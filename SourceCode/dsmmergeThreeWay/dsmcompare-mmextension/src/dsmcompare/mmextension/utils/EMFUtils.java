...
public class EMFUtils {
	...
	public static ArrayList sortByPropertyName(ArrayList<EObject> list, String propertyName) {
		Collections.sort(list, new Comparator<EObject>(){
		    public int compare(EObject n1, EObject n2) {
		    	int id1=(int)(EMFUtils.getAttrValueByAttrNameNullDefault(n1,propertyName));
		    	int id2=(int)(EMFUtils.getAttrValueByAttrNameNullDefault(n2,propertyName));
		        return id1-id2;
		    }
		});
		return list;
	...
	static public void SetEFeature(EObject ERoot, EStructuralFeature feature, Object object){
		 if(ERoot == null || feature == null || object == null) {
	...
	static public EClass createListType(EDataType valueType, EPackage pack, int lowerBound, int upperBound, 
		...
		EClass listClass = EMFUtils.createEClass(listClassName, true, pack);
		EAttribute att = EMFUtils.createEAttribute("value", listClass, valueType, lowerBound, upperBound, false, false, false, false);
	...
	static public EClass createCustomMapType(EDataType keyType,EDataType valueType, EPackage pack, 
		...
		EClass customClassMap = EMFUtils.createEClass(customMapClassName, true, pack);
		//customClassMap.setInstanceTypeName("java.util.Map$Entry");	
		//Add key-value attributes
		EAttribute keyAttr 		= 
				EMFUtils.createEAttribute("key", customClassMap, keyType,  0, 1, false, false, false, false);			
		EAttribute valueAttr 	= 
				EMFUtils.createEAttribute("value", customClassMap, valueType, lowerBound, upperBound, false, false, false, false);
		//Used for Custom Map//EAttribute attrIsForbidden = EMFUtils.createEAttribute("isForbidden", customClassMap, EcorePackage.eINSTANCE.getEBoolean(), 1, 1, false, false);
		...
		/* //Used for Custom Map//
		 if(!isDiffKind){
			...
			EAttribute attrName 	= 
					EMFUtils.createEAttribute("attributeName", customClassMap, stringDataType, 0, 1, false, false);
		}*/
	...
	static public EGenericType createMapListType(EDataType keyType,EGenericType valueType) {
		...
		return _mapType;
		//EMFUtils.createEAttribute("new_"+attr.getName(), diffClass,_mapType, attr.getLowerBound(), -1, false, true);		
	}
