 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayDiffMM.impl.EReferenceImpl#getName <em>Name</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EReferenceImpl#getEtype <em>Etype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EReferenceImpl extends MinimalEObjectImpl.Container implements EReference {
	...
	protected EClass eStaticClass() {
		return Refactoring2WayDiffMMPackage.Literals.EREFERENCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.EREFERENCE__NAME, oldName, name));
	}
	...
	public void setEtype(String newEtype) {
		...
		etype = newEtype;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.EREFERENCE__ETYPE, oldEtype, etype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.EREFERENCE__NAME:
				return getName();
			case Refactoring2WayDiffMMPackage.EREFERENCE__ETYPE:
				return getEtype();
		}
