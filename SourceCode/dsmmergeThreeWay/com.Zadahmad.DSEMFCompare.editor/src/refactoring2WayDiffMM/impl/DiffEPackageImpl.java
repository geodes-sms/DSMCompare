 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayDiffMM.impl.DiffEPackageImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.DiffEPackageImpl#getNew_name <em>New name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEPackageImpl extends EPackageImpl implements DiffEPackage {
	...
	protected EClass eStaticClass() {
		return Refactoring2WayDiffMMPackage.Literals.DIFF_EPACKAGE;
	}
	...
	public void setDiff_kind(DiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.DIFF_EPACKAGE__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.DIFF_EPACKAGE__NEW_NAME, oldNew_name, new_name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.DIFF_EPACKAGE__DIFF_KIND:
				return getDiff_kind();
			case Refactoring2WayDiffMMPackage.DIFF_EPACKAGE__NEW_NAME:
				return getNew_name();
		}
