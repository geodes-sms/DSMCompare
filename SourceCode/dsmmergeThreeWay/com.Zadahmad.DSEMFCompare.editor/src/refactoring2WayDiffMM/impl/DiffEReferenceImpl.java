 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayDiffMM.impl.DiffEReferenceImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.DiffEReferenceImpl#getNew_name <em>New name</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.DiffEReferenceImpl#getNew_etype <em>New etype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEReferenceImpl extends EReferenceImpl implements DiffEReference {
	...
	protected EClass eStaticClass() {
		return Refactoring2WayDiffMMPackage.Literals.DIFF_EREFERENCE;
	}
	...
	public void setDiff_kind(DiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.DIFF_EREFERENCE__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.DIFF_EREFERENCE__NEW_NAME, oldNew_name, new_name));
	}
	...
	public void setNew_etype(String newNew_etype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.DIFF_EREFERENCE__NEW_ETYPE, oldNew_etype, new_etype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.DIFF_EREFERENCE__DIFF_KIND:
				return getDiff_kind();
			case Refactoring2WayDiffMMPackage.DIFF_EREFERENCE__NEW_NAME:
				return getNew_name();
			case Refactoring2WayDiffMMPackage.DIFF_EREFERENCE__NEW_ETYPE:
				return getNew_etype();
		}
