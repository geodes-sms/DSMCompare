 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getName <em>Name</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getExtends <em>Extends</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getImplements <em>Implements</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getPackageName <em>Package Name</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getEattributes <em>Eattributes</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getEoperations <em>Eoperations</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getEreferences <em>Ereferences</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getEsupertypes <em>Esupertypes</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getInterfaces <em>Interfaces</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getNested_classes <em>Nested classes</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getNested_interfaces <em>Nested interfaces</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getDiffeattributes <em>Diffeattributes</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getDiffeoperations <em>Diffeoperations</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getDiffereferences <em>Differeferences</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getDiffesupertypes <em>Diffesupertypes</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getDiffinterfaces <em>Diffinterfaces</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getDiffnested_classes <em>Diffnested classes</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EClassImpl#getDiffnested_interfaces <em>Diffnested interfaces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EClassImpl extends MinimalEObjectImpl.Container implements EClass {
	...
	protected org.eclipse.emf.ecore.EClass eStaticClass() {
		return Refactoring2WayDiffMMPackage.Literals.ECLASS;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.ECLASS__NAME, oldName, name));
	}
	...
	public void setExtends(String newExtends) {
		...
		extends_ = newExtends;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.ECLASS__EXTENDS, oldExtends, extends_));
	}
	...
	public void setImplements(String newImplements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.ECLASS__IMPLEMENTS, oldImplements, implements_));
	}
	...
	public void setIsAbstract(boolean newIsAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.ECLASS__IS_ABSTRACT, oldIsAbstract, isAbstract));
	}
	...
	public void setPackageName(String newPackageName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.ECLASS__PACKAGE_NAME, oldPackageName, packageName));
	}
	...
	public EList<EAttribute> getEattributes() {
		if (eattributes == null) {
			eattributes = new EObjectContainmentEList<EAttribute>(EAttribute.class, this, Refactoring2WayDiffMMPackage.ECLASS__EATTRIBUTES);
		}
		return eattributes;
	}
	...
	public EList<EOperation> getEoperations() {
		if (eoperations == null) {
			eoperations = new EObjectContainmentEList<EOperation>(EOperation.class, this, Refactoring2WayDiffMMPackage.ECLASS__EOPERATIONS);
		}
		return eoperations;
	}
	...
	public EList<EReference> getEreferences() {
		if (ereferences == null) {
			ereferences = new EObjectContainmentEList<EReference>(EReference.class, this, Refactoring2WayDiffMMPackage.ECLASS__EREFERENCES);
		}
		return ereferences;
	}
	...
	public EList<EClass> getEsupertypes() {
		if (esupertypes == null) {
			esupertypes = new EObjectResolvingEList<EClass>(EClass.class, this, Refactoring2WayDiffMMPackage.ECLASS__ESUPERTYPES);
		}
		return esupertypes;
	}
	...
	public EList<Interface> getInterfaces() {
		if (interfaces == null) {
			interfaces = new EObjectResolvingEList<Interface>(Interface.class, this, Refactoring2WayDiffMMPackage.ECLASS__INTERFACES);
		}
		return interfaces;
	}
	...
	public EList<EClass> getNested_classes() {
		if (nested_classes == null) {
			nested_classes = new EObjectContainmentEList<EClass>(EClass.class, this, Refactoring2WayDiffMMPackage.ECLASS__NESTED_CLASSES);
		}
	...
	public EList<Interface> getNested_interfaces() {
		if (nested_interfaces == null) {
			nested_interfaces = new EObjectContainmentEList<Interface>(Interface.class, this, Refactoring2WayDiffMMPackage.ECLASS__NESTED_INTERFACES);
		}
	...
	public EList<DiffEClass_eattributes> getDiffeattributes() {
		if (diffeattributes == null) {
			diffeattributes = new EObjectContainmentEList<DiffEClass_eattributes>(DiffEClass_eattributes.class, this, Refactoring2WayDiffMMPackage.ECLASS__DIFFEATTRIBUTES);
		}
	...
	public EList<DiffEClass_eoperations> getDiffeoperations() {
		if (diffeoperations == null) {
			diffeoperations = new EObjectContainmentEList<DiffEClass_eoperations>(DiffEClass_eoperations.class, this, Refactoring2WayDiffMMPackage.ECLASS__DIFFEOPERATIONS);
		}
	...
	public EList<DiffEClass_ereferences> getDiffereferences() {
		if (differeferences == null) {
			differeferences = new EObjectContainmentEList<DiffEClass_ereferences>(DiffEClass_ereferences.class, this, Refactoring2WayDiffMMPackage.ECLASS__DIFFEREFERENCES);
		}
	...
	public EList<DiffEClass_esupertypes> getDiffesupertypes() {
		if (diffesupertypes == null) {
			diffesupertypes = new EObjectContainmentEList<DiffEClass_esupertypes>(DiffEClass_esupertypes.class, this, Refactoring2WayDiffMMPackage.ECLASS__DIFFESUPERTYPES);
		}
	...
	public EList<DiffEClass_interfaces> getDiffinterfaces() {
		if (diffinterfaces == null) {
			diffinterfaces = new EObjectContainmentEList<DiffEClass_interfaces>(DiffEClass_interfaces.class, this, Refactoring2WayDiffMMPackage.ECLASS__DIFFINTERFACES);
		}
	...
	public EList<DiffEClass_nested_classes> getDiffnested_classes() {
		if (diffnested_classes == null) {
			diffnested_classes = new EObjectContainmentEList<DiffEClass_nested_classes>(DiffEClass_nested_classes.class, this, Refactoring2WayDiffMMPackage.ECLASS__DIFFNESTED_CLASSES);
		}
	...
	public EList<DiffEClass_nested_interfaces> getDiffnested_interfaces() {
		if (diffnested_interfaces == null) {
			diffnested_interfaces = new EObjectContainmentEList<DiffEClass_nested_interfaces>(DiffEClass_nested_interfaces.class, this, Refactoring2WayDiffMMPackage.ECLASS__DIFFNESTED_INTERFACES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.ECLASS__EATTRIBUTES:
				return ((InternalEList<?>)getEattributes()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.ECLASS__EOPERATIONS:
				return ((InternalEList<?>)getEoperations()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.ECLASS__EREFERENCES:
				return ((InternalEList<?>)getEreferences()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.ECLASS__NESTED_CLASSES:
				return ((InternalEList<?>)getNested_classes()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.ECLASS__NESTED_INTERFACES:
				return ((InternalEList<?>)getNested_interfaces()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.ECLASS__DIFFEATTRIBUTES:
				return ((InternalEList<?>)getDiffeattributes()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.ECLASS__DIFFEOPERATIONS:
				return ((InternalEList<?>)getDiffeoperations()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.ECLASS__DIFFEREFERENCES:
				return ((InternalEList<?>)getDiffereferences()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.ECLASS__DIFFESUPERTYPES:
				return ((InternalEList<?>)getDiffesupertypes()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.ECLASS__DIFFINTERFACES:
				return ((InternalEList<?>)getDiffinterfaces()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.ECLASS__DIFFNESTED_CLASSES:
				return ((InternalEList<?>)getDiffnested_classes()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.ECLASS__DIFFNESTED_INTERFACES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.ECLASS__NAME:
				return getName();
			case Refactoring2WayDiffMMPackage.ECLASS__EXTENDS:
				return getExtends();
			case Refactoring2WayDiffMMPackage.ECLASS__IMPLEMENTS:
				return getImplements();
			case Refactoring2WayDiffMMPackage.ECLASS__IS_ABSTRACT:
				return isIsAbstract();
			case Refactoring2WayDiffMMPackage.ECLASS__PACKAGE_NAME:
			...
			case Refactoring2WayDiffMMPackage.ECLASS__ESUPERTYPES:
				return getEsupertypes();
			case Refactoring2WayDiffMMPackage.ECLASS__INTERFACES:
