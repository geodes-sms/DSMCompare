...
import refactoring2WayDiffMM.impl.DiffEPackage_interfacesImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_DiffEPackage_interfacesImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_DiffEPackage_interfacesImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_DiffEPackage_interfacesImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffEPackage_interfacesImpl extends DiffEPackage_interfacesImpl implements Pattern_DiffEPackage_interfaces {
	/**
	...
	protected EClass eStaticClass() {
		return Refactoring2WayRuleMMPackage.Literals.PATTERN_DIFF_EPACKAGE_INTERFACES;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_DIFF_EPACKAGE_INTERFACES__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_DIFF_EPACKAGE_INTERFACES__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_DIFF_EPACKAGE_INTERFACES__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayRuleMMPackage.PATTERN_DIFF_EPACKAGE_INTERFACES__ID_PATTERN:
				return getID_Pattern();
			case Refactoring2WayRuleMMPackage.PATTERN_DIFF_EPACKAGE_INTERFACES__FILTER:
				return isFilter();
			case Refactoring2WayRuleMMPackage.PATTERN_DIFF_EPACKAGE_INTERFACES__IS_FORBIDDEN:
