 ...
 * </p>
 * <ul>
 *   <li>{@link dssmm.impl.FactorImpl#getFactorID <em>Factor ID</em>}</li>
 *   <li>{@link dssmm.impl.FactorImpl#getName <em>Name</em>}</li>
 *   <li>{@link dssmm.impl.FactorImpl#getDescr <em>Descr</em>}</li>
 *   <li>{@link dssmm.impl.FactorImpl#getGW <em>GW</em>}</li>
 *   <li>{@link dssmm.impl.FactorImpl#getLW <em>LW</em>}</li>
 *   <li>{@link dssmm.impl.FactorImpl#getDel <em>Del</em>}</li>
 *   <li>{@link dssmm.impl.FactorImpl#isHideOnLine <em>Hide On Line</em>}</li>
 *   <li>{@link dssmm.impl.FactorImpl#getScores <em>Scores</em>}</li>
 *   <li>{@link dssmm.impl.FactorImpl#getHierarchy <em>Hierarchy</em>}</li>
 *   <li>{@link dssmm.impl.FactorImpl#getMasterFactorID <em>Master Factor ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FactorImpl extends MinimalEObjectImpl.Container implements Factor {
	...
	protected EClass eStaticClass() {
		return DssmmPackage.Literals.FACTOR;
	}
	...
	public void setFactorID(int newFactorID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmPackage.FACTOR__FACTOR_ID, oldFactorID, factorID));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmPackage.FACTOR__NAME, oldName, name));
	}
	...
	public void setDescr(String newDescr) {
		...
		descr = newDescr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmPackage.FACTOR__DESCR, oldDescr, descr));
	}
	...
	public void setGW(float newGW) {
		...
		gw = newGW;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmPackage.FACTOR__GW, oldGW, gw));
	}
	...
	public void setLW(float newLW) {
		...
		lw = newLW;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmPackage.FACTOR__LW, oldLW, lw));
	}
	...
	public void setDel(Boolean newDel) {
		...
		del = newDel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmPackage.FACTOR__DEL, oldDel, del));
	}
	...
	public void setHideOnLine(boolean newHideOnLine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmPackage.FACTOR__HIDE_ON_LINE, oldHideOnLine, hideOnLine));
	}
	...
	public EList<Score> getScores() {
		if (scores == null) {
			scores = new EObjectContainmentEList<Score>(Score.class, this, DssmmPackage.FACTOR__SCORES);
		}
		return scores;
	}
	...
	public void setHierarchy(String newHierarchy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmPackage.FACTOR__HIERARCHY, oldHierarchy, hierarchy));
	}
	...
	public void setMasterFactorID(int newMasterFactorID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmPackage.FACTOR__MASTER_FACTOR_ID, oldMasterFactorID, masterFactorID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DssmmPackage.FACTOR__SCORES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DssmmPackage.FACTOR__FACTOR_ID:
				return getFactorID();
			case DssmmPackage.FACTOR__NAME:
				return getName();
			case DssmmPackage.FACTOR__DESCR:
				return getDescr();
			case DssmmPackage.FACTOR__GW:
				return getGW();
			case DssmmPackage.FACTOR__LW:
				return getLW();
			case DssmmPackage.FACTOR__DEL:
				return getDel();
			case DssmmPackage.FACTOR__HIDE_ON_LINE:
				return isHideOnLine();
			case DssmmPackage.FACTOR__SCORES:
				return getScores();
			case DssmmPackage.FACTOR__HIERARCHY:
				return getHierarchy();
			case DssmmPackage.FACTOR__MASTER_FACTOR_ID:
