...
public class Pacman2WayRuleMMSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Pacman2WayRuleMMPackage.PATTERN_DOMAIN_SPECIFIC_DIFF: {
			...
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_GAME_DOMAINSPECIFICDIFFS: {
			...
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_GAME_SEMANTICCONFLICTS: {
				Pattern_DiffGame_semanticconflicts pattern_DiffGame_semanticconflicts = (Pattern_DiffGame_semanticconflicts)theEObject;
				T result = casePattern_DiffGame_semanticconflicts(pattern_DiffGame_semanticconflicts);
				if (result == null) result = caseDiffGame_semanticconflicts(pattern_DiffGame_semanticconflicts);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Pattern Diff Game semanticconflicts</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Pattern Diff Game semanticconflicts</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePattern_DiffGame_semanticconflicts(Pattern_DiffGame_semanticconflicts object) {
		return null;
	}
