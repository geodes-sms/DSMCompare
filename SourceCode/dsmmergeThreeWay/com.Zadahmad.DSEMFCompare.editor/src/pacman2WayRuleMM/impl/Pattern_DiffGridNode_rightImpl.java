...
import pacman2WayDiffMM.impl.DiffGridNode_rightImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DiffGridNode_rightImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DiffGridNode_rightImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DiffGridNode_rightImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffGridNode_rightImpl extends DiffGridNode_rightImpl implements Pattern_DiffGridNode_right {
	/**
	...
	protected EClass eStaticClass() {
		return Pacman2WayRuleMMPackage.Literals.PATTERN_DIFF_GRID_NODE_RIGHT;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_RIGHT__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_RIGHT__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_RIGHT__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_RIGHT__ID_PATTERN:
				return getID_Pattern();
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_RIGHT__FILTER:
				return isFilter();
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_RIGHT__IS_FORBIDDEN:
