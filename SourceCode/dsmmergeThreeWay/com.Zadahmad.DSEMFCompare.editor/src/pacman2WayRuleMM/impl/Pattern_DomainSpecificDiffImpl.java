...
import pacman2WayDiffMM.impl.DomainSpecificDiffImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Domain Specific Diff</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DomainSpecificDiffImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DomainSpecificDiffImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DomainSpecificDiffImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DomainSpecificDiffImpl extends DomainSpecificDiffImpl implements Pattern_DomainSpecificDiff {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DomainSpecificDiffImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Pacman2WayRuleMMPackage.Literals.PATTERN_DOMAIN_SPECIFIC_DIFF;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DOMAIN_SPECIFIC_DIFF__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DOMAIN_SPECIFIC_DIFF__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DOMAIN_SPECIFIC_DIFF__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayRuleMMPackage.PATTERN_DOMAIN_SPECIFIC_DIFF__ID_PATTERN:
				return getID_Pattern();
			case Pacman2WayRuleMMPackage.PATTERN_DOMAIN_SPECIFIC_DIFF__FILTER:
				return isFilter();
			case Pacman2WayRuleMMPackage.PATTERN_DOMAIN_SPECIFIC_DIFF__IS_FORBIDDEN:
...
} //Pattern_DomainSpecificDiffImpl
