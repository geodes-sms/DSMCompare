...
import pacman2WayRuleMM.Pattern_DiffGame_domainspecificdiffs;
import pacman2WayRuleMM.Pattern_DiffGame_entities;
import pacman2WayRuleMM.Pattern_DiffGame_gridnodes;
import pacman2WayRuleMM.Pattern_DiffGame_semanticconflicts;
...
import pacman2WayRuleMM.Pattern_DomainSpecificDiff;
...
public class Pacman2WayRuleMMPackageImpl extends EPackageImpl implements Pacman2WayRuleMMPackage {
	 ...
	 * @generated
	 */
	private EClass pattern_DiffGame_semanticconflictsEClass = null;
	 ...
	 * @generated
	 */
	public EAttribute getPattern_DomainSpecificDiff_IsForbidden() {
		return (EAttribute)pattern_DomainSpecificDiffEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getPattern_DiffGame_domainspecificdiffs_IsForbidden() {
		return (EAttribute)pattern_DiffGame_domainspecificdiffsEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getPattern_DiffGame_semanticconflicts() {
		return pattern_DiffGame_semanticconflictsEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getPattern_DiffGame_semanticconflicts_ID_Pattern() {
		return (EAttribute)pattern_DiffGame_semanticconflictsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getPattern_DiffGame_semanticconflicts_Filter() {
		return (EAttribute)pattern_DiffGame_semanticconflictsEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getPattern_DiffGame_semanticconflicts_IsForbidden() {
		return (EAttribute)pattern_DiffGame_semanticconflictsEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(pattern_DomainSpecificDiffEClass, PATTERN_DOMAIN_SPECIFIC_DIFF__IS_FORBIDDEN);
		...
		createEAttribute(pattern_DiffGame_domainspecificdiffsEClass, PATTERN_DIFF_GAME_DOMAINSPECIFICDIFFS__IS_FORBIDDEN);

		pattern_DiffGame_semanticconflictsEClass = createEClass(PATTERN_DIFF_GAME_SEMANTICCONFLICTS);
		createEAttribute(pattern_DiffGame_semanticconflictsEClass, PATTERN_DIFF_GAME_SEMANTICCONFLICTS__ID_PATTERN);
		createEAttribute(pattern_DiffGame_semanticconflictsEClass, PATTERN_DIFF_GAME_SEMANTICCONFLICTS__FILTER);
		createEAttribute(pattern_DiffGame_semanticconflictsEClass, PATTERN_DIFF_GAME_SEMANTICCONFLICTS__IS_FORBIDDEN);
	...
	public void initializePackageContents() {
		...
		pattern_DomainSpecificDiffEClass.getESuperTypes().add(thePacman2WayDiffMMPackage.getDomainSpecificDiff());
		...
		pattern_DiffGame_domainspecificdiffsEClass.getESuperTypes().add(thePacman2WayDiffMMPackage.getDiffGame_domainspecificdiffs());
		pattern_DiffGame_semanticconflictsEClass.getESuperTypes().add(thePacman2WayDiffMMPackage.getDiffGame_semanticconflicts());
		...
		initEAttribute(getPattern_DomainSpecificDiff_IsForbidden(), ecorePackage.getEBoolean(), "isForbidden", "false", 1, 1, Pattern_DomainSpecificDiff.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPattern_DiffGame_domainspecificdiffs_IsForbidden(), ecorePackage.getEBoolean(), "isForbidden", "false", 1, 1, Pattern_DiffGame_domainspecificdiffs.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(pattern_DiffGame_semanticconflictsEClass, Pattern_DiffGame_semanticconflicts.class, "Pattern_DiffGame_semanticconflicts", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPattern_DiffGame_semanticconflicts_ID_Pattern(), ecorePackage.getEInt(), "ID_Pattern", null, 1, 1, Pattern_DiffGame_semanticconflicts.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPattern_DiffGame_semanticconflicts_Filter(), ecorePackage.getEBoolean(), "filter", null, 1, 1, Pattern_DiffGame_semanticconflicts.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPattern_DiffGame_semanticconflicts_IsForbidden(), ecorePackage.getEBoolean(), "isForbidden", "false", 1, 1, Pattern_DiffGame_semanticconflicts.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRule_Pattern(), thePacman2WayDiffMMPackage.getGame(), null, "pattern", null, 0, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
