...
public class Pacman2WayRuleMMFactoryImpl extends EFactoryImpl implements Pacman2WayRuleMMFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case Pacman2WayRuleMMPackage.PATTERN_DOMAIN_SPECIFIC_DIFF: return createPattern_DomainSpecificDiff();
			...
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_GAME_DOMAINSPECIFICDIFFS: return createPattern_DiffGame_domainspecificdiffs();
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_GAME_SEMANTICCONFLICTS: return createPattern_DiffGame_semanticconflicts();
	 ...
	 * @generated
	 */
	public Pattern_DiffGame_semanticconflicts createPattern_DiffGame_semanticconflicts() {
		Pattern_DiffGame_semanticconflictsImpl pattern_DiffGame_semanticconflicts = new Pattern_DiffGame_semanticconflictsImpl();
		return pattern_DiffGame_semanticconflicts;
	}
