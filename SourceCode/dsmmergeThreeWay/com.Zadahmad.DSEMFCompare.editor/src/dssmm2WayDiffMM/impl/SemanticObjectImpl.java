 ...
 * </p>
 * <ul>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DecisionSupport <em>Semantic Object Decision Support</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffCompositeFactor_subFactors <em>Semantic Object Diff Composite Factor sub Factors</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffDecisionSupport_model <em>Semantic Object Diff Decision Support model</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffDecisionSupport_options <em>Semantic Object Diff Decision Support options</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffDecisionSupport_vendors <em>Semantic Object Diff Decision Support vendors</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffFactor_scores <em>Semantic Object Diff Factor scores</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffModel_rootFactor <em>Semantic Object Diff Model root Factor</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffOption_vendor <em>Semantic Object Diff Option vendor</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffScore_score_option <em>Semantic Object Diff Score score option</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_Factor <em>Semantic Object Factor</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_Model <em>Semantic Object Model</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_Option <em>Semantic Object Option</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_Score <em>Semantic Object Score</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_Vendor <em>Semantic Object Vendor</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SemanticObjectImpl extends MinimalEObjectImpl.Container implements SemanticObject {
	...
	protected EClass eStaticClass() {
		return Dssmm2WayDiffMMPackage.Literals.SEMANTIC_OBJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__NAME, oldName, name));
	}
	...
	public EList<DecisionSupport> getSemanticObject_DecisionSupport() {
		if (semanticObject_DecisionSupport == null) {
			semanticObject_DecisionSupport = new EObjectResolvingEList<DecisionSupport>(DecisionSupport.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DECISION_SUPPORT);
		}
	...
	public EList<DiffCompositeFactor_subFactors> getSemanticObject_DiffCompositeFactor_subFactors() {
		if (semanticObject_DiffCompositeFactor_subFactors == null) {
			semanticObject_DiffCompositeFactor_subFactors = new EObjectResolvingEList<DiffCompositeFactor_subFactors>(DiffCompositeFactor_subFactors.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_COMPOSITE_FACTOR_SUB_FACTORS);
		}
	...
	public EList<DiffDecisionSupport_model> getSemanticObject_DiffDecisionSupport_model() {
		if (semanticObject_DiffDecisionSupport_model == null) {
			semanticObject_DiffDecisionSupport_model = new EObjectResolvingEList<DiffDecisionSupport_model>(DiffDecisionSupport_model.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_DECISION_SUPPORT_MODEL);
		}
	...
	public EList<DiffDecisionSupport_options> getSemanticObject_DiffDecisionSupport_options() {
		if (semanticObject_DiffDecisionSupport_options == null) {
			semanticObject_DiffDecisionSupport_options = new EObjectResolvingEList<DiffDecisionSupport_options>(DiffDecisionSupport_options.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_DECISION_SUPPORT_OPTIONS);
		}
	...
	public EList<DiffDecisionSupport_vendors> getSemanticObject_DiffDecisionSupport_vendors() {
		if (semanticObject_DiffDecisionSupport_vendors == null) {
			semanticObject_DiffDecisionSupport_vendors = new EObjectResolvingEList<DiffDecisionSupport_vendors>(DiffDecisionSupport_vendors.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_DECISION_SUPPORT_VENDORS);
		}
	...
	public EList<DiffFactor_scores> getSemanticObject_DiffFactor_scores() {
		if (semanticObject_DiffFactor_scores == null) {
			semanticObject_DiffFactor_scores = new EObjectResolvingEList<DiffFactor_scores>(DiffFactor_scores.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_FACTOR_SCORES);
		}
	...
	public EList<DiffModel_rootFactor> getSemanticObject_DiffModel_rootFactor() {
		if (semanticObject_DiffModel_rootFactor == null) {
			semanticObject_DiffModel_rootFactor = new EObjectResolvingEList<DiffModel_rootFactor>(DiffModel_rootFactor.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_MODEL_ROOT_FACTOR);
		}
	...
	public EList<DiffOption_vendor> getSemanticObject_DiffOption_vendor() {
		if (semanticObject_DiffOption_vendor == null) {
			semanticObject_DiffOption_vendor = new EObjectResolvingEList<DiffOption_vendor>(DiffOption_vendor.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_OPTION_VENDOR);
		}
	...
	public EList<DiffScore_score_option> getSemanticObject_DiffScore_score_option() {
		if (semanticObject_DiffScore_score_option == null) {
			semanticObject_DiffScore_score_option = new EObjectResolvingEList<DiffScore_score_option>(DiffScore_score_option.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_SCORE_SCORE_OPTION);
		}
	...
	public EList<Factor> getSemanticObject_Factor() {
		if (semanticObject_Factor == null) {
			semanticObject_Factor = new EObjectResolvingEList<Factor>(Factor.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_FACTOR);
		}
	...
	public EList<Model> getSemanticObject_Model() {
		if (semanticObject_Model == null) {
			semanticObject_Model = new EObjectResolvingEList<Model>(Model.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_MODEL);
		}
	...
	public EList<Option> getSemanticObject_Option() {
		if (semanticObject_Option == null) {
			semanticObject_Option = new EObjectResolvingEList<Option>(Option.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_OPTION);
		}
	...
	public EList<Score> getSemanticObject_Score() {
		if (semanticObject_Score == null) {
			semanticObject_Score = new EObjectResolvingEList<Score>(Score.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_SCORE);
		}
	...
	public EList<Vendor> getSemanticObject_Vendor() {
		if (semanticObject_Vendor == null) {
			semanticObject_Vendor = new EObjectResolvingEList<Vendor>(Vendor.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_VENDOR);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__NAME:
				return getName();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DECISION_SUPPORT:
				return getSemanticObject_DecisionSupport();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_COMPOSITE_FACTOR_SUB_FACTORS:
				return getSemanticObject_DiffCompositeFactor_subFactors();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_DECISION_SUPPORT_MODEL:
				return getSemanticObject_DiffDecisionSupport_model();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_DECISION_SUPPORT_OPTIONS:
				return getSemanticObject_DiffDecisionSupport_options();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_DECISION_SUPPORT_VENDORS:
				return getSemanticObject_DiffDecisionSupport_vendors();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_FACTOR_SCORES:
				return getSemanticObject_DiffFactor_scores();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_MODEL_ROOT_FACTOR:
				return getSemanticObject_DiffModel_rootFactor();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_OPTION_VENDOR:
				return getSemanticObject_DiffOption_vendor();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_SCORE_SCORE_OPTION:
				return getSemanticObject_DiffScore_score_option();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_FACTOR:
				return getSemanticObject_Factor();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_MODEL:
				return getSemanticObject_Model();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_OPTION:
				return getSemanticObject_Option();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_SCORE:
				return getSemanticObject_Score();
			case Dssmm2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_VENDOR:
