 ...
 * </p>
 * <ul>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffDecisionSupport_optionsImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffDecisionSupport_optionsImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffDecisionSupport_optionsImpl extends MinimalEObjectImpl.Container implements DiffDecisionSupport_options {
	...
	protected EClass eStaticClass() {
		return Dssmm2WayDiffMMPackage.Literals.DIFF_DECISION_SUPPORT_OPTIONS;
	}
	...
	public void setDiff_kind(AscDiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_DECISION_SUPPORT_OPTIONS__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public Option getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Dssmm2WayDiffMMPackage.DIFF_DECISION_SUPPORT_OPTIONS__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(Option newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_DECISION_SUPPORT_OPTIONS__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dssmm2WayDiffMMPackage.DIFF_DECISION_SUPPORT_OPTIONS__DIFF_KIND:
				return getDiff_kind();
			case Dssmm2WayDiffMMPackage.DIFF_DECISION_SUPPORT_OPTIONS__ETYPE:
