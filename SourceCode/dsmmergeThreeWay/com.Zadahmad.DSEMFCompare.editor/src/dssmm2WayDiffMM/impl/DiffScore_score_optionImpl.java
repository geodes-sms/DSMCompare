 ...
 * </p>
 * <ul>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffScore_score_optionImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffScore_score_optionImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffScore_score_optionImpl extends MinimalEObjectImpl.Container implements DiffScore_score_option {
	...
	protected EClass eStaticClass() {
		return Dssmm2WayDiffMMPackage.Literals.DIFF_SCORE_SCORE_OPTION;
	}
	...
	public void setDiff_kind(AscDiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_SCORE_SCORE_OPTION__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public Option getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Dssmm2WayDiffMMPackage.DIFF_SCORE_SCORE_OPTION__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(Option newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_SCORE_SCORE_OPTION__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dssmm2WayDiffMMPackage.DIFF_SCORE_SCORE_OPTION__DIFF_KIND:
				return getDiff_kind();
			case Dssmm2WayDiffMMPackage.DIFF_SCORE_SCORE_OPTION__ETYPE:
