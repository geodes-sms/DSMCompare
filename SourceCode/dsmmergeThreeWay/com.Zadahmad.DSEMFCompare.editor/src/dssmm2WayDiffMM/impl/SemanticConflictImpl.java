 ...
 * </p>
 * <ul>
 *   <li>{@link dssmm2WayDiffMM.impl.SemanticConflictImpl#getSemanticdiffs <em>Semanticdiffs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemanticConflictImpl extends SemanticObjectImpl implements SemanticConflict {
	...
	protected EClass eStaticClass() {
		return Dssmm2WayDiffMMPackage.Literals.SEMANTIC_CONFLICT;
	}
	...
	public EList<SemanticDiff> getSemanticdiffs() {
		if (semanticdiffs == null) {
			semanticdiffs = new EObjectContainmentEList<SemanticDiff>(SemanticDiff.class, this, Dssmm2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTICDIFFS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Dssmm2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTICDIFFS:
