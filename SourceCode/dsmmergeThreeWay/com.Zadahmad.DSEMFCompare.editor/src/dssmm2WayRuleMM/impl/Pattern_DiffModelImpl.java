...
import dssmm2WayDiffMM.impl.DiffModelImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff Model</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dssmm2WayRuleMM.impl.Pattern_DiffModelImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link dssmm2WayRuleMM.impl.Pattern_DiffModelImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link dssmm2WayRuleMM.impl.Pattern_DiffModelImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffModelImpl extends DiffModelImpl implements Pattern_DiffModel {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffModelImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Dssmm2WayRuleMMPackage.Literals.PATTERN_DIFF_MODEL;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayRuleMMPackage.PATTERN_DIFF_MODEL__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayRuleMMPackage.PATTERN_DIFF_MODEL__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayRuleMMPackage.PATTERN_DIFF_MODEL__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dssmm2WayRuleMMPackage.PATTERN_DIFF_MODEL__ID_PATTERN:
				return getID_Pattern();
			case Dssmm2WayRuleMMPackage.PATTERN_DIFF_MODEL__FILTER:
				return isFilter();
			case Dssmm2WayRuleMMPackage.PATTERN_DIFF_MODEL__IS_FORBIDDEN:
