 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getName <em>Name</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_GridNode <em>Domain Specific Diff Grid Node</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_Game <em>Domain Specific Diff Game</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_PositionableEntity <em>Domain Specific Diff Positionable Entity</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_DiffGridNode_up <em>Domain Specific Diff Diff Grid Node up</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_DiffGridNode_down <em>Domain Specific Diff Diff Grid Node down</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_DiffGridNode_left <em>Domain Specific Diff Diff Grid Node left</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_DiffGridNode_right <em>Domain Specific Diff Diff Grid Node right</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_DiffGame_gridnodes <em>Domain Specific Diff Diff Game gridnodes</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_DiffGame_entities <em>Domain Specific Diff Diff Game entities</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_DiffGame_domainspecificdiffs <em>Domain Specific Diff Diff Game domainspecificdiffs</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_DiffGame_semanticconflicts <em>Domain Specific Diff Diff Game semanticconflicts</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DomainSpecificDiffImpl#getDomainSpecificDiff_DiffPositionableEntity_on <em>Domain Specific Diff Diff Positionable Entity on</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainSpecificDiffImpl extends MinimalEObjectImpl.Container implements DomainSpecificDiff {
	...
	protected EClass eStaticClass() {
		return Pacman2WayDiffMMPackage.Literals.DOMAIN_SPECIFIC_DIFF;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__NAME, oldName, name));
	}
	...
	public EList<GridNode> getDomainSpecificDiff_GridNode() {
		if (domainSpecificDiff_GridNode == null) {
			domainSpecificDiff_GridNode = new EObjectResolvingEList<GridNode>(GridNode.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_GRID_NODE);
		}
	...
	public EList<Game> getDomainSpecificDiff_Game() {
		if (domainSpecificDiff_Game == null) {
			domainSpecificDiff_Game = new EObjectResolvingEList<Game>(Game.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_GAME);
		}
	...
	public EList<PositionableEntity> getDomainSpecificDiff_PositionableEntity() {
		if (domainSpecificDiff_PositionableEntity == null) {
			domainSpecificDiff_PositionableEntity = new EObjectResolvingEList<PositionableEntity>(PositionableEntity.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_POSITIONABLE_ENTITY);
		}
	...
	public EList<DiffGridNode_up> getDomainSpecificDiff_DiffGridNode_up() {
		if (domainSpecificDiff_DiffGridNode_up == null) {
			domainSpecificDiff_DiffGridNode_up = new EObjectResolvingEList<DiffGridNode_up>(DiffGridNode_up.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GRID_NODE_UP);
		}
	...
	public EList<DiffGridNode_down> getDomainSpecificDiff_DiffGridNode_down() {
		if (domainSpecificDiff_DiffGridNode_down == null) {
			domainSpecificDiff_DiffGridNode_down = new EObjectResolvingEList<DiffGridNode_down>(DiffGridNode_down.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GRID_NODE_DOWN);
		}
	...
	public EList<DiffGridNode_left> getDomainSpecificDiff_DiffGridNode_left() {
		if (domainSpecificDiff_DiffGridNode_left == null) {
			domainSpecificDiff_DiffGridNode_left = new EObjectResolvingEList<DiffGridNode_left>(DiffGridNode_left.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GRID_NODE_LEFT);
		}
	...
	public EList<DiffGridNode_right> getDomainSpecificDiff_DiffGridNode_right() {
		if (domainSpecificDiff_DiffGridNode_right == null) {
			domainSpecificDiff_DiffGridNode_right = new EObjectResolvingEList<DiffGridNode_right>(DiffGridNode_right.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GRID_NODE_RIGHT);
		}
	...
	public EList<DiffGame_gridnodes> getDomainSpecificDiff_DiffGame_gridnodes() {
		if (domainSpecificDiff_DiffGame_gridnodes == null) {
			domainSpecificDiff_DiffGame_gridnodes = new EObjectResolvingEList<DiffGame_gridnodes>(DiffGame_gridnodes.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GAME_GRIDNODES);
		}
	...
	public EList<DiffGame_entities> getDomainSpecificDiff_DiffGame_entities() {
		if (domainSpecificDiff_DiffGame_entities == null) {
			domainSpecificDiff_DiffGame_entities = new EObjectResolvingEList<DiffGame_entities>(DiffGame_entities.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GAME_ENTITIES);
		}
	...
	public EList<DiffGame_domainspecificdiffs> getDomainSpecificDiff_DiffGame_domainspecificdiffs() {
		if (domainSpecificDiff_DiffGame_domainspecificdiffs == null) {
			domainSpecificDiff_DiffGame_domainspecificdiffs = new EObjectResolvingEList<DiffGame_domainspecificdiffs>(DiffGame_domainspecificdiffs.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GAME_DOMAINSPECIFICDIFFS);
		}
	...
	public EList<DiffGame_semanticconflicts> getDomainSpecificDiff_DiffGame_semanticconflicts() {
		if (domainSpecificDiff_DiffGame_semanticconflicts == null) {
			domainSpecificDiff_DiffGame_semanticconflicts = new EObjectResolvingEList<DiffGame_semanticconflicts>(DiffGame_semanticconflicts.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GAME_SEMANTICCONFLICTS);
		}
	...
	public EList<DiffPositionableEntity_on> getDomainSpecificDiff_DiffPositionableEntity_on() {
		if (domainSpecificDiff_DiffPositionableEntity_on == null) {
			domainSpecificDiff_DiffPositionableEntity_on = new EObjectResolvingEList<DiffPositionableEntity_on>(DiffPositionableEntity_on.class, this, Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_POSITIONABLE_ENTITY_ON);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__NAME:
				return getName();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_GRID_NODE:
				return getDomainSpecificDiff_GridNode();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_GAME:
				return getDomainSpecificDiff_Game();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_POSITIONABLE_ENTITY:
				return getDomainSpecificDiff_PositionableEntity();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GRID_NODE_UP:
				return getDomainSpecificDiff_DiffGridNode_up();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GRID_NODE_DOWN:
				return getDomainSpecificDiff_DiffGridNode_down();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GRID_NODE_LEFT:
				return getDomainSpecificDiff_DiffGridNode_left();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GRID_NODE_RIGHT:
				return getDomainSpecificDiff_DiffGridNode_right();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GAME_GRIDNODES:
				return getDomainSpecificDiff_DiffGame_gridnodes();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GAME_ENTITIES:
				return getDomainSpecificDiff_DiffGame_entities();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GAME_DOMAINSPECIFICDIFFS:
				return getDomainSpecificDiff_DiffGame_domainspecificdiffs();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_GAME_SEMANTICCONFLICTS:
				return getDomainSpecificDiff_DiffGame_semanticconflicts();
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF__DOMAIN_SPECIFIC_DIFF_DIFF_POSITIONABLE_ENTITY_ON:
