 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayDiffMM.impl.DiffGame_domainspecificdiffsImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DiffGame_domainspecificdiffsImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffGame_domainspecificdiffsImpl extends MinimalEObjectImpl.Container implements DiffGame_domainspecificdiffs {
	...
	protected EClass eStaticClass() {
		return Pacman2WayDiffMMPackage.Literals.DIFF_GAME_DOMAINSPECIFICDIFFS;
	}
	...
	public void setDiff_kind(AscDiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public DomainSpecificDiff getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pacman2WayDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(DomainSpecificDiff newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__DIFF_KIND:
				return getDiff_kind();
			case Pacman2WayDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__ETYPE:
