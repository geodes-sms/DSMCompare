 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getName <em>Name</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffGridNode <em>Semantic Conflict Diff Grid Node</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffGridNode_up <em>Semantic Conflict Diff Grid Node up</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffGridNode_down <em>Semantic Conflict Diff Grid Node down</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffGridNode_left <em>Semantic Conflict Diff Grid Node left</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffGridNode_right <em>Semantic Conflict Diff Grid Node right</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffFood <em>Semantic Conflict Diff Food</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffPacman <em>Semantic Conflict Diff Pacman</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffGhost <em>Semantic Conflict Diff Ghost</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffGame <em>Semantic Conflict Diff Game</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffGame_gridnodes <em>Semantic Conflict Diff Game gridnodes</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffGame_entities <em>Semantic Conflict Diff Game entities</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffGame_domainspecificdiffs <em>Semantic Conflict Diff Game domainspecificdiffs</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffGame_semanticconflicts <em>Semantic Conflict Diff Game semanticconflicts</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffPositionableEntity_on <em>Semantic Conflict Diff Positionable Entity on</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffFruit <em>Semantic Conflict Diff Fruit</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DiffEnergizer <em>Semantic Conflict Diff Energizer</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticConflictImpl#getSemanticConflict_DomainSpecificDiff <em>Semantic Conflict Domain Specific Diff</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemanticConflictImpl extends MinimalEObjectImpl.Container implements SemanticConflict {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__NAME, oldName, name));
	}
	...
	public EList<DiffGridNode> getSemanticConflict_DiffGridNode() {
		if (semanticConflict_DiffGridNode == null) {
			semanticConflict_DiffGridNode = new EObjectResolvingEList<DiffGridNode>(DiffGridNode.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GRID_NODE);
		}
	...
	public EList<DiffGridNode_up> getSemanticConflict_DiffGridNode_up() {
		if (semanticConflict_DiffGridNode_up == null) {
			semanticConflict_DiffGridNode_up = new EObjectResolvingEList<DiffGridNode_up>(DiffGridNode_up.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GRID_NODE_UP);
		}
	...
	public EList<DiffGridNode_down> getSemanticConflict_DiffGridNode_down() {
		if (semanticConflict_DiffGridNode_down == null) {
			semanticConflict_DiffGridNode_down = new EObjectResolvingEList<DiffGridNode_down>(DiffGridNode_down.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GRID_NODE_DOWN);
		}
	...
	public EList<DiffGridNode_left> getSemanticConflict_DiffGridNode_left() {
		if (semanticConflict_DiffGridNode_left == null) {
			semanticConflict_DiffGridNode_left = new EObjectResolvingEList<DiffGridNode_left>(DiffGridNode_left.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GRID_NODE_LEFT);
		}
	...
	public EList<DiffGridNode_right> getSemanticConflict_DiffGridNode_right() {
		if (semanticConflict_DiffGridNode_right == null) {
			semanticConflict_DiffGridNode_right = new EObjectResolvingEList<DiffGridNode_right>(DiffGridNode_right.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GRID_NODE_RIGHT);
		}
	...
	public EList<DiffFood> getSemanticConflict_DiffFood() {
		if (semanticConflict_DiffFood == null) {
			semanticConflict_DiffFood = new EObjectResolvingEList<DiffFood>(DiffFood.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_FOOD);
		}
	...
	public EList<DiffPacman> getSemanticConflict_DiffPacman() {
		if (semanticConflict_DiffPacman == null) {
			semanticConflict_DiffPacman = new EObjectResolvingEList<DiffPacman>(DiffPacman.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_PACMAN);
		}
	...
	public EList<DiffGhost> getSemanticConflict_DiffGhost() {
		if (semanticConflict_DiffGhost == null) {
			semanticConflict_DiffGhost = new EObjectResolvingEList<DiffGhost>(DiffGhost.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GHOST);
		}
	...
	public EList<DiffGame> getSemanticConflict_DiffGame() {
		if (semanticConflict_DiffGame == null) {
			semanticConflict_DiffGame = new EObjectResolvingEList<DiffGame>(DiffGame.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GAME);
		}
	...
	public EList<DiffGame_gridnodes> getSemanticConflict_DiffGame_gridnodes() {
		if (semanticConflict_DiffGame_gridnodes == null) {
			semanticConflict_DiffGame_gridnodes = new EObjectResolvingEList<DiffGame_gridnodes>(DiffGame_gridnodes.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GAME_GRIDNODES);
		}
	...
	public EList<DiffGame_entities> getSemanticConflict_DiffGame_entities() {
		if (semanticConflict_DiffGame_entities == null) {
			semanticConflict_DiffGame_entities = new EObjectResolvingEList<DiffGame_entities>(DiffGame_entities.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GAME_ENTITIES);
		}
	...
	public EList<DiffGame_domainspecificdiffs> getSemanticConflict_DiffGame_domainspecificdiffs() {
		if (semanticConflict_DiffGame_domainspecificdiffs == null) {
			semanticConflict_DiffGame_domainspecificdiffs = new EObjectResolvingEList<DiffGame_domainspecificdiffs>(DiffGame_domainspecificdiffs.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GAME_DOMAINSPECIFICDIFFS);
		}
	...
	public EList<DiffGame_semanticconflicts> getSemanticConflict_DiffGame_semanticconflicts() {
		if (semanticConflict_DiffGame_semanticconflicts == null) {
			semanticConflict_DiffGame_semanticconflicts = new EObjectResolvingEList<DiffGame_semanticconflicts>(DiffGame_semanticconflicts.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GAME_SEMANTICCONFLICTS);
		}
	...
	public EList<DiffPositionableEntity_on> getSemanticConflict_DiffPositionableEntity_on() {
		if (semanticConflict_DiffPositionableEntity_on == null) {
			semanticConflict_DiffPositionableEntity_on = new EObjectResolvingEList<DiffPositionableEntity_on>(DiffPositionableEntity_on.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_POSITIONABLE_ENTITY_ON);
		}
	...
	public EList<DiffFruit> getSemanticConflict_DiffFruit() {
		if (semanticConflict_DiffFruit == null) {
			semanticConflict_DiffFruit = new EObjectResolvingEList<DiffFruit>(DiffFruit.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_FRUIT);
		}
	...
	public EList<DiffEnergizer> getSemanticConflict_DiffEnergizer() {
		if (semanticConflict_DiffEnergizer == null) {
			semanticConflict_DiffEnergizer = new EObjectResolvingEList<DiffEnergizer>(DiffEnergizer.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_ENERGIZER);
		}
	...
	public EList<DomainSpecificDiff> getSemanticConflict_DomainSpecificDiff() {
		if (semanticConflict_DomainSpecificDiff == null) {
			semanticConflict_DomainSpecificDiff = new EObjectResolvingEList<DomainSpecificDiff>(DomainSpecificDiff.class, this, Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DOMAIN_SPECIFIC_DIFF);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__NAME:
				return getName();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GRID_NODE:
				return getSemanticConflict_DiffGridNode();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GRID_NODE_UP:
				return getSemanticConflict_DiffGridNode_up();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GRID_NODE_DOWN:
				return getSemanticConflict_DiffGridNode_down();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GRID_NODE_LEFT:
				return getSemanticConflict_DiffGridNode_left();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GRID_NODE_RIGHT:
				return getSemanticConflict_DiffGridNode_right();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_FOOD:
				return getSemanticConflict_DiffFood();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_PACMAN:
				return getSemanticConflict_DiffPacman();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GHOST:
				return getSemanticConflict_DiffGhost();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GAME:
				return getSemanticConflict_DiffGame();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GAME_GRIDNODES:
				return getSemanticConflict_DiffGame_gridnodes();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GAME_ENTITIES:
				return getSemanticConflict_DiffGame_entities();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GAME_DOMAINSPECIFICDIFFS:
				return getSemanticConflict_DiffGame_domainspecificdiffs();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_GAME_SEMANTICCONFLICTS:
				return getSemanticConflict_DiffGame_semanticconflicts();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_POSITIONABLE_ENTITY_ON:
				return getSemanticConflict_DiffPositionableEntity_on();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_FRUIT:
				return getSemanticConflict_DiffFruit();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DIFF_ENERGIZER:
				return getSemanticConflict_DiffEnergizer();
			case Pacman2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTIC_CONFLICT_DOMAIN_SPECIFIC_DIFF:
