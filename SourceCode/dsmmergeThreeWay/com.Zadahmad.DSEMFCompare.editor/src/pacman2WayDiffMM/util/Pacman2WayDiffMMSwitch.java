...
public class Pacman2WayDiffMMSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Pacman2WayDiffMMPackage.DOMAIN_SPECIFIC_DIFF: {
			...
			case Pacman2WayDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS: {
			...
			case Pacman2WayDiffMMPackage.DIFF_GAME_SEMANTICCONFLICTS: {
