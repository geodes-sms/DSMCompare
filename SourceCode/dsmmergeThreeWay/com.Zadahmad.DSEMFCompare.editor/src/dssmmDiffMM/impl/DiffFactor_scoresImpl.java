 ...
 * </p>
 * <ul>
 *   <li>{@link dssmmDiffMM.impl.DiffFactor_scoresImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffFactor_scoresImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffFactor_scoresImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffFactor_scoresImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffFactor_scoresImpl extends MinimalEObjectImpl.Container implements DiffFactor_scores {
	...
	protected EClass eStaticClass() {
		return DssmmDiffMMPackage.Literals.DIFF_FACTOR_SCORES;
	}
	...
	public void setDiff_kind_Left(AscDiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_FACTOR_SCORES__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(AscDiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_FACTOR_SCORES__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_FACTOR_SCORES__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public Score getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DssmmDiffMMPackage.DIFF_FACTOR_SCORES__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(Score newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_FACTOR_SCORES__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DssmmDiffMMPackage.DIFF_FACTOR_SCORES__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case DssmmDiffMMPackage.DIFF_FACTOR_SCORES__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case DssmmDiffMMPackage.DIFF_FACTOR_SCORES__CHANGE_STATUS:
				return getChangeStatus();
			case DssmmDiffMMPackage.DIFF_FACTOR_SCORES__ETYPE:
