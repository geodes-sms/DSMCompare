...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Composite Factor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_FactorID_Left <em>New Factor ID Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_FactorID_Right <em>New Factor ID Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getFactorIDChangeStatus <em>Factor ID Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_Name_Left <em>New Name Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_Name_Right <em>New Name Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNameChangeStatus <em>Name Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_Descr_Left <em>New Descr Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_Descr_Right <em>New Descr Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getDescrChangeStatus <em>Descr Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_GW_Left <em>New GW Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_GW_Right <em>New GW Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getGWChangeStatus <em>GW Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_LW_Left <em>New LW Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_LW_Right <em>New LW Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getLWChangeStatus <em>LW Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_Del_Left <em>New Del Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_Del_Right <em>New Del Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getDelChangeStatus <em>Del Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#isNew_HideOnLine_Left <em>New Hide On Line Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#isNew_HideOnLine_Right <em>New Hide On Line Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getHideOnLineChangeStatus <em>Hide On Line Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_Hierarchy_Left <em>New Hierarchy Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_Hierarchy_Right <em>New Hierarchy Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getHierarchyChangeStatus <em>Hierarchy Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_MasterFactorID_Left <em>New Master Factor ID Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getNew_MasterFactorID_Right <em>New Master Factor ID Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffCompositeFactorImpl#getMasterFactorIDChangeStatus <em>Master Factor ID Change Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffCompositeFactorImpl extends CompositeFactorImpl implements DiffCompositeFactor {
	/**
	 ...
	 * @generated
	 */
	protected DiffCompositeFactorImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DssmmDiffMMPackage.Literals.DIFF_COMPOSITE_FACTOR;
	}
	...
	public void setDiff_kind_Left(ClassDiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(ClassDiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setNew_FactorID_Left(int newNew_FactorID_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_FACTOR_ID_LEFT, oldNew_FactorID_Left, new_FactorID_Left));
	}
	...
	public void setNew_FactorID_Right(int newNew_FactorID_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_FACTOR_ID_RIGHT, oldNew_FactorID_Right, new_FactorID_Right));
	}
	...
	public void setFactorIDChangeStatus(ChangeStatus newFactorIDChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__FACTOR_ID_CHANGE_STATUS, oldFactorIDChangeStatus, factorIDChangeStatus));
	}
	...
	public void setNew_Name_Left(String newNew_Name_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_NAME_LEFT, oldNew_Name_Left, new_Name_Left));
	}
	...
	public void setNew_Name_Right(String newNew_Name_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_NAME_RIGHT, oldNew_Name_Right, new_Name_Right));
	}
	...
	public void setNameChangeStatus(ChangeStatus newNameChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NAME_CHANGE_STATUS, oldNameChangeStatus, nameChangeStatus));
	}
	...
	public void setNew_Descr_Left(String newNew_Descr_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DESCR_LEFT, oldNew_Descr_Left, new_Descr_Left));
	}
	...
	public void setNew_Descr_Right(String newNew_Descr_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DESCR_RIGHT, oldNew_Descr_Right, new_Descr_Right));
	}
	...
	public void setDescrChangeStatus(ChangeStatus newDescrChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__DESCR_CHANGE_STATUS, oldDescrChangeStatus, descrChangeStatus));
	}
	...
	public void setNew_GW_Left(float newNew_GW_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_GW_LEFT, oldNew_GW_Left, new_GW_Left));
	}
	...
	public void setNew_GW_Right(float newNew_GW_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_GW_RIGHT, oldNew_GW_Right, new_GW_Right));
	}
	...
	public void setGWChangeStatus(ChangeStatus newGWChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__GW_CHANGE_STATUS, oldGWChangeStatus, gwChangeStatus));
	}
	...
	public void setNew_LW_Left(float newNew_LW_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_LW_LEFT, oldNew_LW_Left, new_LW_Left));
	}
	...
	public void setNew_LW_Right(float newNew_LW_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_LW_RIGHT, oldNew_LW_Right, new_LW_Right));
	}
	...
	public void setLWChangeStatus(ChangeStatus newLWChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__LW_CHANGE_STATUS, oldLWChangeStatus, lwChangeStatus));
	}
	...
	public void setNew_Del_Left(Boolean newNew_Del_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DEL_LEFT, oldNew_Del_Left, new_Del_Left));
	}
	...
	public void setNew_Del_Right(Boolean newNew_Del_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DEL_RIGHT, oldNew_Del_Right, new_Del_Right));
	}
	...
	public void setDelChangeStatus(ChangeStatus newDelChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__DEL_CHANGE_STATUS, oldDelChangeStatus, delChangeStatus));
	}
	...
	public void setNew_HideOnLine_Left(boolean newNew_HideOnLine_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIDE_ON_LINE_LEFT, oldNew_HideOnLine_Left, new_HideOnLine_Left));
	}
	...
	public void setNew_HideOnLine_Right(boolean newNew_HideOnLine_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIDE_ON_LINE_RIGHT, oldNew_HideOnLine_Right, new_HideOnLine_Right));
	}
	...
	public void setHideOnLineChangeStatus(ChangeStatus newHideOnLineChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__HIDE_ON_LINE_CHANGE_STATUS, oldHideOnLineChangeStatus, hideOnLineChangeStatus));
	}
	...
	public void setNew_Hierarchy_Left(String newNew_Hierarchy_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIERARCHY_LEFT, oldNew_Hierarchy_Left, new_Hierarchy_Left));
	}
	...
	public void setNew_Hierarchy_Right(String newNew_Hierarchy_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIERARCHY_RIGHT, oldNew_Hierarchy_Right, new_Hierarchy_Right));
	}
	...
	public void setHierarchyChangeStatus(ChangeStatus newHierarchyChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__HIERARCHY_CHANGE_STATUS, oldHierarchyChangeStatus, hierarchyChangeStatus));
	}
	...
	public void setNew_MasterFactorID_Left(int newNew_MasterFactorID_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_MASTER_FACTOR_ID_LEFT, oldNew_MasterFactorID_Left, new_MasterFactorID_Left));
	}
	...
	public void setNew_MasterFactorID_Right(int newNew_MasterFactorID_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_MASTER_FACTOR_ID_RIGHT, oldNew_MasterFactorID_Right, new_MasterFactorID_Right));
	}
	...
	public void setMasterFactorIDChangeStatus(ChangeStatus newMasterFactorIDChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__MASTER_FACTOR_ID_CHANGE_STATUS, oldMasterFactorIDChangeStatus, masterFactorIDChangeStatus));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__CHANGE_STATUS:
				return getChangeStatus();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_FACTOR_ID_LEFT:
				return getNew_FactorID_Left();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_FACTOR_ID_RIGHT:
				return getNew_FactorID_Right();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__FACTOR_ID_CHANGE_STATUS:
				return getFactorIDChangeStatus();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_NAME_LEFT:
				return getNew_Name_Left();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_NAME_RIGHT:
				return getNew_Name_Right();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NAME_CHANGE_STATUS:
				return getNameChangeStatus();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DESCR_LEFT:
				return getNew_Descr_Left();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DESCR_RIGHT:
				return getNew_Descr_Right();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__DESCR_CHANGE_STATUS:
				return getDescrChangeStatus();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_GW_LEFT:
				return getNew_GW_Left();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_GW_RIGHT:
				return getNew_GW_Right();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__GW_CHANGE_STATUS:
				return getGWChangeStatus();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_LW_LEFT:
				return getNew_LW_Left();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_LW_RIGHT:
				return getNew_LW_Right();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__LW_CHANGE_STATUS:
				return getLWChangeStatus();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DEL_LEFT:
				return getNew_Del_Left();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DEL_RIGHT:
				return getNew_Del_Right();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__DEL_CHANGE_STATUS:
				return getDelChangeStatus();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIDE_ON_LINE_LEFT:
				return isNew_HideOnLine_Left();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIDE_ON_LINE_RIGHT:
				return isNew_HideOnLine_Right();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__HIDE_ON_LINE_CHANGE_STATUS:
				return getHideOnLineChangeStatus();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIERARCHY_LEFT:
				return getNew_Hierarchy_Left();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIERARCHY_RIGHT:
				return getNew_Hierarchy_Right();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__HIERARCHY_CHANGE_STATUS:
				return getHierarchyChangeStatus();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_MASTER_FACTOR_ID_LEFT:
				return getNew_MasterFactorID_Left();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_MASTER_FACTOR_ID_RIGHT:
				return getNew_MasterFactorID_Right();
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR__MASTER_FACTOR_ID_CHANGE_STATUS:
