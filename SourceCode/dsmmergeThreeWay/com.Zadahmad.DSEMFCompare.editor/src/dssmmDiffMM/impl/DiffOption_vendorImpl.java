...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Option vendor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dssmmDiffMM.impl.DiffOption_vendorImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffOption_vendorImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffOption_vendorImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffOption_vendorImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffOption_vendorImpl extends MinimalEObjectImpl.Container implements DiffOption_vendor {
	/**
	 ...
	 * @generated
	 */
	protected DiffOption_vendorImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DssmmDiffMMPackage.Literals.DIFF_OPTION_VENDOR;
	}
	...
	public void setDiff_kind_Left(AscDiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_OPTION_VENDOR__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(AscDiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_OPTION_VENDOR__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_OPTION_VENDOR__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public Vendor getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DssmmDiffMMPackage.DIFF_OPTION_VENDOR__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(Vendor newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_OPTION_VENDOR__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DssmmDiffMMPackage.DIFF_OPTION_VENDOR__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case DssmmDiffMMPackage.DIFF_OPTION_VENDOR__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case DssmmDiffMMPackage.DIFF_OPTION_VENDOR__CHANGE_STATUS:
				return getChangeStatus();
			case DssmmDiffMMPackage.DIFF_OPTION_VENDOR__ETYPE:
