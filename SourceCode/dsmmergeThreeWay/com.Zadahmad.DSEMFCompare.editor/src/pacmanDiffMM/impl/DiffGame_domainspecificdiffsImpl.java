 ...
 * </p>
 * <ul>
 *   <li>{@link pacmanDiffMM.impl.DiffGame_domainspecificdiffsImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGame_domainspecificdiffsImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGame_domainspecificdiffsImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGame_domainspecificdiffsImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffGame_domainspecificdiffsImpl extends MinimalEObjectImpl.Container implements DiffGame_domainspecificdiffs {
	...
	protected EClass eStaticClass() {
		return PacmanDiffMMPackage.Literals.DIFF_GAME_DOMAINSPECIFICDIFFS;
	}
	...
	public void setDiff_kind_Left(AscDiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(AscDiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public DomainSpecificDiff getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PacmanDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(DomainSpecificDiff newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PacmanDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case PacmanDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case PacmanDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__CHANGE_STATUS:
				return getChangeStatus();
			case PacmanDiffMMPackage.DIFF_GAME_DOMAINSPECIFICDIFFS__ETYPE:
