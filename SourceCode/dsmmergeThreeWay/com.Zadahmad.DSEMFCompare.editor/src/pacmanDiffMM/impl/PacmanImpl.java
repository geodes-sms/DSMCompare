 ...
 * </p>
 * <ul>
 *   <li>{@link pacmanDiffMM.impl.PacmanImpl#getInitialPosition <em>Initial Position</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PacmanImpl extends PositionableEntityImpl implements Pacman {
	...
	protected EClass eStaticClass() {
		return PacmanDiffMMPackage.Literals.PACMAN;
	}
	...
	public void setInitialPosition(String newInitialPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.PACMAN__INITIAL_POSITION, oldInitialPosition, initialPosition));
	}
