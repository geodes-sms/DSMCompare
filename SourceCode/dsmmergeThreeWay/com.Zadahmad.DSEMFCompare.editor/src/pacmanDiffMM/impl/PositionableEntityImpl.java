 ...
 * </p>
 * <ul>
 *   <li>{@link pacmanDiffMM.impl.PositionableEntityImpl#getOn <em>On</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.PositionableEntityImpl#getId <em>Id</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.PositionableEntityImpl#getDiffon <em>Diffon</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PositionableEntityImpl extends MinimalEObjectImpl.Container implements PositionableEntity {
	...
	protected EClass eStaticClass() {
		return PacmanDiffMMPackage.Literals.POSITIONABLE_ENTITY;
	}
		...
		if (on != null && on.eIsProxy()) {
			...
			if (on != oldOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PacmanDiffMMPackage.POSITIONABLE_ENTITY__ON, oldOn, on));
			}
		}
		return on;
	}
	...
	public void setOn(GridNode newOn) {
		...
		on = newOn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.POSITIONABLE_ENTITY__ON, oldOn, on));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.POSITIONABLE_ENTITY__ID, oldId, id));
	}
	...
	public EList<DiffPositionableEntity_on> getDiffon() {
		if (diffon == null) {
			diffon = new EObjectContainmentEList<DiffPositionableEntity_on>(DiffPositionableEntity_on.class, this, PacmanDiffMMPackage.POSITIONABLE_ENTITY__DIFFON);
		}
		return diffon;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PacmanDiffMMPackage.POSITIONABLE_ENTITY__DIFFON:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PacmanDiffMMPackage.POSITIONABLE_ENTITY__ON:
				if (resolve) return getOn();
				return basicGetOn();
			case PacmanDiffMMPackage.POSITIONABLE_ENTITY__ID:
				return getId();
			case PacmanDiffMMPackage.POSITIONABLE_ENTITY__DIFFON:
				return getDiffon();
		}
