 ...
 * </p>
 * <ul>
 *   <li>{@link pacmanDiffMM.DiffGame_domainspecificdiffs#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link pacmanDiffMM.DiffGame_domainspecificdiffs#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link pacmanDiffMM.DiffGame_domainspecificdiffs#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link pacmanDiffMM.DiffGame_domainspecificdiffs#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @see pacmanDiffMM.PacmanDiffMMPackage#getDiffGame_domainspecificdiffs()
 * @model
 * @generated
 */
public interface DiffGame_domainspecificdiffs extends EObject {
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getDiffGame_domainspecificdiffs_Diff_kind_Left()
	...
	/**
	 * Sets the value of the '{@link pacmanDiffMM.DiffGame_domainspecificdiffs#getDiff_kind_Left <em>Diff kind Left</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getDiffGame_domainspecificdiffs_Diff_kind_Right()
	 * @model default="NON" unique="false" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link pacmanDiffMM.DiffGame_domainspecificdiffs#getDiff_kind_Right <em>Diff kind Right</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getDiffGame_domainspecificdiffs_ChangeStatus()
	 * @model default="NON" unique="false" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link pacmanDiffMM.DiffGame_domainspecificdiffs#getChangeStatus <em>Change Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getDiffGame_domainspecificdiffs_EType()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link pacmanDiffMM.DiffGame_domainspecificdiffs#getEType <em>EType</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
