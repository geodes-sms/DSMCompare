 ...
 * @generated
 */
public class PacmanDiffMMSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PacmanDiffMMPackage.PACMAN: {
			...
			case PacmanDiffMMPackage.GHOST: {
			...
			case PacmanDiffMMPackage.ENERGIZER: {
			...
			case PacmanDiffMMPackage.DIFF_PACMAN: {
			...
			case PacmanDiffMMPackage.DIFF_GHOST: {
			...
			case PacmanDiffMMPackage.DIFF_GAME: {
			...
			case PacmanDiffMMPackage.DIFF_GAME_SEMANTICCONFLICTS: {
				DiffGame_semanticconflicts diffGame_semanticconflicts = (DiffGame_semanticconflicts)theEObject;
				T result = caseDiffGame_semanticconflicts(diffGame_semanticconflicts);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PacmanDiffMMPackage.DIFF_POSITIONABLE_ENTITY_ON: {
			...
			case PacmanDiffMMPackage.DIFF_FRUIT: {
			...
			case PacmanDiffMMPackage.DIFF_ENERGIZER: {
			...
			case PacmanDiffMMPackage._LIST_EINT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Diff Game semanticconflicts</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Diff Game semanticconflicts</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDiffGame_semanticconflicts(DiffGame_semanticconflicts object) {
		return null;
	}
