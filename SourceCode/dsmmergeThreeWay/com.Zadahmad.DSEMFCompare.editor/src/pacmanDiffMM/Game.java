 ...
 * </p>
 * <ul>
 *   <li>{@link pacmanDiffMM.Game#getId <em>Id</em>}</li>
 *   <li>{@link pacmanDiffMM.Game#getLives <em>Lives</em>}</li>
 *   <li>{@link pacmanDiffMM.Game#getScore <em>Score</em>}</li>
 *   <li>{@link pacmanDiffMM.Game#getGridnodes <em>Gridnodes</em>}</li>
 *   <li>{@link pacmanDiffMM.Game#getEntities <em>Entities</em>}</li>
 *   <li>{@link pacmanDiffMM.Game#getDomainspecificdiffs <em>Domainspecificdiffs</em>}</li>
 *   <li>{@link pacmanDiffMM.Game#getSemanticconflicts <em>Semanticconflicts</em>}</li>
 *   <li>{@link pacmanDiffMM.Game#getDiffgridnodes <em>Diffgridnodes</em>}</li>
 *   <li>{@link pacmanDiffMM.Game#getDiffentities <em>Diffentities</em>}</li>
 *   <li>{@link pacmanDiffMM.Game#getDiffdomainspecificdiffs <em>Diffdomainspecificdiffs</em>}</li>
 *   <li>{@link pacmanDiffMM.Game#getDiffsemanticconflicts <em>Diffsemanticconflicts</em>}</li>
 * </ul>
 *
 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame()
 * @model
 * @generated
 */
public interface Game extends EObject {
	 ...
	 * @see #setId(String)
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame_Id()
	 * @model id="true"
	 * @generated
	 */
	String getId();
	...
	/**
	 * Sets the value of the '{@link pacmanDiffMM.Game#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setLives(int)
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame_Lives()
	 * @model default="1"
	 * @generated
	 */
	int getLives();
	...
	/**
	 * Sets the value of the '{@link pacmanDiffMM.Game#getLives <em>Lives</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setScore(int)
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame_Score()
	 * @model default="0"
	 * @generated
	 */
	int getScore();
	...
	/**
	 * Sets the value of the '{@link pacmanDiffMM.Game#getScore <em>Score</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame_Gridnodes()
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame_Entities()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame_Domainspecificdiffs()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame_Semanticconflicts()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame_Diffgridnodes()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame_Diffentities()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame_Diffdomainspecificdiffs()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see pacmanDiffMM.PacmanDiffMMPackage#getGame_Diffsemanticconflicts()
	 * @model containment="true"
	 * @generated
	 */
