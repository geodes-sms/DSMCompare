...
import ecoreDiffMM.impl.ETypeParameterImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern EType Parameter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ecoreRuleMM.impl.Pattern_ETypeParameterImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link ecoreRuleMM.impl.Pattern_ETypeParameterImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_ETypeParameterImpl extends ETypeParameterImpl implements Pattern_ETypeParameter {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_ETypeParameterImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EcoreRuleMMPackage.Literals.PATTERN_ETYPE_PARAMETER;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_ETYPE_PARAMETER__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_ETYPE_PARAMETER__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcoreRuleMMPackage.PATTERN_ETYPE_PARAMETER__ID_PATTERN:
				return getID_Pattern();
			case EcoreRuleMMPackage.PATTERN_ETYPE_PARAMETER__FILTER:
				return isFilter();
		}
