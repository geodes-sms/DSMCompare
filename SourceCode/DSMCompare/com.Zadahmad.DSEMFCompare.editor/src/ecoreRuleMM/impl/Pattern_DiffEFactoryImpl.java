...
import ecoreDiffMM.impl.DiffEFactoryImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff EFactory</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ecoreRuleMM.impl.Pattern_DiffEFactoryImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link ecoreRuleMM.impl.Pattern_DiffEFactoryImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffEFactoryImpl extends DiffEFactoryImpl implements Pattern_DiffEFactory {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffEFactoryImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EcoreRuleMMPackage.Literals.PATTERN_DIFF_EFACTORY;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_DIFF_EFACTORY__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_DIFF_EFACTORY__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcoreRuleMMPackage.PATTERN_DIFF_EFACTORY__ID_PATTERN:
				return getID_Pattern();
			case EcoreRuleMMPackage.PATTERN_DIFF_EFACTORY__FILTER:
				return isFilter();
		}
