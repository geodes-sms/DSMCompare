...
import ecoreDiffMM.impl.EAttributeImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link ecoreRuleMM.impl.Pattern_EAttributeImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link ecoreRuleMM.impl.Pattern_EAttributeImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_EAttributeImpl extends EAttributeImpl implements Pattern_EAttribute {
	...
	protected EClass eStaticClass() {
		return EcoreRuleMMPackage.Literals.PATTERN_EATTRIBUTE;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_EATTRIBUTE__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_EATTRIBUTE__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcoreRuleMMPackage.PATTERN_EATTRIBUTE__ID_PATTERN:
				return getID_Pattern();
			case EcoreRuleMMPackage.PATTERN_EATTRIBUTE__FILTER:
				return isFilter();
		}
