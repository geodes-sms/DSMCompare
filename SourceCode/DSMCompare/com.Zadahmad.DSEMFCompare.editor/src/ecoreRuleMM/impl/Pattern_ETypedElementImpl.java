...
import ecoreDiffMM.impl.ETypedElementImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern ETyped Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ecoreRuleMM.impl.Pattern_ETypedElementImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link ecoreRuleMM.impl.Pattern_ETypedElementImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class Pattern_ETypedElementImpl extends ETypedElementImpl implements Pattern_ETypedElement {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_ETypedElementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EcoreRuleMMPackage.Literals.PATTERN_ETYPED_ELEMENT;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_ETYPED_ELEMENT__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_ETYPED_ELEMENT__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcoreRuleMMPackage.PATTERN_ETYPED_ELEMENT__ID_PATTERN:
				return getID_Pattern();
			case EcoreRuleMMPackage.PATTERN_ETYPED_ELEMENT__FILTER:
				return isFilter();
		}
