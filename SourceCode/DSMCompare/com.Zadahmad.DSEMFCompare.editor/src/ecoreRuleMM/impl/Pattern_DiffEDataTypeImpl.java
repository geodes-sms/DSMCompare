...
import ecoreDiffMM.impl.DiffEDataTypeImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff EData Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ecoreRuleMM.impl.Pattern_DiffEDataTypeImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link ecoreRuleMM.impl.Pattern_DiffEDataTypeImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffEDataTypeImpl extends DiffEDataTypeImpl implements Pattern_DiffEDataType {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffEDataTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EcoreRuleMMPackage.Literals.PATTERN_DIFF_EDATA_TYPE;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_DIFF_EDATA_TYPE__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_DIFF_EDATA_TYPE__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcoreRuleMMPackage.PATTERN_DIFF_EDATA_TYPE__ID_PATTERN:
				return getID_Pattern();
			case EcoreRuleMMPackage.PATTERN_DIFF_EDATA_TYPE__FILTER:
				return isFilter();
		}
