...
import ecoreDiffMM.impl.EOperationImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link ecoreRuleMM.impl.Pattern_EOperationImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link ecoreRuleMM.impl.Pattern_EOperationImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_EOperationImpl extends EOperationImpl implements Pattern_EOperation {
	...
	protected EClass eStaticClass() {
		return EcoreRuleMMPackage.Literals.PATTERN_EOPERATION;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_EOPERATION__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreRuleMMPackage.PATTERN_EOPERATION__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcoreRuleMMPackage.PATTERN_EOPERATION__ID_PATTERN:
				return getID_Pattern();
			case EcoreRuleMMPackage.PATTERN_EOPERATION__FILTER:
				return isFilter();
		}
