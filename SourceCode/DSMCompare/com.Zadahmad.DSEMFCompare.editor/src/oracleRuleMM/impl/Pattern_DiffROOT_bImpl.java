...
import oracleDiffMM.impl.DiffROOT_bImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff ROOT b</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link oracleRuleMM.impl.Pattern_DiffROOT_bImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link oracleRuleMM.impl.Pattern_DiffROOT_bImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffROOT_bImpl extends DiffROOT_bImpl implements Pattern_DiffROOT_b {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffROOT_bImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OracleRuleMMPackage.Literals.PATTERN_DIFF_ROOT_B;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleRuleMMPackage.PATTERN_DIFF_ROOT_B__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleRuleMMPackage.PATTERN_DIFF_ROOT_B__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OracleRuleMMPackage.PATTERN_DIFF_ROOT_B__ID_PATTERN:
				return getID_Pattern();
			case OracleRuleMMPackage.PATTERN_DIFF_ROOT_B__FILTER:
				return isFilter();
		}
