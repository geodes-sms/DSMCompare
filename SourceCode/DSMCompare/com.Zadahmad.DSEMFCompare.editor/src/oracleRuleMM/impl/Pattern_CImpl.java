...
import oracleDiffMM.impl.CImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern C</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link oracleRuleMM.impl.Pattern_CImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link oracleRuleMM.impl.Pattern_CImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_CImpl extends CImpl implements Pattern_C {
	/**
	...
	protected EClass eStaticClass() {
		return OracleRuleMMPackage.Literals.PATTERN_C;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleRuleMMPackage.PATTERN_C__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleRuleMMPackage.PATTERN_C__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OracleRuleMMPackage.PATTERN_C__ID_PATTERN:
				return getID_Pattern();
			case OracleRuleMMPackage.PATTERN_C__FILTER:
				return isFilter();
		}
