...
import oracleDiffMM.impl.ROOTImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link oracleRuleMM.impl.Pattern_ROOTImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link oracleRuleMM.impl.Pattern_ROOTImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_ROOTImpl extends ROOTImpl implements Pattern_ROOT {
	/**
	...
	protected EClass eStaticClass() {
		return OracleRuleMMPackage.Literals.PATTERN_ROOT;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleRuleMMPackage.PATTERN_ROOT__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleRuleMMPackage.PATTERN_ROOT__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OracleRuleMMPackage.PATTERN_ROOT__ID_PATTERN:
				return getID_Pattern();
			case OracleRuleMMPackage.PATTERN_ROOT__FILTER:
				return isFilter();
		}
