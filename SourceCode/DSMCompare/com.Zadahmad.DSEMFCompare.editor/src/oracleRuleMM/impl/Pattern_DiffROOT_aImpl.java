...
import oracleDiffMM.impl.DiffROOT_aImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff ROOT a</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link oracleRuleMM.impl.Pattern_DiffROOT_aImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link oracleRuleMM.impl.Pattern_DiffROOT_aImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffROOT_aImpl extends DiffROOT_aImpl implements Pattern_DiffROOT_a {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffROOT_aImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OracleRuleMMPackage.Literals.PATTERN_DIFF_ROOT_A;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleRuleMMPackage.PATTERN_DIFF_ROOT_A__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleRuleMMPackage.PATTERN_DIFF_ROOT_A__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OracleRuleMMPackage.PATTERN_DIFF_ROOT_A__ID_PATTERN:
				return getID_Pattern();
			case OracleRuleMMPackage.PATTERN_DIFF_ROOT_A__FILTER:
				return isFilter();
		}
