...
import oracleDiffMM.impl.DiffDImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff D</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link oracleRuleMM.impl.Pattern_DiffDImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link oracleRuleMM.impl.Pattern_DiffDImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffDImpl extends DiffDImpl implements Pattern_DiffD {
	/**
	...
	protected EClass eStaticClass() {
		return OracleRuleMMPackage.Literals.PATTERN_DIFF_D;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleRuleMMPackage.PATTERN_DIFF_D__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleRuleMMPackage.PATTERN_DIFF_D__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OracleRuleMMPackage.PATTERN_DIFF_D__ID_PATTERN:
				return getID_Pattern();
			case OracleRuleMMPackage.PATTERN_DIFF_D__FILTER:
				return isFilter();
		}
