...
import arduinoDiffMM.impl.ProjectImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Project</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link arduinoRuleMM.impl.Pattern_ProjectImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link arduinoRuleMM.impl.Pattern_ProjectImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_ProjectImpl extends ProjectImpl implements Pattern_Project {
	/**
	...
	protected EClass eStaticClass() {
		return ArduinoRuleMMPackage.Literals.PATTERN_PROJECT;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoRuleMMPackage.PATTERN_PROJECT__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoRuleMMPackage.PATTERN_PROJECT__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ArduinoRuleMMPackage.PATTERN_PROJECT__FILTER:
				return isFilter();
		}
