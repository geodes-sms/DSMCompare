...
import arduinoDiffMM.impl.FunctionCallImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Function Call</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link arduinoRuleMM.impl.Pattern_FunctionCallImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link arduinoRuleMM.impl.Pattern_FunctionCallImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_FunctionCallImpl extends FunctionCallImpl implements Pattern_FunctionCall {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_FunctionCallImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ArduinoRuleMMPackage.Literals.PATTERN_FUNCTION_CALL;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoRuleMMPackage.PATTERN_FUNCTION_CALL__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoRuleMMPackage.PATTERN_FUNCTION_CALL__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArduinoRuleMMPackage.PATTERN_FUNCTION_CALL__ID_PATTERN:
				return getID_Pattern();
			case ArduinoRuleMMPackage.PATTERN_FUNCTION_CALL__FILTER:
				return isFilter();
		}
