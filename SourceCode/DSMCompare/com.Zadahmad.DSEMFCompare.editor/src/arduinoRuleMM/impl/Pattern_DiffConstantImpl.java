 ...
 *   <li>{@link arduinoRuleMM.impl.Pattern_DiffConstantImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffConstantImpl extends DiffConstantImpl implements Pattern_DiffConstant {
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoRuleMMPackage.PATTERN_DIFF_CONSTANT__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ArduinoRuleMMPackage.PATTERN_DIFF_CONSTANT__FILTER:
				return isFilter();
		}
