...
import arduinoDiffMM.impl.DomainSpecificDiffImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link arduinoRuleMM.impl.Pattern_DomainSpecificDiffImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link arduinoRuleMM.impl.Pattern_DomainSpecificDiffImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DomainSpecificDiffImpl extends DomainSpecificDiffImpl implements Pattern_DomainSpecificDiff {
	...
	protected EClass eStaticClass() {
		return ArduinoRuleMMPackage.Literals.PATTERN_DOMAIN_SPECIFIC_DIFF;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoRuleMMPackage.PATTERN_DOMAIN_SPECIFIC_DIFF__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoRuleMMPackage.PATTERN_DOMAIN_SPECIFIC_DIFF__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ArduinoRuleMMPackage.PATTERN_DOMAIN_SPECIFIC_DIFF__FILTER:
				return isFilter();
		}
