...
import arduinoDiffMM.impl.RepeatImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Repeat</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link arduinoRuleMM.impl.Pattern_RepeatImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link arduinoRuleMM.impl.Pattern_RepeatImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_RepeatImpl extends RepeatImpl implements Pattern_Repeat {
	/**
	...
	protected EClass eStaticClass() {
		return ArduinoRuleMMPackage.Literals.PATTERN_REPEAT;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoRuleMMPackage.PATTERN_REPEAT__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoRuleMMPackage.PATTERN_REPEAT__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ArduinoRuleMMPackage.PATTERN_REPEAT__FILTER:
				return isFilter();
		}
