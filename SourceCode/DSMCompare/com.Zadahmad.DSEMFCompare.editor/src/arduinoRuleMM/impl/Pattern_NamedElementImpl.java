...
import arduinoDiffMM.impl.NamedElementImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link arduinoRuleMM.impl.Pattern_NamedElementImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link arduinoRuleMM.impl.Pattern_NamedElementImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class Pattern_NamedElementImpl extends NamedElementImpl implements Pattern_NamedElement {
	...
	protected EClass eStaticClass() {
		return ArduinoRuleMMPackage.Literals.PATTERN_NAMED_ELEMENT;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoRuleMMPackage.PATTERN_NAMED_ELEMENT__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoRuleMMPackage.PATTERN_NAMED_ELEMENT__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ArduinoRuleMMPackage.PATTERN_NAMED_ELEMENT__FILTER:
				return isFilter();
		}
