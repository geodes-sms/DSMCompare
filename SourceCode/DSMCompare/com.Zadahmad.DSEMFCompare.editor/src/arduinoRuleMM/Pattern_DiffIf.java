 ...
 *   <li>{@link arduinoRuleMM.Pattern_DiffIf#isFilter <em>Filter</em>}</li>
 * </ul>
 *
...
public interface Pattern_DiffIf extends DiffIf {
	 ...
	 * @see arduinoRuleMM.ArduinoRuleMMPackage#getPattern_DiffIf_Filter()
	 * @model required="true"
	 * @generated
	 */
	boolean isFilter();
	...
	/**
	 * Sets the value of the '{@link arduinoRuleMM.Pattern_DiffIf#isFilter <em>Filter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
