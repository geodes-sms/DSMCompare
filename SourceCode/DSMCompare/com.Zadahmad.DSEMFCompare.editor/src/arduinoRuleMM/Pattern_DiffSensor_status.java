 ...
 *   <li>{@link arduinoRuleMM.Pattern_DiffSensor_status#isFilter <em>Filter</em>}</li>
 * </ul>
 *
...
public interface Pattern_DiffSensor_status extends DiffSensor_status {
	 ...
	 * @see arduinoRuleMM.ArduinoRuleMMPackage#getPattern_DiffSensor_status_Filter()
	 * @model required="true"
	 * @generated
	 */
	boolean isFilter();
	...
	/**
	 * Sets the value of the '{@link arduinoRuleMM.Pattern_DiffSensor_status#isFilter <em>Filter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
