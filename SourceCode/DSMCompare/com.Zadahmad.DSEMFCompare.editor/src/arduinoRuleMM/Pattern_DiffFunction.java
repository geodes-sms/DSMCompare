 ...
 *   <li>{@link arduinoRuleMM.Pattern_DiffFunction#isFilter <em>Filter</em>}</li>
 * </ul>
 *
...
public interface Pattern_DiffFunction extends DiffFunction {
	 ...
	 * @see arduinoRuleMM.ArduinoRuleMMPackage#getPattern_DiffFunction_Filter()
	 * @model required="true"
	 * @generated
	 */
	boolean isFilter();
	...
	/**
	 * Sets the value of the '{@link arduinoRuleMM.Pattern_DiffFunction#isFilter <em>Filter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
