 ...
 * </p>
 * <ul>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#getNew_name <em>New name</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#isNew_ordered <em>New ordered</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#isNew_unique <em>New unique</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#getNew_lowerBound <em>New lower Bound</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#getNew_upperBound <em>New upper Bound</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#isNew_many <em>New many</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#isNew_required <em>New required</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#isNew_changeable <em>New changeable</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#isNew_volatile <em>New volatile</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#isNew_transient <em>New transient</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#getNew_defaultValueLiteral <em>New default Value Literal</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#getNew_defaultValue <em>New default Value</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#isNew_unsettable <em>New unsettable</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#isNew_derived <em>New derived</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEAttributeImpl#isNew_iD <em>New iD</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEAttributeImpl extends EAttributeImpl implements DiffEAttribute {
	...
	/**
	 * The default value of the '{@link #isNew_iD() <em>New iD</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isNew_iD()
	 * @generated
	 * @ordered
	 */
	protected static final boolean NEW_ID_EDEFAULT = false;

	/**
	 * The cached value of the '{@link #isNew_iD() <em>New iD</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isNew_iD()
	 * @generated
	 * @ordered
	 */
	protected boolean new_iD = NEW_ID_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return EcoreDiffMMPackage.eINSTANCE.getDiffEAttribute();
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_NAME, oldNew_name, new_name));
	}
	...
	public void setNew_ordered(boolean newNew_ordered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_ORDERED, oldNew_ordered, new_ordered));
	}
	...
	public void setNew_unique(boolean newNew_unique) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_UNIQUE, oldNew_unique, new_unique));
	}
	...
	public void setNew_lowerBound(int newNew_lowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_LOWER_BOUND, oldNew_lowerBound, new_lowerBound));
	}
	...
	public void setNew_upperBound(int newNew_upperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_UPPER_BOUND, oldNew_upperBound, new_upperBound));
	}
	...
	public void setNew_many(boolean newNew_many) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_MANY, oldNew_many, new_many));
	}
	...
	public void setNew_required(boolean newNew_required) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_REQUIRED, oldNew_required, new_required));
	}
	...
	public void setNew_changeable(boolean newNew_changeable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_CHANGEABLE, oldNew_changeable, new_changeable));
	}
	...
	public void setNew_volatile(boolean newNew_volatile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_VOLATILE, oldNew_volatile, new_volatile));
	}
	...
	public void setNew_transient(boolean newNew_transient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_TRANSIENT, oldNew_transient, new_transient));
	}
	...
	public void setNew_defaultValueLiteral(String newNew_defaultValueLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_DEFAULT_VALUE_LITERAL, oldNew_defaultValueLiteral, new_defaultValueLiteral));
	}
	...
	public void setNew_defaultValue(Object newNew_defaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_DEFAULT_VALUE, oldNew_defaultValue, new_defaultValue));
	}
	...
	public void setNew_unsettable(boolean newNew_unsettable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_UNSETTABLE, oldNew_unsettable, new_unsettable));
	}
	...
	public void setNew_derived(boolean newNew_derived) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_DERIVED, oldNew_derived, new_derived));
	}
	 ...
	 */
	@Override
	public void setNew_iD(boolean newNew_iD) {
		boolean oldNew_iD = new_iD;
		new_iD = newNew_iD;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_ID, oldNew_iD, new_iD));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__OPERATION:
				return getOperation();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_NAME:
				return getNew_name();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_ORDERED:
				return isNew_ordered();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_UNIQUE:
				return isNew_unique();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_LOWER_BOUND:
				return getNew_lowerBound();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_UPPER_BOUND:
				return getNew_upperBound();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_MANY:
				return isNew_many();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_REQUIRED:
				return isNew_required();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_CHANGEABLE:
				return isNew_changeable();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_VOLATILE:
				return isNew_volatile();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_TRANSIENT:
				return isNew_transient();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_DEFAULT_VALUE_LITERAL:
				return getNew_defaultValueLiteral();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_DEFAULT_VALUE:
				return getNew_defaultValue();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_UNSETTABLE:
				return isNew_unsettable();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_DERIVED:
				return isNew_derived();
			case EcoreDiffMMPackage.DIFF_EATTRIBUTE__NEW_ID:
				return isNew_iD();
		}
