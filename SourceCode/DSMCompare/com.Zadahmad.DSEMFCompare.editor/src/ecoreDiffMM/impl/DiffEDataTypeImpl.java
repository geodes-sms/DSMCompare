...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff EData Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ecoreDiffMM.impl.DiffEDataTypeImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEDataTypeImpl#getNew_name <em>New name</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEDataTypeImpl#getNew_instanceClassName <em>New instance Class Name</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEDataTypeImpl#getNew_instanceClass <em>New instance Class</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEDataTypeImpl#getNew_defaultValue <em>New default Value</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEDataTypeImpl#getNew_instanceTypeName <em>New instance Type Name</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEDataTypeImpl#isNew_serializable <em>New serializable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEDataTypeImpl extends EDataTypeImpl implements DiffEDataType {
	/**
	...
	protected EClass eStaticClass() {
		return EcoreDiffMMPackage.eINSTANCE.getDiffEDataType();
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EDATA_TYPE__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_NAME, oldNew_name, new_name));
	}
	...
	public void setNew_instanceClassName(String newNew_instanceClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_INSTANCE_CLASS_NAME, oldNew_instanceClassName, new_instanceClassName));
	}
	...
	public void setNew_instanceClass(Class newNew_instanceClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_INSTANCE_CLASS, oldNew_instanceClass, new_instanceClass));
	}
	...
	public void setNew_defaultValue(Object newNew_defaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_DEFAULT_VALUE, oldNew_defaultValue, new_defaultValue));
	}
	...
	public void setNew_instanceTypeName(String newNew_instanceTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_INSTANCE_TYPE_NAME, oldNew_instanceTypeName, new_instanceTypeName));
	}
	...
	public void setNew_serializable(boolean newNew_serializable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_SERIALIZABLE, oldNew_serializable, new_serializable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcoreDiffMMPackage.DIFF_EDATA_TYPE__OPERATION:
				return getOperation();
			case EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_NAME:
				return getNew_name();
			case EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_INSTANCE_CLASS_NAME:
				return getNew_instanceClassName();
			case EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_INSTANCE_CLASS:
				return getNew_instanceClass();
			case EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_DEFAULT_VALUE:
				return getNew_defaultValue();
			case EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_INSTANCE_TYPE_NAME:
				return getNew_instanceTypeName();
			case EcoreDiffMMPackage.DIFF_EDATA_TYPE__NEW_SERIALIZABLE:
