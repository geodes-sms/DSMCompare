 ...
 * </p>
 * <ul>
 *   <li>{@link ecoreDiffMM.impl.DiffEOperationImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEOperationImpl#getNew_name <em>New name</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEOperationImpl#isNew_ordered <em>New ordered</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEOperationImpl#isNew_unique <em>New unique</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEOperationImpl#getNew_lowerBound <em>New lower Bound</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEOperationImpl#getNew_upperBound <em>New upper Bound</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEOperationImpl#isNew_many <em>New many</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEOperationImpl#isNew_required <em>New required</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEOperationImpl extends EOperationImpl implements DiffEOperation {
	...
	protected EClass eStaticClass() {
		return EcoreDiffMMPackage.eINSTANCE.getDiffEOperation();
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EOPERATION__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EOPERATION__NEW_NAME, oldNew_name, new_name));
	}
	...
	public void setNew_ordered(boolean newNew_ordered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EOPERATION__NEW_ORDERED, oldNew_ordered, new_ordered));
	}
	...
	public void setNew_unique(boolean newNew_unique) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EOPERATION__NEW_UNIQUE, oldNew_unique, new_unique));
	}
	...
	public void setNew_lowerBound(int newNew_lowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EOPERATION__NEW_LOWER_BOUND, oldNew_lowerBound, new_lowerBound));
	}
	...
	public void setNew_upperBound(int newNew_upperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EOPERATION__NEW_UPPER_BOUND, oldNew_upperBound, new_upperBound));
	}
	...
	public void setNew_many(boolean newNew_many) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EOPERATION__NEW_MANY, oldNew_many, new_many));
	}
	...
	public void setNew_required(boolean newNew_required) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EOPERATION__NEW_REQUIRED, oldNew_required, new_required));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcoreDiffMMPackage.DIFF_EOPERATION__OPERATION:
				return getOperation();
			case EcoreDiffMMPackage.DIFF_EOPERATION__NEW_NAME:
				return getNew_name();
			case EcoreDiffMMPackage.DIFF_EOPERATION__NEW_ORDERED:
				return isNew_ordered();
			case EcoreDiffMMPackage.DIFF_EOPERATION__NEW_UNIQUE:
				return isNew_unique();
			case EcoreDiffMMPackage.DIFF_EOPERATION__NEW_LOWER_BOUND:
				return getNew_lowerBound();
			case EcoreDiffMMPackage.DIFF_EOPERATION__NEW_UPPER_BOUND:
				return getNew_upperBound();
			case EcoreDiffMMPackage.DIFF_EOPERATION__NEW_MANY:
				return isNew_many();
			case EcoreDiffMMPackage.DIFF_EOPERATION__NEW_REQUIRED:
