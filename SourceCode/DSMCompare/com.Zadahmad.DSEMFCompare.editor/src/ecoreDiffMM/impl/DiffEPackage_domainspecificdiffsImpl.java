 ...
 * </p>
 * <ul>
 *   <li>{@link ecoreDiffMM.impl.DiffEPackage_domainspecificdiffsImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEPackage_domainspecificdiffsImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEPackage_domainspecificdiffsImpl extends MinimalEObjectImpl.Container implements DiffEPackage_domainspecificdiffs {
	...
	protected EClass eStaticClass() {
		return EcoreDiffMMPackage.eINSTANCE.getDiffEPackage_domainspecificdiffs();
	}
	...
	public void setOperation(AscOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EPACKAGE_DOMAINSPECIFICDIFFS__OPERATION, oldOperation, operation));
	}
	...
	public DomainSpecificDiff getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcoreDiffMMPackage.DIFF_EPACKAGE_DOMAINSPECIFICDIFFS__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(DomainSpecificDiff newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_EPACKAGE_DOMAINSPECIFICDIFFS__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcoreDiffMMPackage.DIFF_EPACKAGE_DOMAINSPECIFICDIFFS__OPERATION:
				return getOperation();
			case EcoreDiffMMPackage.DIFF_EPACKAGE_DOMAINSPECIFICDIFFS__ETYPE:
