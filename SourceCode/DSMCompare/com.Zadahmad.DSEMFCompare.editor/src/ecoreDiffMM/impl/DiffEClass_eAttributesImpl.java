 ...
 * </p>
 * <ul>
 *   <li>{@link ecoreDiffMM.impl.DiffEClass_eAttributesImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link ecoreDiffMM.impl.DiffEClass_eAttributesImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEClass_eAttributesImpl extends MinimalEObjectImpl.Container implements DiffEClass_eAttributes {
	...
	protected EClass eStaticClass() {
		return EcoreDiffMMPackage.eINSTANCE.getDiffEClass_eAttributes();
	}
	...
	public void setOperation(AscOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_ECLASS_EATTRIBUTES__OPERATION, oldOperation, operation));
	}
	...
	public EAttribute getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcoreDiffMMPackage.DIFF_ECLASS_EATTRIBUTES__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(EAttribute newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcoreDiffMMPackage.DIFF_ECLASS_EATTRIBUTES__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcoreDiffMMPackage.DIFF_ECLASS_EATTRIBUTES__OPERATION:
				return getOperation();
			case EcoreDiffMMPackage.DIFF_ECLASS_EATTRIBUTES__ETYPE:
