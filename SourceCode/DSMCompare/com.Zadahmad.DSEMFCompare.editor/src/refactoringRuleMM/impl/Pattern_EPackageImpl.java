...
import refactoringDiffMM.impl.EPackageImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringRuleMM.impl.Pattern_EPackageImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link refactoringRuleMM.impl.Pattern_EPackageImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_EPackageImpl extends EPackageImpl implements Pattern_EPackage {
	...
	protected EClass eStaticClass() {
		return RefactoringRuleMMPackage.Literals.PATTERN_EPACKAGE;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringRuleMMPackage.PATTERN_EPACKAGE__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringRuleMMPackage.PATTERN_EPACKAGE__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringRuleMMPackage.PATTERN_EPACKAGE__ID_PATTERN:
				return getID_Pattern();
			case RefactoringRuleMMPackage.PATTERN_EPACKAGE__FILTER:
				return isFilter();
		}
