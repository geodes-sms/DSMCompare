...
import refactoringDiffMM.impl.DiffEAttributeImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringRuleMM.impl.Pattern_DiffEAttributeImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link refactoringRuleMM.impl.Pattern_DiffEAttributeImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffEAttributeImpl extends DiffEAttributeImpl implements Pattern_DiffEAttribute {
	...
	protected EClass eStaticClass() {
		return RefactoringRuleMMPackage.Literals.PATTERN_DIFF_EATTRIBUTE;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringRuleMMPackage.PATTERN_DIFF_EATTRIBUTE__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringRuleMMPackage.PATTERN_DIFF_EATTRIBUTE__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringRuleMMPackage.PATTERN_DIFF_EATTRIBUTE__ID_PATTERN:
				return getID_Pattern();
			case RefactoringRuleMMPackage.PATTERN_DIFF_EATTRIBUTE__FILTER:
				return isFilter();
		}
