...
import refactoringDiffMM.impl.DiffEReferenceImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringRuleMM.impl.Pattern_DiffEReferenceImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link refactoringRuleMM.impl.Pattern_DiffEReferenceImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffEReferenceImpl extends DiffEReferenceImpl implements Pattern_DiffEReference {
	...
	protected EClass eStaticClass() {
		return RefactoringRuleMMPackage.Literals.PATTERN_DIFF_EREFERENCE;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringRuleMMPackage.PATTERN_DIFF_EREFERENCE__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringRuleMMPackage.PATTERN_DIFF_EREFERENCE__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringRuleMMPackage.PATTERN_DIFF_EREFERENCE__ID_PATTERN:
				return getID_Pattern();
			case RefactoringRuleMMPackage.PATTERN_DIFF_EREFERENCE__FILTER:
				return isFilter();
		}
