...
import PacmanGoRuleMM.impl.PacmanGoRuleMMPackageImpl;
...
public class PacmanGoDiffMMPackageImpl extends EPackageImpl implements PacmanGoDiffMMPackage {
	...
	public static PacmanGoDiffMMPackage init() {
		...
		Object registeredPacmanGoDiffMMPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		PacmanGoDiffMMPackageImpl thePacmanGoDiffMMPackage = registeredPacmanGoDiffMMPackage instanceof PacmanGoDiffMMPackageImpl ? (PacmanGoDiffMMPackageImpl)registeredPacmanGoDiffMMPackage : new PacmanGoDiffMMPackageImpl();

		isInited = true;

		// Obtain or create and register interdependencies
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(PacmanGoRuleMMPackage.eNS_URI);
		PacmanGoRuleMMPackageImpl thePacmanGoRuleMMPackage = (PacmanGoRuleMMPackageImpl)(registeredPackage instanceof PacmanGoRuleMMPackageImpl ? registeredPackage : PacmanGoRuleMMPackage.eINSTANCE);
