...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff D</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link oracleDiffMM.impl.DiffDImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link oracleDiffMM.impl.DiffDImpl#getNew_id <em>New id</em>}</li>
 *   <li>{@link oracleDiffMM.impl.DiffDImpl#getNew_Name <em>New Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffDImpl extends DImpl implements DiffD {
	/**
	...
	protected EClass eStaticClass() {
		return OracleDiffMMPackage.Literals.DIFF_D;
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleDiffMMPackage.DIFF_D__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_id(int newNew_id) {
		...
		new_id = newNew_id;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleDiffMMPackage.DIFF_D__NEW_ID, oldNew_id, new_id));
	}
	...
	public void setNew_Name(String newNew_Name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OracleDiffMMPackage.DIFF_D__NEW_NAME, oldNew_Name, new_Name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OracleDiffMMPackage.DIFF_D__OPERATION:
				return getOperation();
			case OracleDiffMMPackage.DIFF_D__NEW_ID:
				return getNew_id();
			case OracleDiffMMPackage.DIFF_D__NEW_NAME:
				return getNew_Name();
		}
