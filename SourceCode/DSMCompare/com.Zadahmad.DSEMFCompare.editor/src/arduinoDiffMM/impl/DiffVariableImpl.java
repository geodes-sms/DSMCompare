...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Variable</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link arduinoDiffMM.impl.DiffVariableImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffVariableImpl#getNew_value <em>New value</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffVariableImpl#getNew_name <em>New name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffVariableImpl extends VariableImpl implements DiffVariable {
	/**
	...
	protected EClass eStaticClass() {
		return ArduinoDiffMMPackage.Literals.DIFF_VARIABLE;
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_VARIABLE__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_value(String newNew_value) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_VARIABLE__NEW_VALUE, oldNew_value, new_value));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_VARIABLE__NEW_NAME, oldNew_name, new_name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArduinoDiffMMPackage.DIFF_VARIABLE__OPERATION:
				return getOperation();
			case ArduinoDiffMMPackage.DIFF_VARIABLE__NEW_VALUE:
				return getNew_value();
			case ArduinoDiffMMPackage.DIFF_VARIABLE__NEW_NAME:
				return getNew_name();
		}
