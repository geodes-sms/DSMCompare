 ...
 * </p>
 * <ul>
 *   <li>{@link arduinoDiffMM.impl.PinImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PinImpl extends MinimalEObjectImpl.Container implements Pin {
	...
	protected EClass eStaticClass() {
		return ArduinoDiffMMPackage.Literals.PIN;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.PIN__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArduinoDiffMMPackage.PIN__ID:
				return getId();
		}
