 ...
 * </p>
 * <ul>
 *   <li>{@link arduinoDiffMM.impl.ModuleImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.ModuleImpl#getImage <em>Image</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.ModuleImpl#isLevel <em>Level</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.ModuleImpl#getLibrary <em>Library</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ModuleImpl extends NamedElementImpl implements arduinoDiffMM.Module {
	/**
	...
	protected EClass eStaticClass() {
		return ArduinoDiffMMPackage.Literals.MODULE;
	}
	...
	public void setKind(ModuleKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.MODULE__KIND, oldKind, kind));
	}
	...
	public void setImage(String newImage) {
		...
		image = newImage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.MODULE__IMAGE, oldImage, image));
	}
	...
	public void setLevel(boolean newLevel) {
		...
		level = newLevel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.MODULE__LEVEL, oldLevel, level));
	}
	...
	public void setLibrary(Library newLibrary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.MODULE__LIBRARY, oldLibrary, library));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArduinoDiffMMPackage.MODULE__KIND:
				return getKind();
			case ArduinoDiffMMPackage.MODULE__IMAGE:
				return getImage();
			case ArduinoDiffMMPackage.MODULE__LEVEL:
				return isLevel();
			case ArduinoDiffMMPackage.MODULE__LIBRARY:
				return getLibrary();
		}
