...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Boolean Operator</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link arduinoDiffMM.impl.DiffBooleanOperatorImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffBooleanOperatorImpl#getNew_value <em>New value</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffBooleanOperatorImpl#getNew_operator <em>New operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffBooleanOperatorImpl extends BooleanOperatorImpl implements DiffBooleanOperator {
	/**
	 ...
	 * @generated
	 */
	protected DiffBooleanOperatorImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ArduinoDiffMMPackage.Literals.DIFF_BOOLEAN_OPERATOR;
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_BOOLEAN_OPERATOR__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_value(String newNew_value) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_BOOLEAN_OPERATOR__NEW_VALUE, oldNew_value, new_value));
	}
	...
	public void setNew_operator(OperatorKind newNew_operator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_BOOLEAN_OPERATOR__NEW_OPERATOR, oldNew_operator, new_operator));
	}
