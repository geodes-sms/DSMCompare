...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Input Module</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link arduinoDiffMM.impl.DiffInputModuleImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffInputModuleImpl#getNew_name <em>New name</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffInputModuleImpl#getNew_kind <em>New kind</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffInputModuleImpl#getNew_image <em>New image</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffInputModuleImpl#isNew_level <em>New level</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffInputModuleImpl#getNew_library <em>New library</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffInputModuleImpl extends InputModuleImpl implements DiffInputModule {
	/**
	...
	protected EClass eStaticClass() {
		return ArduinoDiffMMPackage.Literals.DIFF_INPUT_MODULE;
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_INPUT_MODULE__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_INPUT_MODULE__NEW_NAME, oldNew_name, new_name));
	}
	...
	public void setNew_kind(ModuleKind newNew_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_INPUT_MODULE__NEW_KIND, oldNew_kind, new_kind));
	}
	...
	public void setNew_image(String newNew_image) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_INPUT_MODULE__NEW_IMAGE, oldNew_image, new_image));
	}
	...
	public void setNew_level(boolean newNew_level) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_INPUT_MODULE__NEW_LEVEL, oldNew_level, new_level));
	}
	...
	public void setNew_library(Library newNew_library) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_INPUT_MODULE__NEW_LIBRARY, oldNew_library, new_library));
	}
