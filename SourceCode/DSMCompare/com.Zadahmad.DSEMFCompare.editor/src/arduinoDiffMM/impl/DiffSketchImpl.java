...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Sketch</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link arduinoDiffMM.impl.DiffSketchImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffSketchImpl#getNew_name <em>New name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffSketchImpl extends SketchImpl implements DiffSketch {
	/**
	...
	protected EClass eStaticClass() {
		return ArduinoDiffMMPackage.Literals.DIFF_SKETCH;
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_SKETCH__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_SKETCH__NEW_NAME, oldNew_name, new_name));
	}
