...
public class Digraph {
     ...
     */
    public Digraph isolateNode(int v) {
        validateVertex(v);
    ...
    public ArrayList<Integer> inVertices(int w){
    	ArrayList<Integer> inW= new ArrayList<Integer>();
    	int v = -1;
    	for(Bag<Integer> adjI: adj) {
    		v=v+1;
    		Iterator<Integer> Ws = adjI.iterator();
    		for(;Ws.hasNext();) {
    		  Integer wI = Ws.next();
    		  if(wI==w) {
    			  inW.add(v);
    ...
    public String toString() {
        ...
        return s.toString();
    		...
    		System.out.print("There is error in writing graph!");
    		return "";
    	}        
    }
