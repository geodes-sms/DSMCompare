 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.DiffEClass_ereferences#getOperation <em>Operation</em>}</li>
...
public interface DiffEClass_ereferences extends EObject {
	 ...
	 * @see refactoringDiffMM.RefactoringDiffMMPackage#getDiffEClass_ereferences_Operation()
	 * @model required="true"
	 * @generated
	 */
	AscOp getOperation();
	...
	/**
	 * Sets the value of the '{@link refactoringDiffMM.DiffEClass_ereferences#getOperation <em>Operation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
