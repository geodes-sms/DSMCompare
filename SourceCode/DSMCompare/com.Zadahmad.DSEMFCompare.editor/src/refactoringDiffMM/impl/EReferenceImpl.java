 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.EReferenceImpl#getName <em>Name</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.EReferenceImpl#getEtype <em>Etype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EReferenceImpl extends MinimalEObjectImpl.Container implements EReference {
	...
	protected EClass eStaticClass() {
		return RefactoringDiffMMPackage.Literals.EREFERENCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.EREFERENCE__NAME, oldName, name));
	}
	...
	public void setEtype(String newEtype) {
		...
		etype = newEtype;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.EREFERENCE__ETYPE, oldEtype, etype));
	}
