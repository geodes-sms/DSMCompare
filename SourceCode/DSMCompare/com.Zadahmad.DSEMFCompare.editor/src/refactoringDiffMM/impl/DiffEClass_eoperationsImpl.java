 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.DiffEClass_eoperationsImpl#getOperation <em>Operation</em>}</li>
...
public class DiffEClass_eoperationsImpl extends MinimalEObjectImpl.Container implements DiffEClass_eoperations {
	...
	public void setOperation(AscOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_ECLASS_EOPERATIONS__OPERATION, oldOperation, operation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringDiffMMPackage.DIFF_ECLASS_EOPERATIONS__OPERATION:
				return getOperation();
