 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.DiffEAttributeImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEAttributeImpl#getNew_name <em>New name</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEAttributeImpl#getNew_etype <em>New etype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEAttributeImpl extends EAttributeImpl implements DiffEAttribute {
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EATTRIBUTE__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EATTRIBUTE__NEW_NAME, oldNew_name, new_name));
	}
	...
	public void setNew_etype(String newNew_etype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EATTRIBUTE__NEW_ETYPE, oldNew_etype, new_etype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringDiffMMPackage.DIFF_EATTRIBUTE__OPERATION:
				return getOperation();
			case RefactoringDiffMMPackage.DIFF_EATTRIBUTE__NEW_NAME:
				return getNew_name();
			case RefactoringDiffMMPackage.DIFF_EATTRIBUTE__NEW_ETYPE:
				return getNew_etype();
		}
