 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.DiffEClass_esupertypesImpl#getOperation <em>Operation</em>}</li>
...
public class DiffEClass_esupertypesImpl extends MinimalEObjectImpl.Container implements DiffEClass_esupertypes {
	...
	public void setOperation(AscOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_ECLASS_ESUPERTYPES__OPERATION, oldOperation, operation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringDiffMMPackage.DIFF_ECLASS_ESUPERTYPES__OPERATION:
				return getOperation();
