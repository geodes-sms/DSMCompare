 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackageImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackageImpl#getNew_name <em>New name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEPackageImpl extends EPackageImpl implements DiffEPackage {
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE__NEW_NAME, oldNew_name, new_name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringDiffMMPackage.DIFF_EPACKAGE__OPERATION:
				return getOperation();
			case RefactoringDiffMMPackage.DIFF_EPACKAGE__NEW_NAME:
				return getNew_name();
		}
