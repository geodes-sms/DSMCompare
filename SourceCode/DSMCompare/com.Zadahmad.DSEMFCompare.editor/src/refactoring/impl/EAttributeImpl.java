 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring.impl.EAttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link refactoring.impl.EAttributeImpl#getEtype <em>Etype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EAttributeImpl extends MinimalEObjectImpl.Container implements EAttribute {
	...
	protected EClass eStaticClass() {
		return RefactoringPackage.Literals.EATTRIBUTE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringPackage.EATTRIBUTE__NAME, oldName, name));
	}
	...
	public void setEtype(String newEtype) {
		...
		etype = newEtype;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringPackage.EATTRIBUTE__ETYPE, oldEtype, etype));
	}
