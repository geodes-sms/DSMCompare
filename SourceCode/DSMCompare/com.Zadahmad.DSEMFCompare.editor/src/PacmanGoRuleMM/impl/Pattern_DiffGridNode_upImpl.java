...
import PacmanGoDiffMM.impl.DiffGridNode_upImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link PacmanGoRuleMM.impl.Pattern_DiffGridNode_upImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link PacmanGoRuleMM.impl.Pattern_DiffGridNode_upImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffGridNode_upImpl extends DiffGridNode_upImpl implements Pattern_DiffGridNode_up {
	...
	protected EClass eStaticClass() {
		return PacmanGoRuleMMPackage.Literals.PATTERN_DIFF_GRID_NODE_UP;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoRuleMMPackage.PATTERN_DIFF_GRID_NODE_UP__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoRuleMMPackage.PATTERN_DIFF_GRID_NODE_UP__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PacmanGoRuleMMPackage.PATTERN_DIFF_GRID_NODE_UP__FILTER:
				return isFilter();
		}
