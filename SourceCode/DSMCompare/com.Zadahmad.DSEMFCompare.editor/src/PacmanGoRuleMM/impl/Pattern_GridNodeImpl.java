...
import PacmanGoDiffMM.impl.GridNodeImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link PacmanGoRuleMM.impl.Pattern_GridNodeImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link PacmanGoRuleMM.impl.Pattern_GridNodeImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_GridNodeImpl extends GridNodeImpl implements Pattern_GridNode {
	...
	protected EClass eStaticClass() {
		return PacmanGoRuleMMPackage.Literals.PATTERN_GRID_NODE;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoRuleMMPackage.PATTERN_GRID_NODE__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoRuleMMPackage.PATTERN_GRID_NODE__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PacmanGoRuleMMPackage.PATTERN_GRID_NODE__FILTER:
				return isFilter();
		}
