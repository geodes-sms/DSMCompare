...
import PacmanGoDiffMM.impl.FoodImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link PacmanGoRuleMM.impl.Pattern_FoodImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link PacmanGoRuleMM.impl.Pattern_FoodImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_FoodImpl extends FoodImpl implements Pattern_Food {
	...
	protected EClass eStaticClass() {
		return PacmanGoRuleMMPackage.Literals.PATTERN_FOOD;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoRuleMMPackage.PATTERN_FOOD__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoRuleMMPackage.PATTERN_FOOD__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PacmanGoRuleMMPackage.PATTERN_FOOD__FILTER:
				return isFilter();
		}
