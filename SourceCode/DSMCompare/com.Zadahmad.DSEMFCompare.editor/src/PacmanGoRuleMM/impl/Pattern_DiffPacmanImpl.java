...
import PacmanGoDiffMM.impl.DiffPacmanImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link PacmanGoRuleMM.impl.Pattern_DiffPacmanImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link PacmanGoRuleMM.impl.Pattern_DiffPacmanImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffPacmanImpl extends DiffPacmanImpl implements Pattern_DiffPacman {
	...
	protected EClass eStaticClass() {
		return PacmanGoRuleMMPackage.Literals.PATTERN_DIFF_PACMAN;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoRuleMMPackage.PATTERN_DIFF_PACMAN__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoRuleMMPackage.PATTERN_DIFF_PACMAN__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PacmanGoRuleMMPackage.PATTERN_DIFF_PACMAN__FILTER:
				return isFilter();
		}
