...
import PacmanGoDiffMM.impl.DiffGridNodeImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link PacmanGoRuleMM.impl.Pattern_DiffGridNodeImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link PacmanGoRuleMM.impl.Pattern_DiffGridNodeImpl#isFilter <em>Filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffGridNodeImpl extends DiffGridNodeImpl implements Pattern_DiffGridNode {
	...
	protected EClass eStaticClass() {
		return PacmanGoRuleMMPackage.Literals.PATTERN_DIFF_GRID_NODE;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoRuleMMPackage.PATTERN_DIFF_GRID_NODE__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoRuleMMPackage.PATTERN_DIFF_GRID_NODE__FILTER, oldFilter, filter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PacmanGoRuleMMPackage.PATTERN_DIFF_GRID_NODE__FILTER:
				return isFilter();
		}
