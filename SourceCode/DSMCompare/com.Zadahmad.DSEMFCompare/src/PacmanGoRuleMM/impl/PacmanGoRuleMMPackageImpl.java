...
public class PacmanGoRuleMMPackageImpl extends EPackageImpl implements PacmanGoRuleMMPackage {
	...
	public static PacmanGoRuleMMPackage init() {
		...
		PacmanGoRuleMMPackageImpl thePacmanGoRuleMMPackage = (PacmanGoRuleMMPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PacmanGoRuleMMPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PacmanGoRuleMMPackageImpl());

		isInited = true;

		// Initialize simple dependencies
		PacmanGoDiffMMPackage.eINSTANCE.eClass();
