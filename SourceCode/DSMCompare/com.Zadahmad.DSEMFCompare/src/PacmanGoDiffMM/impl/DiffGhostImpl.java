 ...
 * </p>
 * <ul>
 *   <li>{@link PacmanGoDiffMM.impl.DiffGhostImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link PacmanGoDiffMM.impl.DiffGhostImpl#getNew_id <em>New id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffGhostImpl extends GhostImpl implements DiffGhost {
	...
	protected EClass eStaticClass() {
		return PacmanGoDiffMMPackage.Literals.DIFF_GHOST;
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoDiffMMPackage.DIFF_GHOST__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_id(String newNew_id) {
		...
		new_id = newNew_id;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoDiffMMPackage.DIFF_GHOST__NEW_ID, oldNew_id, new_id));
	}
