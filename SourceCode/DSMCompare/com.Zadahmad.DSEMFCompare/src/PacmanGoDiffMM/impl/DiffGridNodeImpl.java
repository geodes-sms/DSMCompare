 ...
 * </p>
 * <ul>
 *   <li>{@link PacmanGoDiffMM.impl.DiffGridNodeImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link PacmanGoDiffMM.impl.DiffGridNodeImpl#getNew_id <em>New id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffGridNodeImpl extends GridNodeImpl implements DiffGridNode {
	...
	protected EClass eStaticClass() {
		return PacmanGoDiffMMPackage.Literals.DIFF_GRID_NODE;
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoDiffMMPackage.DIFF_GRID_NODE__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_id(String newNew_id) {
		...
		new_id = newNew_id;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoDiffMMPackage.DIFF_GRID_NODE__NEW_ID, oldNew_id, new_id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PacmanGoDiffMMPackage.DIFF_GRID_NODE__OPERATION:
				return getOperation();
			case PacmanGoDiffMMPackage.DIFF_GRID_NODE__NEW_ID:
				return getNew_id();
		}
