 ...
 * </p>
 * <ul>
 *   <li>{@link PacmanGoDiffMM.impl.DiffGameImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffGameImpl extends GameImpl implements DiffGame {
	...
	protected EClass eStaticClass() {
		return PacmanGoDiffMMPackage.Literals.DIFF_GAME;
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoDiffMMPackage.DIFF_GAME__OPERATION, oldOperation, operation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PacmanGoDiffMMPackage.DIFF_GAME__OPERATION:
				return getOperation();
		}
