 ...
 * </p>
 * <ul>
 *   <li>{@link PacmanGoDiffMM.impl.DiffPacmanImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link PacmanGoDiffMM.impl.DiffPacmanImpl#getNew_id <em>New id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffPacmanImpl extends PacmanImpl implements DiffPacman {
	...
	protected EClass eStaticClass() {
		return PacmanGoDiffMMPackage.Literals.DIFF_PACMAN;
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoDiffMMPackage.DIFF_PACMAN__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_id(String newNew_id) {
		...
		new_id = newNew_id;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoDiffMMPackage.DIFF_PACMAN__NEW_ID, oldNew_id, new_id));
	}
