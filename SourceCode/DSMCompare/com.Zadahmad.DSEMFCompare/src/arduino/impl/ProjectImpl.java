 ...
 * </p>
 * <ul>
 *   <li>{@link arduino.impl.ProjectImpl#getHardware <em>Hardware</em>}</li>
 *   <li>{@link arduino.impl.ProjectImpl#getSketch <em>Sketch</em>}</li>
 *   <li>{@link arduino.impl.ProjectImpl#getModules <em>Modules</em>}</li>
 *   <li>{@link arduino.impl.ProjectImpl#getPlatform <em>Platform</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProjectImpl extends MinimalEObjectImpl.Container implements Project {
	...
	public EList<arduino.Module> getModules() {
		if (modules == null) {
			modules = new EObjectContainmentEList<arduino.Module>(arduino.Module.class, this, ArduinoPackage.PROJECT__MODULES);
		}
		return modules;
	}
