 ...
 * </p>
 * <ul>
 *   <li>{@link PacmanGo.impl.PositionableEntityImpl#getOn <em>On</em>}</li>
 *   <li>{@link PacmanGo.impl.PositionableEntityImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PositionableEntityImpl extends MinimalEObjectImpl.Container implements PositionableEntity {
	...
	protected EClass eStaticClass() {
		return PacmanGoPackage.Literals.POSITIONABLE_ENTITY;
	}
		...
		if (on != null && on.eIsProxy()) {
			...
			if (on != oldOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PacmanGoPackage.POSITIONABLE_ENTITY__ON, oldOn, on));
			}
		}
		return on;
	}
	...
	public void setOn(GridNode newOn) {
		...
		on = newOn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoPackage.POSITIONABLE_ENTITY__ON, oldOn, on));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanGoPackage.POSITIONABLE_ENTITY__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PacmanGoPackage.POSITIONABLE_ENTITY__ON:
				if (resolve) return getOn();
				return basicGetOn();
			case PacmanGoPackage.POSITIONABLE_ENTITY__ID:
				return getId();
		}
