...
public class PacmanGoPackageImpl extends EPackageImpl implements PacmanGoPackage {
	...
	public static PacmanGoPackage init() {
		...
		PacmanGoPackageImpl thePacmanGoPackage = (PacmanGoPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PacmanGoPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PacmanGoPackageImpl());
