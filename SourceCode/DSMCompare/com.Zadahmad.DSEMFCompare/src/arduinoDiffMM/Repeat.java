 ...
 * </p>
 * <ul>
 *   <li>{@link arduinoDiffMM.Repeat#getIteration <em>Iteration</em>}</li>
 * </ul>
 *
 * @see arduinoDiffMM.ArduinoDiffMMPackage#getRepeat()
 * @model
 * @generated
 */
public interface Repeat extends Control {
	 ...
	 * @see arduinoDiffMM.ArduinoDiffMMPackage#getRepeat_Iteration()
	 * @model default="5"
	 * @generated
	 */
	int getIteration();
	...
	/**
	 * Sets the value of the '{@link arduinoDiffMM.Repeat#getIteration <em>Iteration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
