...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Sensor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link arduinoDiffMM.impl.DiffSensorImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffSensorImpl#getNew_value <em>New value</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffSensorImpl#getNew_operator <em>New operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffSensorImpl extends SensorImpl implements DiffSensor {
	/**
	...
	protected EClass eStaticClass() {
		return ArduinoDiffMMPackage.Literals.DIFF_SENSOR;
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_SENSOR__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_value(String newNew_value) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_SENSOR__NEW_VALUE, oldNew_value, new_value));
	}
	...
	public void setNew_operator(OperatorKind newNew_operator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_SENSOR__NEW_OPERATOR, oldNew_operator, new_operator));
	}
