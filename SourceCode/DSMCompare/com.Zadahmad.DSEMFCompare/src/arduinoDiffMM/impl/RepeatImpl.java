 ...
 * </p>
 * <ul>
 *   <li>{@link arduinoDiffMM.impl.RepeatImpl#getIteration <em>Iteration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RepeatImpl extends ControlImpl implements Repeat {
	...
	protected EClass eStaticClass() {
		return ArduinoDiffMMPackage.Literals.REPEAT;
	}
	...
	public void setIteration(int newIteration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.REPEAT__ITERATION, oldIteration, iteration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArduinoDiffMMPackage.REPEAT__ITERATION:
				return getIteration();
		}
