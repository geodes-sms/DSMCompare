...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Analog Pin</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link arduinoDiffMM.impl.DiffAnalogPinImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link arduinoDiffMM.impl.DiffAnalogPinImpl#getNew_id <em>New id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffAnalogPinImpl extends AnalogPinImpl implements DiffAnalogPin {
	/**
	...
	protected EClass eStaticClass() {
		return ArduinoDiffMMPackage.Literals.DIFF_ANALOG_PIN;
	}
	...
	public void setOperation(ClassOp newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_ANALOG_PIN__OPERATION, oldOperation, operation));
	}
	...
	public void setNew_id(int newNew_id) {
		...
		new_id = newNew_id;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoDiffMMPackage.DIFF_ANALOG_PIN__NEW_ID, oldNew_id, new_id));
	}
