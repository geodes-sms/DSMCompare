/**
 */
package activitiesDSL.impl;

import activitiesDSL.ActivitiesDSLFactory;
import activitiesDSL.ActivitiesDSLPackage;
import activitiesDSL.ActivityResource;
import activitiesDSL.Comp;
import activitiesDSL.Culture;
import activitiesDSL.Date;
import activitiesDSL.DelaySinceActivy;
import activitiesDSL.ExploitationActivity;
import activitiesDSL.Frequency;
import activitiesDSL.GrainIs;
import activitiesDSL.Model;
import activitiesDSL.Month;
import activitiesDSL.NoRain;
import activitiesDSL.Predicate;
import activitiesDSL.ResourceKind;
import activitiesDSL.TempOfTheDay;
import activitiesDSL.TempUnit;
...
public class ActivitiesDSLPackageImpl extends EPackageImpl implements ActivitiesDSLPackage {
	 ...
	 * @see activitiesDSL.ActivitiesDSLPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ActivitiesDSLPackage init() {
		...
		Object registeredActivitiesDSLPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ActivitiesDSLPackageImpl theActivitiesDSLPackage = registeredActivitiesDSLPackage instanceof ActivitiesDSLPackageImpl ? (ActivitiesDSLPackageImpl)registeredActivitiesDSLPackage : new ActivitiesDSLPackageImpl();

		isInited = true;

		// Obtain or create and register interdependencies
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(ExploitationPackage.eNS_URI);
		ExploitationPackageImpl theExploitationPackage = (ExploitationPackageImpl)(registeredPackage instanceof ExploitationPackageImpl ? registeredPackage : ExploitationPackage.eINSTANCE);
