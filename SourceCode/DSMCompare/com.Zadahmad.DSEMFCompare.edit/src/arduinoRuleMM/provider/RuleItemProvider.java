...
/**
 * This is the item provider adapter for a {@link arduinoRuleMM.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArduinoRuleMMPackage.Literals.RULE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addConstraintsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_constraints_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_constraints_feature", "_UI_Rule_type"),
				 ArduinoRuleMMPackage.Literals.RULE__CONSTRAINTS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArduinoRuleMMPackage.Literals.RULE__PATTERN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArduinoRuleMMPackage.Literals.RULE__PATTERN,
				 ArduinoRuleMMFactory.eINSTANCE.createPattern_Project()));
	}
