...
/**
 * This is the item provider adapter for a {@link PacmanGoDiffMM.DiffGridNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiffGridNode_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiffGridNode_operation_feature", "_UI_DiffGridNode_type"),
				 PacmanGoDiffMMPackage.Literals.DIFF_GRID_NODE__OPERATION,
				 true,
				 false,
				 false,
	...
	protected void addNew_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiffGridNode_new_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiffGridNode_new_id_feature", "_UI_DiffGridNode_type"),
				 PacmanGoDiffMMPackage.Literals.DIFF_GRID_NODE__NEW_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
