...
/**
 * This is the item provider adapter for a {@link PacmanGoDiffMM.DiffGhost} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiffGhostItemProvider extends GhostItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiffGhost_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiffGhost_operation_feature", "_UI_DiffGhost_type"),
				 PacmanGoDiffMMPackage.Literals.DIFF_GHOST__OPERATION,
				 true,
				 false,
				 false,
	...
	protected void addNew_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiffGhost_new_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiffGhost_new_id_feature", "_UI_DiffGhost_type"),
				 PacmanGoDiffMMPackage.Literals.DIFF_GHOST__NEW_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DiffGhost.class)) {
			case PacmanGoDiffMMPackage.DIFF_GHOST__OPERATION:
			case PacmanGoDiffMMPackage.DIFF_GHOST__NEW_ID:
