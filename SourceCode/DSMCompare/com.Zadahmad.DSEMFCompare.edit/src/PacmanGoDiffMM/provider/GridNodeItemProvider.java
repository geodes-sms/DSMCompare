...
/**
 * This is the item provider adapter for a {@link PacmanGoDiffMM.GridNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GridNodeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PacmanGoDiffMMPackage.Literals.GRID_NODE__UP,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PacmanGoDiffMMPackage.Literals.GRID_NODE__BOTTOM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PacmanGoDiffMMPackage.Literals.GRID_NODE__LEFT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PacmanGoDiffMMPackage.Literals.GRID_NODE__RIGHT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PacmanGoDiffMMPackage.Literals.GRID_NODE__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PacmanGoDiffMMPackage.Literals.GRID_NODE__DIFFUP);
			childrenFeatures.add(PacmanGoDiffMMPackage.Literals.GRID_NODE__DIFFBOTTOM);
			childrenFeatures.add(PacmanGoDiffMMPackage.Literals.GRID_NODE__DIFFLEFT);
			childrenFeatures.add(PacmanGoDiffMMPackage.Literals.GRID_NODE__DIFFRIGHT);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(PacmanGoDiffMMPackage.Literals.GRID_NODE__DIFFUP,
				 PacmanGoDiffMMFactory.eINSTANCE.createDiffGridNode_up()));

		newChildDescriptors.add
			(createChildParameter
				(PacmanGoDiffMMPackage.Literals.GRID_NODE__DIFFBOTTOM,
				 PacmanGoDiffMMFactory.eINSTANCE.createDiffGridNode_bottom()));

		newChildDescriptors.add
			(createChildParameter
				(PacmanGoDiffMMPackage.Literals.GRID_NODE__DIFFLEFT,
				 PacmanGoDiffMMFactory.eINSTANCE.createDiffGridNode_left()));

		newChildDescriptors.add
			(createChildParameter
				(PacmanGoDiffMMPackage.Literals.GRID_NODE__DIFFRIGHT,
				 PacmanGoDiffMMFactory.eINSTANCE.createDiffGridNode_right()));
	}
