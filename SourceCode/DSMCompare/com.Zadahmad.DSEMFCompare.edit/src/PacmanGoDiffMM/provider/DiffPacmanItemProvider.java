...
/**
 * This is the item provider adapter for a {@link PacmanGoDiffMM.DiffPacman} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiffPacmanItemProvider extends PacmanItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiffPacman_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiffPacman_operation_feature", "_UI_DiffPacman_type"),
				 PacmanGoDiffMMPackage.Literals.DIFF_PACMAN__OPERATION,
				 true,
				 false,
				 false,
	...
	protected void addNew_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiffPacman_new_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiffPacman_new_id_feature", "_UI_DiffPacman_type"),
				 PacmanGoDiffMMPackage.Literals.DIFF_PACMAN__NEW_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DiffPacman.class)) {
			case PacmanGoDiffMMPackage.DIFF_PACMAN__OPERATION:
			case PacmanGoDiffMMPackage.DIFF_PACMAN__NEW_ID:
