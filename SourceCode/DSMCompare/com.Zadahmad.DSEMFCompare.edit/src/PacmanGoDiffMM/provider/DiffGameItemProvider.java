...
/**
 * This is the item provider adapter for a {@link PacmanGoDiffMM.DiffGame} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiffGameItemProvider extends GameItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiffGame_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiffGame_operation_feature", "_UI_DiffGame_type"),
				 PacmanGoDiffMMPackage.Literals.DIFF_GAME__OPERATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ClassOp labelValue = ((DiffGame)object).getOperation();
