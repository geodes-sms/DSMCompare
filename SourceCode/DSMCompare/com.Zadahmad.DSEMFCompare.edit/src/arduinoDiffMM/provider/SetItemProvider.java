...
/**
 * This is the item provider adapter for a {@link arduinoDiffMM.Set} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SetItemProvider extends InstructionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArduinoDiffMMPackage.Literals.SET__VARIABLE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArduinoDiffMMPackage.Literals.SET__VALUE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArduinoDiffMMPackage.Literals.SET__DIFFVARIABLE);
			childrenFeatures.add(ArduinoDiffMMPackage.Literals.SET__DIFFVALUE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArduinoDiffMMPackage.Literals.SET__DIFFVARIABLE,
				 ArduinoDiffMMFactory.eINSTANCE.createDiffSet_variable()));

		newChildDescriptors.add
			(createChildParameter
				(ArduinoDiffMMPackage.Literals.SET__DIFFVARIABLE,
				 ArduinoRuleMMFactory.eINSTANCE.createPattern_DiffSet_variable()));

		newChildDescriptors.add
			(createChildParameter
				(ArduinoDiffMMPackage.Literals.SET__DIFFVALUE,
				 ArduinoDiffMMFactory.eINSTANCE.createDiffSet_value()));

		newChildDescriptors.add
			(createChildParameter
				(ArduinoDiffMMPackage.Literals.SET__DIFFVALUE,
				 ArduinoRuleMMFactory.eINSTANCE.createPattern_DiffSet_value()));
	}
