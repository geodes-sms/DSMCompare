...
/**
 * This is the item provider adapter for a {@link arduinoDiffMM.While} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WhileItemProvider extends ControlItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArduinoDiffMMPackage.Literals.WHILE__CONDITION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArduinoDiffMMPackage.Literals.WHILE__DIFFCONDITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArduinoDiffMMPackage.Literals.WHILE__DIFFCONDITION,
				 ArduinoDiffMMFactory.eINSTANCE.createDiffWhile_condition()));

		newChildDescriptors.add
			(createChildParameter
				(ArduinoDiffMMPackage.Literals.WHILE__DIFFCONDITION,
				 ArduinoRuleMMFactory.eINSTANCE.createPattern_DiffWhile_condition()));
	}
