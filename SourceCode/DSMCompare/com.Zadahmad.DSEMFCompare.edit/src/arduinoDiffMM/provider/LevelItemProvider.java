...
/**
 * This is the item provider adapter for a {@link arduinoDiffMM.Level} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LevelItemProvider extends ModuleInstructionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArduinoDiffMMPackage.Literals.LEVEL__LEVEL,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArduinoDiffMMPackage.Literals.LEVEL__DIFFLEVEL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArduinoDiffMMPackage.Literals.LEVEL__DIFFLEVEL,
				 ArduinoDiffMMFactory.eINSTANCE.createDiffLevel_level()));

		newChildDescriptors.add
			(createChildParameter
				(ArduinoDiffMMPackage.Literals.LEVEL__DIFFLEVEL,
				 ArduinoRuleMMFactory.eINSTANCE.createPattern_DiffLevel_level()));
	}
