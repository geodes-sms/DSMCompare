 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayDiffMM.impl.DiffGridNode_upImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DiffGridNode_upImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffGridNode_upImpl extends MinimalEObjectImpl.Container implements DiffGridNode_up {
	...
	protected EClass eStaticClass() {
		return Pacman2WayDiffMMPackage.Literals.DIFF_GRID_NODE_UP;
	}
	...
	public void setDiff_kind(DiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.DIFF_GRID_NODE_UP__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public GridNode getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pacman2WayDiffMMPackage.DIFF_GRID_NODE_UP__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(GridNode newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.DIFF_GRID_NODE_UP__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayDiffMMPackage.DIFF_GRID_NODE_UP__DIFF_KIND:
				return getDiff_kind();
			case Pacman2WayDiffMMPackage.DIFF_GRID_NODE_UP__ETYPE:
