 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayDiffMM.impl.EnergizerImpl#getDurations <em>Durations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnergizerImpl extends FoodImpl implements Energizer {
	...
	protected EClass eStaticClass() {
		return Pacman2WayDiffMMPackage.Literals.ENERGIZER;
	}
	...
	public EList<Integer> getDurations() {
		if (durations == null) {
			durations = new EDataTypeUniqueEList<Integer>(Integer.class, this, Pacman2WayDiffMMPackage.ENERGIZER__DURATIONS);
		}
		return durations;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayDiffMMPackage.ENERGIZER__DURATIONS:
				return getDurations();
		}
