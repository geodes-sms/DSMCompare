 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayDiffMM.impl.DiffGridNode_downImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.DiffGridNode_downImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffGridNode_downImpl extends MinimalEObjectImpl.Container implements DiffGridNode_down {
	...
	protected EClass eStaticClass() {
		return Pacman2WayDiffMMPackage.Literals.DIFF_GRID_NODE_DOWN;
	}
	...
	public void setDiff_kind(DiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.DIFF_GRID_NODE_DOWN__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public GridNode getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pacman2WayDiffMMPackage.DIFF_GRID_NODE_DOWN__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(GridNode newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.DIFF_GRID_NODE_DOWN__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayDiffMMPackage.DIFF_GRID_NODE_DOWN__DIFF_KIND:
				return getDiff_kind();
			case Pacman2WayDiffMMPackage.DIFF_GRID_NODE_DOWN__ETYPE:
