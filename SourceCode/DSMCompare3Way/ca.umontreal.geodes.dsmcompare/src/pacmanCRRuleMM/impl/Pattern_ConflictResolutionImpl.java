 ...
 * </p>
 * <ul>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_ConflictResolutionImpl#getResolutionType <em>Resolution Type</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_ConflictResolutionImpl#getResolutionStrategy <em>Resolution Strategy</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_ConflictResolutionImpl#getSemanticconflicts <em>Semanticconflicts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_ConflictResolutionImpl extends Pattern_SemanticObjectImpl implements Pattern_ConflictResolution {
	...
	protected EClass eStaticClass() {
		return PacmanCRRuleMMPackage.Literals.PATTERN_CONFLICT_RESOLUTION;
	}
	...
	public void setResolutionType(ConflictResolutionType newResolutionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_CONFLICT_RESOLUTION__RESOLUTION_TYPE, oldResolutionType, resolutionType));
	}
	...
	public void setResolutionStrategy(ConflictResolutionStrategy newResolutionStrategy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_CONFLICT_RESOLUTION__RESOLUTION_STRATEGY, oldResolutionStrategy, resolutionStrategy));
	}
	...
	public EList<Pattern_SemanticConflict> getSemanticconflicts() {
		if (semanticconflicts == null) {
			semanticconflicts = new EObjectResolvingEList<Pattern_SemanticConflict>(Pattern_SemanticConflict.class, this, PacmanCRRuleMMPackage.PATTERN_CONFLICT_RESOLUTION__SEMANTICCONFLICTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PacmanCRRuleMMPackage.PATTERN_CONFLICT_RESOLUTION__RESOLUTION_TYPE:
				return getResolutionType();
			case PacmanCRRuleMMPackage.PATTERN_CONFLICT_RESOLUTION__RESOLUTION_STRATEGY:
				return getResolutionStrategy();
			case PacmanCRRuleMMPackage.PATTERN_CONFLICT_RESOLUTION__SEMANTICCONFLICTS:
