 ...
 * </p>
 * <ul>
 *   <li>{@link pacmanDiffMM.impl.SemanticConflictImpl#getConflict_kind <em>Conflict kind</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.SemanticConflictImpl#getConflict_Granularity <em>Conflict Granularity</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.SemanticConflictImpl#getSemanticdiffs <em>Semanticdiffs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemanticConflictImpl extends SemanticObjectImpl implements SemanticConflict {
	...
	public void setConflict_kind(ChangeStatus newConflict_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.SEMANTIC_CONFLICT__CONFLICT_KIND, oldConflict_kind, conflict_kind));
	}
	...
	public void setConflict_Granularity(ConflictGranularity newConflict_Granularity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.SEMANTIC_CONFLICT__CONFLICT_GRANULARITY, oldConflict_Granularity, conflict_Granularity));
	}
	...
	public EList<SemanticDiff> getSemanticdiffs() {
		if (semanticdiffs == null) {
			semanticdiffs = new EObjectResolvingEList<SemanticDiff>(SemanticDiff.class, this, PacmanDiffMMPackage.SEMANTIC_CONFLICT__SEMANTICDIFFS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PacmanDiffMMPackage.SEMANTIC_CONFLICT__SEMANTICDIFFS:
