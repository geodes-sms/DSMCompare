 ...
 *   <li>{@link pacmanDiffMM.impl.DiffEnergizerImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffEnergizerImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffEnergizerImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffEnergizerImpl#getNew_id_Left <em>New id Left</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffEnergizerImpl#getNew_id_Right <em>New id Right</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffEnergizerImpl#getIdChangeStatus <em>Id Change Status</em>}</li>
...
public class DiffEnergizerImpl extends EnergizerImpl implements DiffEnergizer {
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_ENERGIZER__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_ENERGIZER__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setNew_id_Left(String newNew_id_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_ENERGIZER__NEW_ID_LEFT, oldNew_id_Left, new_id_Left));
	}
	...
	public void setNew_id_Right(String newNew_id_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_ENERGIZER__NEW_ID_RIGHT, oldNew_id_Right, new_id_Right));
	}
	...
	public void setIdChangeStatus(ChangeStatus newIdChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_ENERGIZER__ID_CHANGE_STATUS, oldIdChangeStatus, idChangeStatus));
	}
