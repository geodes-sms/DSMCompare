...
import pacman2WayDiffMM.impl.DiffPositionableEntity_onImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DiffPositionableEntity_onImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DiffPositionableEntity_onImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DiffPositionableEntity_onImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffPositionableEntity_onImpl extends DiffPositionableEntity_onImpl implements Pattern_DiffPositionableEntity_on {
	/**
	...
	protected EClass eStaticClass() {
		return Pacman2WayRuleMMPackage.Literals.PATTERN_DIFF_POSITIONABLE_ENTITY_ON;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DIFF_POSITIONABLE_ENTITY_ON__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DIFF_POSITIONABLE_ENTITY_ON__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DIFF_POSITIONABLE_ENTITY_ON__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_POSITIONABLE_ENTITY_ON__ID_PATTERN:
				return getID_Pattern();
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_POSITIONABLE_ENTITY_ON__FILTER:
				return isFilter();
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_POSITIONABLE_ENTITY_ON__IS_FORBIDDEN:
