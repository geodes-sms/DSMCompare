...
import pacman2WayDiffMM.impl.SemanticDiffImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_SemanticDiffImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_SemanticDiffImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_SemanticDiffImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_SemanticDiffImpl extends SemanticDiffImpl implements Pattern_SemanticDiff {
	...
	protected EClass eStaticClass() {
		return Pacman2WayRuleMMPackage.Literals.PATTERN_SEMANTIC_DIFF;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_SEMANTIC_DIFF__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_SEMANTIC_DIFF__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_SEMANTIC_DIFF__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayRuleMMPackage.PATTERN_SEMANTIC_DIFF__ID_PATTERN:
				return getID_Pattern();
			case Pacman2WayRuleMMPackage.PATTERN_SEMANTIC_DIFF__FILTER:
				return isFilter();
			case Pacman2WayRuleMMPackage.PATTERN_SEMANTIC_DIFF__IS_FORBIDDEN:
