 ...
 * </p>
 * <ul>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffOption_vendorImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffOption_vendorImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffOption_vendorImpl extends MinimalEObjectImpl.Container implements DiffOption_vendor {
	...
	protected EClass eStaticClass() {
		return Dssmm2WayDiffMMPackage.Literals.DIFF_OPTION_VENDOR;
	}
	...
	public void setDiff_kind(AscDiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_OPTION_VENDOR__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public Vendor getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Dssmm2WayDiffMMPackage.DIFF_OPTION_VENDOR__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(Vendor newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_OPTION_VENDOR__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dssmm2WayDiffMMPackage.DIFF_OPTION_VENDOR__DIFF_KIND:
				return getDiff_kind();
			case Dssmm2WayDiffMMPackage.DIFF_OPTION_VENDOR__ETYPE:
