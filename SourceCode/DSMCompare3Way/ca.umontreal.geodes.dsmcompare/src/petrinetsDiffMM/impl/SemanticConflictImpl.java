 ...
 * </p>
 * <ul>
 *   <li>{@link petrinetsDiffMM.impl.SemanticConflictImpl#getConflict_kind <em>Conflict kind</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.SemanticConflictImpl#getConflict_Granularity <em>Conflict Granularity</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.SemanticConflictImpl#getSemanticdiffs <em>Semanticdiffs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemanticConflictImpl extends SemanticObjectImpl implements SemanticConflict {
	...
	protected EClass eStaticClass() {
		return PetrinetsDiffMMPackage.Literals.SEMANTIC_CONFLICT;
	}
	...
	public void setConflict_kind(ChangeStatus newConflict_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.SEMANTIC_CONFLICT__CONFLICT_KIND, oldConflict_kind, conflict_kind));
	}
	...
	public void setConflict_Granularity(ConflictGranularity newConflict_Granularity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.SEMANTIC_CONFLICT__CONFLICT_GRANULARITY, oldConflict_Granularity, conflict_Granularity));
	}
	...
	public EList<SemanticDiff> getSemanticdiffs() {
		if (semanticdiffs == null) {
			semanticdiffs = new EObjectResolvingEList<SemanticDiff>(SemanticDiff.class, this, PetrinetsDiffMMPackage.SEMANTIC_CONFLICT__SEMANTICDIFFS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetsDiffMMPackage.SEMANTIC_CONFLICT__CONFLICT_KIND:
				return getConflict_kind();
			case PetrinetsDiffMMPackage.SEMANTIC_CONFLICT__CONFLICT_GRANULARITY:
				return getConflict_Granularity();
			case PetrinetsDiffMMPackage.SEMANTIC_CONFLICT__SEMANTICDIFFS:
