 ...
 * </p>
 * <ul>
 *   <li>{@link petrinetsDiffMM.impl.PetriNetImpl#getPlaces <em>Places</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.PetriNetImpl#getTransitions <em>Transitions</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.PetriNetImpl#getDiffplaces <em>Diffplaces</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.PetriNetImpl#getDifftransitions <em>Difftransitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PetriNetImpl extends NamedElementImpl implements PetriNet {
	...
	protected EClass eStaticClass() {
		return PetrinetsDiffMMPackage.Literals.PETRI_NET;
	}
	...
	public EList<Place> getPlaces() {
		if (places == null) {
			places = new EObjectContainmentEList<Place>(Place.class, this, PetrinetsDiffMMPackage.PETRI_NET__PLACES);
		}
		return places;
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, PetrinetsDiffMMPackage.PETRI_NET__TRANSITIONS);
		}
		return transitions;
	}
	...
	public EList<DiffPetriNet_places> getDiffplaces() {
		if (diffplaces == null) {
			diffplaces = new EObjectContainmentEList<DiffPetriNet_places>(DiffPetriNet_places.class, this, PetrinetsDiffMMPackage.PETRI_NET__DIFFPLACES);
		}
		return diffplaces;
	}
	...
	public EList<DiffPetriNet_transitions> getDifftransitions() {
		if (difftransitions == null) {
			difftransitions = new EObjectContainmentEList<DiffPetriNet_transitions>(DiffPetriNet_transitions.class, this, PetrinetsDiffMMPackage.PETRI_NET__DIFFTRANSITIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetsDiffMMPackage.PETRI_NET__PLACES:
				return ((InternalEList<?>)getPlaces()).basicRemove(otherEnd, msgs);
			case PetrinetsDiffMMPackage.PETRI_NET__TRANSITIONS:
				return ((InternalEList<?>)getTransitions()).basicRemove(otherEnd, msgs);
			case PetrinetsDiffMMPackage.PETRI_NET__DIFFPLACES:
				return ((InternalEList<?>)getDiffplaces()).basicRemove(otherEnd, msgs);
			case PetrinetsDiffMMPackage.PETRI_NET__DIFFTRANSITIONS:
