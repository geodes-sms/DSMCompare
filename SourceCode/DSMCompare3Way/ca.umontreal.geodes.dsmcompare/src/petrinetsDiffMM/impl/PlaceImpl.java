 ...
 * </p>
 * <ul>
 *   <li>{@link petrinetsDiffMM.impl.PlaceImpl#getTokens <em>Tokens</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.PlaceImpl#getTransitions <em>Transitions</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.PlaceImpl#getDifftransitions <em>Difftransitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaceImpl extends NamedElementImpl implements Place {
	...
	protected EClass eStaticClass() {
		return PetrinetsDiffMMPackage.Literals.PLACE;
	}
	...
	public void setTokens(int newTokens) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.PLACE__TOKENS, oldTokens, tokens));
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectResolvingEList<Transition>(Transition.class, this, PetrinetsDiffMMPackage.PLACE__TRANSITIONS);
		}
		return transitions;
	}
	...
	public EList<DiffPlace_transitions> getDifftransitions() {
		if (difftransitions == null) {
			difftransitions = new EObjectContainmentEList<DiffPlace_transitions>(DiffPlace_transitions.class, this, PetrinetsDiffMMPackage.PLACE__DIFFTRANSITIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetsDiffMMPackage.PLACE__DIFFTRANSITIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetsDiffMMPackage.PLACE__TOKENS:
				return getTokens();
			case PetrinetsDiffMMPackage.PLACE__TRANSITIONS:
