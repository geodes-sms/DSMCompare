...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff EPackage interfaces</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_interfacesImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_interfacesImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_interfacesImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_interfacesImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_interfacesImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_interfacesImpl#getDiff_Group <em>Diff Group</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_interfacesImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEPackage_interfacesImpl extends MinimalEObjectImpl.Container implements DiffEPackage_interfaces {
	/**
	 ...
	 * @generated
	 */
	protected DiffEPackage_interfacesImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RefactoringDiffMMPackage.Literals.DIFF_EPACKAGE_INTERFACES;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_INTERFACES__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_INTERFACES__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_INTERFACES__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_INTERFACES__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_INTERFACES__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setDiff_Group(String newDiff_Group) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_INTERFACES__DIFF_GROUP, oldDiff_Group, diff_Group));
	}
	...
	public Interface getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefactoringDiffMMPackage.DIFF_EPACKAGE_INTERFACES__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(Interface newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_INTERFACES__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_INTERFACES__ETYPE:
