...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff EPackage test</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_testImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_testImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_testImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_testImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_testImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_testImpl#getDiff_Group <em>Diff Group</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEPackage_testImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEPackage_testImpl extends MinimalEObjectImpl.Container implements DiffEPackage_test {
	/**
	 ...
	 * @ordered
	 */
	protected testAssociations eType;
	 ...
	 * @generated
	 */
	protected DiffEPackage_testImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RefactoringDiffMMPackage.Literals.DIFF_EPACKAGE_TEST;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setDiff_Group(String newDiff_Group) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__DIFF_GROUP, oldDiff_Group, diff_Group));
	}
	 ...
	 * @generated
	 */
	public testAssociations getEType() {
		if (eType != null && eType.eIsProxy()) {
			InternalEObject oldEType = (InternalEObject)eType;
			eType = (testAssociations)eResolveProxy(oldEType);
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	 ...
	 * @generated
	 */
	public testAssociations basicGetEType() {
		return eType;
	}
	 ...
	 * @generated
	 */
	public void setEType(testAssociations newEType) {
		testAssociations oldEType = eType;
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__CHANGE_STATUS:
				return getChangeStatus();
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__FILTER:
				return isFilter();
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__IS_MERGED:
				return isIsMerged();
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__DIFF_GROUP:
				return getDiff_Group();
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__ETYPE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__DIFF_GROUP:
				...
				return;
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__ETYPE:
				setEType((testAssociations)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__DIFF_GROUP:
				...
				return;
			case RefactoringDiffMMPackage.DIFF_EPACKAGE_TEST__ETYPE:
				setEType((testAssociations)null);
				return;
		}
