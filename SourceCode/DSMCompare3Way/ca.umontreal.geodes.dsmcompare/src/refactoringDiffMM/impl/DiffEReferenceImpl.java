 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.DiffEReferenceImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEReferenceImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEReferenceImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEReferenceImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEReferenceImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEReferenceImpl#getNew_name_Left <em>New name Left</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEReferenceImpl#getNew_name_Right <em>New name Right</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEReferenceImpl#getNameChangeStatus <em>Name Change Status</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEReferenceImpl#getNew_etype_Left <em>New etype Left</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEReferenceImpl#getNew_etype_Right <em>New etype Right</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEReferenceImpl#getEtypeChangeStatus <em>Etype Change Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEReferenceImpl extends EReferenceImpl implements DiffEReference {
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EREFERENCE__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EREFERENCE__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EREFERENCE__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EREFERENCE__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EREFERENCE__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setNew_name_Left(String newNew_name_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EREFERENCE__NEW_NAME_LEFT, oldNew_name_Left, new_name_Left));
	}
	...
	public void setNew_name_Right(String newNew_name_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EREFERENCE__NEW_NAME_RIGHT, oldNew_name_Right, new_name_Right));
	}
	...
	public void setNameChangeStatus(ChangeStatus newNameChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EREFERENCE__NAME_CHANGE_STATUS, oldNameChangeStatus, nameChangeStatus));
	}
	...
	public void setNew_etype_Left(String newNew_etype_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EREFERENCE__NEW_ETYPE_LEFT, oldNew_etype_Left, new_etype_Left));
	}
	...
	public void setNew_etype_Right(String newNew_etype_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EREFERENCE__NEW_ETYPE_RIGHT, oldNew_etype_Right, new_etype_Right));
	}
	...
	public void setEtypeChangeStatus(ChangeStatus newEtypeChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EREFERENCE__ETYPE_CHANGE_STATUS, oldEtypeChangeStatus, etypeChangeStatus));
	}
