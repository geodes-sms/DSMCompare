 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.EOperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.EOperationImpl#getEparameters <em>Eparameters</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.EOperationImpl#getEtype <em>Etype</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.EOperationImpl#getMethodBody <em>Method Body</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.EOperationImpl#get__idKDM <em>id KDM</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EOperationImpl extends MinimalEObjectImpl.Container implements EOperation {
	...
	protected EClass eStaticClass() {
		return RefactoringDiffMMPackage.Literals.EOPERATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.EOPERATION__NAME, oldName, name));
	}
	...
	public void setEparameters(String newEparameters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.EOPERATION__EPARAMETERS, oldEparameters, eparameters));
	}
	...
	public void setEtype(String newEtype) {
		...
		etype = newEtype;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.EOPERATION__ETYPE, oldEtype, etype));
	}
	...
	public void setMethodBody(String newMethodBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.EOPERATION__METHOD_BODY, oldMethodBody, methodBody));
	}
	...
	public void set__idKDM(String new__idKDM) {
		...
		__idKDM = new__idKDM;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.EOPERATION__ID_KDM, old__idKDM, __idKDM));
	}
