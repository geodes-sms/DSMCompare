 ...
 *   <li>{@link refactoringDiffMM.impl.EPackageImpl#getTest <em>Test</em>}</li>
 ...
 *   <li>{@link refactoringDiffMM.impl.EPackageImpl#getDifftest <em>Difftest</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EPackageImpl extends MinimalEObjectImpl.Container implements EPackage {
	 ...
	 * @ordered
	 */
	protected EList<DiffEPackage_test> difftest;
	...
	public EList<testAssociations> getTest() {
		if (test == null) {
			test = new EObjectContainmentEList<testAssociations>(testAssociations.class, this, RefactoringDiffMMPackage.EPACKAGE__TEST);
		}
		return test;
	}
	 ...
	 * @generated
	 */
	public EList<DiffEPackage_test> getDifftest() {
		if (difftest == null) {
			difftest = new EObjectContainmentEList<DiffEPackage_test>(DiffEPackage_test.class, this, RefactoringDiffMMPackage.EPACKAGE__DIFFTEST);
		}
		return difftest;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case RefactoringDiffMMPackage.EPACKAGE__DIFFTEST:
				getDifftest().clear();
				getDifftest().addAll((Collection<? extends DiffEPackage_test>)newValue);
				return;
		}
