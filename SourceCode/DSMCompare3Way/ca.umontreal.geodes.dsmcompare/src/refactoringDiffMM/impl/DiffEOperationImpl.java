 ...
 *   <li>{@link refactoringDiffMM.impl.DiffEOperationImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEOperationImpl#isIsMerged <em>Is Merged</em>}</li>
...
public class DiffEOperationImpl extends EOperationImpl implements DiffEOperation {
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EOPERATION__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_EOPERATION__IS_MERGED, oldIsMerged, isMerged));
	}
