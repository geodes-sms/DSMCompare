...
import refactoring2WayDiffMM.impl.EPackageImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_EPackageImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_EPackageImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_EPackageImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_EPackageImpl extends EPackageImpl implements Pattern_EPackage {
	/**
	...
	protected EClass eStaticClass() {
		return Refactoring2WayRuleMMPackage.Literals.PATTERN_EPACKAGE;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_EPACKAGE__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_EPACKAGE__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_EPACKAGE__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayRuleMMPackage.PATTERN_EPACKAGE__ID_PATTERN:
				return getID_Pattern();
			case Refactoring2WayRuleMMPackage.PATTERN_EPACKAGE__FILTER:
				return isFilter();
			case Refactoring2WayRuleMMPackage.PATTERN_EPACKAGE__IS_FORBIDDEN:
