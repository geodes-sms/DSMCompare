 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayDiffMM.impl.InterfaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.InterfaceImpl#getExtends <em>Extends</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.InterfaceImpl#getPackageName <em>Package Name</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.InterfaceImpl#getEoperations <em>Eoperations</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.InterfaceImpl#getEsupertypes <em>Esupertypes</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.InterfaceImpl#getDiffeoperations <em>Diffeoperations</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.InterfaceImpl#getDiffesupertypes <em>Diffesupertypes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceImpl extends MinimalEObjectImpl.Container implements Interface {
	...
	protected EClass eStaticClass() {
		return Refactoring2WayDiffMMPackage.Literals.INTERFACE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.INTERFACE__NAME, oldName, name));
	}
	...
	public void setExtends(String newExtends) {
		...
		extends_ = newExtends;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.INTERFACE__EXTENDS, oldExtends, extends_));
	}
	...
	public void setPackageName(String newPackageName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.INTERFACE__PACKAGE_NAME, oldPackageName, packageName));
	}
	...
	public EList<EOperation> getEoperations() {
		if (eoperations == null) {
			eoperations = new EObjectContainmentEList<EOperation>(EOperation.class, this, Refactoring2WayDiffMMPackage.INTERFACE__EOPERATIONS);
		}
		return eoperations;
	}
	...
	public EList<Interface> getEsupertypes() {
		if (esupertypes == null) {
			esupertypes = new EObjectResolvingEList<Interface>(Interface.class, this, Refactoring2WayDiffMMPackage.INTERFACE__ESUPERTYPES);
		}
		return esupertypes;
	}
	...
	public EList<DiffInterface_eoperations> getDiffeoperations() {
		if (diffeoperations == null) {
			diffeoperations = new EObjectContainmentEList<DiffInterface_eoperations>(DiffInterface_eoperations.class, this, Refactoring2WayDiffMMPackage.INTERFACE__DIFFEOPERATIONS);
		}
	...
	public EList<DiffInterface_esupertypes> getDiffesupertypes() {
		if (diffesupertypes == null) {
			diffesupertypes = new EObjectContainmentEList<DiffInterface_esupertypes>(DiffInterface_esupertypes.class, this, Refactoring2WayDiffMMPackage.INTERFACE__DIFFESUPERTYPES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.INTERFACE__EOPERATIONS:
				return ((InternalEList<?>)getEoperations()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.INTERFACE__DIFFEOPERATIONS:
				return ((InternalEList<?>)getDiffeoperations()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.INTERFACE__DIFFESUPERTYPES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.INTERFACE__NAME:
				return getName();
			case Refactoring2WayDiffMMPackage.INTERFACE__EXTENDS:
				return getExtends();
			case Refactoring2WayDiffMMPackage.INTERFACE__PACKAGE_NAME:
				return getPackageName();
			case Refactoring2WayDiffMMPackage.INTERFACE__EOPERATIONS:
				return getEoperations();
			case Refactoring2WayDiffMMPackage.INTERFACE__ESUPERTYPES:
