 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayDiffMM.impl.EPackageImpl#getName <em>Name</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EPackageImpl#getEclassifiers <em>Eclassifiers</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EPackageImpl#getInterfaces <em>Interfaces</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EPackageImpl#getDiffeclassifiers <em>Diffeclassifiers</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EPackageImpl#getDiffinterfaces <em>Diffinterfaces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EPackageImpl extends MinimalEObjectImpl.Container implements EPackage {
	...
	protected org.eclipse.emf.ecore.EClass eStaticClass() {
		return Refactoring2WayDiffMMPackage.Literals.EPACKAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.EPACKAGE__NAME, oldName, name));
	}
	...
	public EList<EClass> getEclassifiers() {
		if (eclassifiers == null) {
			eclassifiers = new EObjectContainmentEList<EClass>(EClass.class, this, Refactoring2WayDiffMMPackage.EPACKAGE__ECLASSIFIERS);
		}
		return eclassifiers;
	}
	...
	public EList<Interface> getInterfaces() {
		if (interfaces == null) {
			interfaces = new EObjectContainmentEList<Interface>(Interface.class, this, Refactoring2WayDiffMMPackage.EPACKAGE__INTERFACES);
		}
		return interfaces;
	}
	...
	public EList<DiffEPackage_eclassifiers> getDiffeclassifiers() {
		if (diffeclassifiers == null) {
			diffeclassifiers = new EObjectContainmentEList<DiffEPackage_eclassifiers>(DiffEPackage_eclassifiers.class, this, Refactoring2WayDiffMMPackage.EPACKAGE__DIFFECLASSIFIERS);
		}
	...
	public EList<DiffEPackage_interfaces> getDiffinterfaces() {
		if (diffinterfaces == null) {
			diffinterfaces = new EObjectContainmentEList<DiffEPackage_interfaces>(DiffEPackage_interfaces.class, this, Refactoring2WayDiffMMPackage.EPACKAGE__DIFFINTERFACES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.EPACKAGE__ECLASSIFIERS:
				return ((InternalEList<?>)getEclassifiers()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.EPACKAGE__INTERFACES:
				return ((InternalEList<?>)getInterfaces()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.EPACKAGE__DIFFECLASSIFIERS:
				return ((InternalEList<?>)getDiffeclassifiers()).basicRemove(otherEnd, msgs);
			case Refactoring2WayDiffMMPackage.EPACKAGE__DIFFINTERFACES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.EPACKAGE__NAME:
				return getName();
			case Refactoring2WayDiffMMPackage.EPACKAGE__ECLASSIFIERS:
