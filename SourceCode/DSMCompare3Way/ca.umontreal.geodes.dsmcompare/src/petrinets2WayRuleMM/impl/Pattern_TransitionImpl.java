...
import petrinets2WayDiffMM.impl.TransitionImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link petrinets2WayRuleMM.impl.Pattern_TransitionImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link petrinets2WayRuleMM.impl.Pattern_TransitionImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link petrinets2WayRuleMM.impl.Pattern_TransitionImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_TransitionImpl extends TransitionImpl implements Pattern_Transition {
	/**
	...
	protected EClass eStaticClass() {
		return Petrinets2WayRuleMMPackage.Literals.PATTERN_TRANSITION;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayRuleMMPackage.PATTERN_TRANSITION__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayRuleMMPackage.PATTERN_TRANSITION__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayRuleMMPackage.PATTERN_TRANSITION__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Petrinets2WayRuleMMPackage.PATTERN_TRANSITION__ID_PATTERN:
				return getID_Pattern();
			case Petrinets2WayRuleMMPackage.PATTERN_TRANSITION__FILTER:
				return isFilter();
			case Petrinets2WayRuleMMPackage.PATTERN_TRANSITION__IS_FORBIDDEN:
