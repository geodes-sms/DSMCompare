...
import dssmm2WayDiffMM.impl.DiffFactor_scoresImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff Factor scores</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dssmm2WayRuleMM.impl.Pattern_DiffFactor_scoresImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link dssmm2WayRuleMM.impl.Pattern_DiffFactor_scoresImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link dssmm2WayRuleMM.impl.Pattern_DiffFactor_scoresImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffFactor_scoresImpl extends DiffFactor_scoresImpl implements Pattern_DiffFactor_scores {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffFactor_scoresImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Dssmm2WayRuleMMPackage.Literals.PATTERN_DIFF_FACTOR_SCORES;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayRuleMMPackage.PATTERN_DIFF_FACTOR_SCORES__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayRuleMMPackage.PATTERN_DIFF_FACTOR_SCORES__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayRuleMMPackage.PATTERN_DIFF_FACTOR_SCORES__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dssmm2WayRuleMMPackage.PATTERN_DIFF_FACTOR_SCORES__ID_PATTERN:
				return getID_Pattern();
			case Dssmm2WayRuleMMPackage.PATTERN_DIFF_FACTOR_SCORES__FILTER:
				return isFilter();
			case Dssmm2WayRuleMMPackage.PATTERN_DIFF_FACTOR_SCORES__IS_FORBIDDEN:
