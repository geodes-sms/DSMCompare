...
import dssmm2WayDiffMM.impl.DiffCompositeFactorImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff Composite Factor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dssmm2WayRuleMM.impl.Pattern_DiffCompositeFactorImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link dssmm2WayRuleMM.impl.Pattern_DiffCompositeFactorImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link dssmm2WayRuleMM.impl.Pattern_DiffCompositeFactorImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffCompositeFactorImpl extends DiffCompositeFactorImpl implements Pattern_DiffCompositeFactor {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffCompositeFactorImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Dssmm2WayRuleMMPackage.Literals.PATTERN_DIFF_COMPOSITE_FACTOR;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayRuleMMPackage.PATTERN_DIFF_COMPOSITE_FACTOR__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayRuleMMPackage.PATTERN_DIFF_COMPOSITE_FACTOR__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayRuleMMPackage.PATTERN_DIFF_COMPOSITE_FACTOR__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dssmm2WayRuleMMPackage.PATTERN_DIFF_COMPOSITE_FACTOR__ID_PATTERN:
				return getID_Pattern();
			case Dssmm2WayRuleMMPackage.PATTERN_DIFF_COMPOSITE_FACTOR__FILTER:
				return isFilter();
			case Dssmm2WayRuleMMPackage.PATTERN_DIFF_COMPOSITE_FACTOR__IS_FORBIDDEN:
...
} //Pattern_DiffCompositeFactorImpl
