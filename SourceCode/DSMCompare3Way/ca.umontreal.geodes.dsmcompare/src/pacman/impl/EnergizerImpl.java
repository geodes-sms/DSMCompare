 ...
 * </p>
 * <ul>
 *   <li>{@link pacman.impl.EnergizerImpl#getDurations <em>Durations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnergizerImpl extends FoodImpl implements Energizer {
	...
	protected EClass eStaticClass() {
		return PacmanPackage.Literals.ENERGIZER;
	}
	...
	public EList<Integer> getDurations() {
		if (durations == null) {
			durations = new EDataTypeUniqueEList<Integer>(Integer.class, this, PacmanPackage.ENERGIZER__DURATIONS);
		}
		return durations;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PacmanPackage.ENERGIZER__DURATIONS:
				return getDurations();
		}
