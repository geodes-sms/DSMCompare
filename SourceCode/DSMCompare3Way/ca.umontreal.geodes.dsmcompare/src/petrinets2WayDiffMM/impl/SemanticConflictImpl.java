 ...
 * </p>
 * <ul>
 *   <li>{@link petrinets2WayDiffMM.impl.SemanticConflictImpl#getSemanticdiffs <em>Semanticdiffs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemanticConflictImpl extends SemanticObjectImpl implements SemanticConflict {
	...
	protected EClass eStaticClass() {
		return Petrinets2WayDiffMMPackage.Literals.SEMANTIC_CONFLICT;
	}
	...
	public EList<SemanticDiff> getSemanticdiffs() {
		if (semanticdiffs == null) {
			semanticdiffs = new EObjectResolvingEList<SemanticDiff>(SemanticDiff.class, this, Petrinets2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTICDIFFS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Petrinets2WayDiffMMPackage.SEMANTIC_CONFLICT__SEMANTICDIFFS:
