...
public class dsCompare {
	...
	public static void main(String[] args) {
		String v1Path = "R:/Thesis/wsEMFcompare/ca.umontreal.geodes.dsmcompare/model/Schema.xmi"; 
		String v2Path = "R:/Thesis/wsEMFcompare/ca.umontreal.geodes.dsmcompare/model/Schema2.xmi"; 
		String compResulFilePath= "R:/Thesis/wsEMFcompare/ca.umontreal.geodes.dsmcompare/model/file.txt";
	...
	void writeCompResultUsingIntentPrettyPrinter(Comparison comparison, File compResulFile)
	{
		...
		ProcessComparisonResult.processThreeWayComparison(comparison, compResulFile.toPath().toString());
