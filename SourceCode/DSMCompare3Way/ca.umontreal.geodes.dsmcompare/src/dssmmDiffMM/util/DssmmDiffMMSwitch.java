 ...
 * @generated
 */
public class DssmmDiffMMSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DssmmDiffMMPackage.DECISION_SUPPORT: {
				DecisionSupport decisionSupport = (DecisionSupport)theEObject;
				T result = caseDecisionSupport(decisionSupport);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DssmmDiffMMPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DssmmDiffMMPackage.FACTOR: {
				Factor factor = (Factor)theEObject;
				T result = caseFactor(factor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DssmmDiffMMPackage.LEAF_FACTOR: {
			...
			case DssmmDiffMMPackage.COMPOSITE_FACTOR: {
			...
			case DssmmDiffMMPackage.SEMANTIC_CONFLICT: {
			...
			case DssmmDiffMMPackage.DIFF_DECISION_SUPPORT: {
			...
			case DssmmDiffMMPackage.DIFF_DECISION_SUPPORT_MODEL: {
			...
			case DssmmDiffMMPackage.DIFF_DECISION_SUPPORT_OPTIONS: {
			...
			case DssmmDiffMMPackage.DIFF_DECISION_SUPPORT_VENDORS: {
			...
			case DssmmDiffMMPackage.DIFF_MODEL: {
			...
			case DssmmDiffMMPackage.DIFF_MODEL_ROOT_FACTOR: {
			...
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR: {
			...
			case DssmmDiffMMPackage.DIFF_COMPOSITE_FACTOR_SUB_FACTORS: {
			...
			case DssmmDiffMMPackage.DIFF_OPTION: {
			...
			case DssmmDiffMMPackage.DIFF_SCORE: {
			...
			case DssmmDiffMMPackage.DIFF_SCORE_SCORE_OPTION: {
