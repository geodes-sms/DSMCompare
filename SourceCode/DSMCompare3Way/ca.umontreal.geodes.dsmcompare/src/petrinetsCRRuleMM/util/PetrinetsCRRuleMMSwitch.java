 ...
 * @generated
 */
public class PetrinetsCRRuleMMSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public PetrinetsCRRuleMMSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PetrinetsCRRuleMMPackage.PATTERN_CONFLICT_RESOLUTION: {
			...
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PETRI_NET: {
				...
				if (result == null) result = casePattern_NamedElement(pattern_DiffPetriNet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PETRI_NET_PLACES: {
			...
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PETRI_NET_TRANSITIONS: {
			...
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE: {
				Pattern_DiffPlace pattern_DiffPlace = (Pattern_DiffPlace)theEObject;
				T result = casePattern_DiffPlace(pattern_DiffPlace);
				if (result == null) result = casePattern_NamedElement(pattern_DiffPlace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS: {
			...
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION: {
				...
				if (result == null) result = casePattern_NamedElement(pattern_DiffTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION_PLACES: {
			...
			case PetrinetsCRRuleMMPackage.PATTERN_NAMED_ELEMENT: {
			...
			case PetrinetsCRRuleMMPackage.PATTERN_PETRI_NET: {
				Pattern_PetriNet pattern_PetriNet = (Pattern_PetriNet)theEObject;
				T result = casePattern_PetriNet(pattern_PetriNet);
				if (result == null) result = casePattern_NamedElement(pattern_PetriNet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetsCRRuleMMPackage.PATTERN_PLACE: {
				Pattern_Place pattern_Place = (Pattern_Place)theEObject;
				T result = casePattern_Place(pattern_Place);
				if (result == null) result = casePattern_NamedElement(pattern_Place);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetsCRRuleMMPackage.PATTERN_SEMANTIC_CONFLICT: {
			...
			case PetrinetsCRRuleMMPackage.PATTERN_SEMANTIC_DIFF: {
			...
			case PetrinetsCRRuleMMPackage.PATTERN_SEMANTIC_OBJECT: {
			...
			case PetrinetsCRRuleMMPackage.PATTERN_TRANSITION: {
				Pattern_Transition pattern_Transition = (Pattern_Transition)theEObject;
				T result = casePattern_Transition(pattern_Transition);
				if (result == null) result = casePattern_NamedElement(pattern_Transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetsCRRuleMMPackage.RULE: {
