...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff Place transitions</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlace_transitionsImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlace_transitionsImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlace_transitionsImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlace_transitionsImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlace_transitionsImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlace_transitionsImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlace_transitionsImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlace_transitionsImpl#getDiff_Group <em>Diff Group</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlace_transitionsImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffPlace_transitionsImpl extends MinimalEObjectImpl.Container implements Pattern_DiffPlace_transitions {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffPlace_transitionsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PetrinetsCRRuleMMPackage.Literals.PATTERN_DIFF_PLACE_TRANSITIONS;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setDiff_Group(String newDiff_Group) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__DIFF_GROUP, oldDiff_Group, diff_Group));
	}
	...
	public Pattern_Transition getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(Pattern_Transition newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__ID_PATTERN:
				return getID_Pattern();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__IS_FORBIDDEN:
				return isIsForbidden();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__CHANGE_STATUS:
				return getChangeStatus();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__FILTER:
				return isFilter();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__IS_MERGED:
				return isIsMerged();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__DIFF_GROUP:
				return getDiff_Group();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE_TRANSITIONS__ETYPE:
...
} //Pattern_DiffPlace_transitionsImpl
