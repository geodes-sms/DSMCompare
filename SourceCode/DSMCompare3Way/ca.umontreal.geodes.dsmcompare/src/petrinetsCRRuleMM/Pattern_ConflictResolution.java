 ...
 * </p>
 * <ul>
 *   <li>{@link petrinetsCRRuleMM.Pattern_ConflictResolution#getResolutionType <em>Resolution Type</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.Pattern_ConflictResolution#getResolutionStrategy <em>Resolution Strategy</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.Pattern_ConflictResolution#getSemanticconflicts <em>Semanticconflicts</em>}</li>
 * </ul>
 *
 * @see petrinetsCRRuleMM.PetrinetsCRRuleMMPackage#getPattern_ConflictResolution()
 * @model
 * @generated
 */
public interface Pattern_ConflictResolution extends Pattern_SemanticObject {
	 ...
	 * The literals are from the enumeration {@link petrinetsCRRuleMM.ConflictResolutionType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see petrinetsCRRuleMM.PetrinetsCRRuleMMPackage#getPattern_ConflictResolution_ResolutionType()
	...
	/**
	 * Sets the value of the '{@link petrinetsCRRuleMM.Pattern_ConflictResolution#getResolutionType <em>Resolution Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link petrinetsCRRuleMM.ConflictResolutionStrategy}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see petrinetsCRRuleMM.PetrinetsCRRuleMMPackage#getPattern_ConflictResolution_ResolutionStrategy()
	 * @model unique="false" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link petrinetsCRRuleMM.Pattern_ConflictResolution#getResolutionStrategy <em>Resolution Strategy</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link petrinetsCRRuleMM.Pattern_SemanticConflict}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Semanticconflicts</em>' reference list.
	 * @see petrinetsCRRuleMM.PetrinetsCRRuleMMPackage#getPattern_ConflictResolution_Semanticconflicts()
	 * @model ordered="false"
	 * @generated
	 */
