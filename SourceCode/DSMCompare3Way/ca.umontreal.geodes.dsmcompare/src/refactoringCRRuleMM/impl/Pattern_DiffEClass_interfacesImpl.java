...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff EClass interfaces</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClass_interfacesImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClass_interfacesImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClass_interfacesImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClass_interfacesImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClass_interfacesImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClass_interfacesImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClass_interfacesImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClass_interfacesImpl#getDiff_Group <em>Diff Group</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClass_interfacesImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffEClass_interfacesImpl extends MinimalEObjectImpl.Container implements Pattern_DiffEClass_interfaces {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffEClass_interfacesImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RefactoringCRRuleMMPackage.Literals.PATTERN_DIFF_ECLASS_INTERFACES;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setDiff_Group(String newDiff_Group) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__DIFF_GROUP, oldDiff_Group, diff_Group));
	}
	...
	public Pattern_Interface getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(Pattern_Interface newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__ID_PATTERN:
				return getID_Pattern();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__IS_FORBIDDEN:
				return isIsForbidden();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__CHANGE_STATUS:
				return getChangeStatus();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__FILTER:
				return isFilter();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__IS_MERGED:
				return isIsMerged();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__DIFF_GROUP:
				return getDiff_Group();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS_INTERFACES__ETYPE:
...
} //Pattern_DiffEClass_interfacesImpl
