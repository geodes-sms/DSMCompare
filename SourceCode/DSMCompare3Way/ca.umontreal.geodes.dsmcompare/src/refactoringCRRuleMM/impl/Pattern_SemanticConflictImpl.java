 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_SemanticConflictImpl#getConflict_kind <em>Conflict kind</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_SemanticConflictImpl#getConflict_Granularity <em>Conflict Granularity</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_SemanticConflictImpl#getSemanticdiffs <em>Semanticdiffs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_SemanticConflictImpl extends Pattern_SemanticObjectImpl implements Pattern_SemanticConflict {
	...
	protected EClass eStaticClass() {
		return RefactoringCRRuleMMPackage.Literals.PATTERN_SEMANTIC_CONFLICT;
	}
	...
	public void setConflict_kind(ChangeStatus newConflict_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__CONFLICT_KIND, oldConflict_kind, conflict_kind));
	}
	...
	public void setConflict_Granularity(ConflictGranularity newConflict_Granularity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__CONFLICT_GRANULARITY, oldConflict_Granularity, conflict_Granularity));
	}
	...
	public EList<Pattern_SemanticDiff> getSemanticdiffs() {
		if (semanticdiffs == null) {
			semanticdiffs = new EObjectResolvingEList<Pattern_SemanticDiff>(Pattern_SemanticDiff.class, this, RefactoringCRRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__SEMANTICDIFFS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringCRRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__CONFLICT_KIND:
				return getConflict_kind();
			case RefactoringCRRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__CONFLICT_GRANULARITY:
				return getConflict_Granularity();
			case RefactoringCRRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__SEMANTICDIFFS:
