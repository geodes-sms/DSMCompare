...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern EAttribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_EAttributeImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_EAttributeImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_EAttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_EAttributeImpl#getEtype <em>Etype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_EAttributeImpl extends MinimalEObjectImpl.Container implements Pattern_EAttribute {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_EAttributeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RefactoringCRRuleMMPackage.Literals.PATTERN_EATTRIBUTE;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_EATTRIBUTE__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_EATTRIBUTE__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_EATTRIBUTE__NAME, oldName, name));
	}
	...
	public void setEtype(String newEtype) {
		...
		etype = newEtype;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_EATTRIBUTE__ETYPE, oldEtype, etype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringCRRuleMMPackage.PATTERN_EATTRIBUTE__ID_PATTERN:
				return getID_Pattern();
			case RefactoringCRRuleMMPackage.PATTERN_EATTRIBUTE__IS_FORBIDDEN:
				return isIsForbidden();
			case RefactoringCRRuleMMPackage.PATTERN_EATTRIBUTE__NAME:
				return getName();
			case RefactoringCRRuleMMPackage.PATTERN_EATTRIBUTE__ETYPE:
				return getEtype();
		}
