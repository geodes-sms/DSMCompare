...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Difftest Associations</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DifftestAssociationsImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DifftestAssociationsImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DifftestAssociationsImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DifftestAssociationsImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DifftestAssociationsImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DifftestAssociationsImpl#getNew_name_Left <em>New name Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DifftestAssociationsImpl#getNew_name_Right <em>New name Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DifftestAssociationsImpl#getNameChangeStatus <em>Name Change Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DifftestAssociationsImpl extends Pattern_testAssociationsImpl implements Pattern_DifftestAssociations {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DifftestAssociationsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RefactoringCRRuleMMPackage.Literals.PATTERN_DIFFTEST_ASSOCIATIONS;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setNew_name_Left(String newNew_name_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__NEW_NAME_LEFT, oldNew_name_Left, new_name_Left));
	}
	...
	public void setNew_name_Right(String newNew_name_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__NEW_NAME_RIGHT, oldNew_name_Right, new_name_Right));
	}
	...
	public void setNameChangeStatus(ChangeStatus newNameChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__NAME_CHANGE_STATUS, oldNameChangeStatus, nameChangeStatus));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__FILTER:
				return isFilter();
			case RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__IS_MERGED:
				return isIsMerged();
			case RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__CHANGE_STATUS:
				return getChangeStatus();
			case RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__NEW_NAME_LEFT:
				return getNew_name_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__NEW_NAME_RIGHT:
				return getNew_name_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFFTEST_ASSOCIATIONS__NAME_CHANGE_STATUS:
...
} //Pattern_DifftestAssociationsImpl
