 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringCRRuleMM.Pattern_SemanticConflict#getConflict_kind <em>Conflict kind</em>}</li>
 *   <li>{@link refactoringCRRuleMM.Pattern_SemanticConflict#getConflict_Granularity <em>Conflict Granularity</em>}</li>
 *   <li>{@link refactoringCRRuleMM.Pattern_SemanticConflict#getSemanticdiffs <em>Semanticdiffs</em>}</li>
 * </ul>
 *
 * @see refactoringCRRuleMM.RefactoringCRRuleMMPackage#getPattern_SemanticConflict()
 * @model
 * @generated
 */
public interface Pattern_SemanticConflict extends Pattern_SemanticObject {
	 ...
	 * @see refactoringCRRuleMM.RefactoringCRRuleMMPackage#getPattern_SemanticConflict_Conflict_kind()
	...
	/**
	 * Sets the value of the '{@link refactoringCRRuleMM.Pattern_SemanticConflict#getConflict_kind <em>Conflict kind</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link refactoringCRRuleMM.ConflictGranularity}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see refactoringCRRuleMM.RefactoringCRRuleMMPackage#getPattern_SemanticConflict_Conflict_Granularity()
	 * @model unique="false" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link refactoringCRRuleMM.Pattern_SemanticConflict#getConflict_Granularity <em>Conflict Granularity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link refactoringCRRuleMM.Pattern_SemanticDiff}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Semanticdiffs</em>' reference list.
	 * @see refactoringCRRuleMM.RefactoringCRRuleMMPackage#getPattern_SemanticConflict_Semanticdiffs()
	 * @model ordered="false"
	 * @generated
	 */
