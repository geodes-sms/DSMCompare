 ...
 *   <li>{@link petrinets.impl.PetriNetImpl#getTransitions <em>Transitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PetriNetImpl extends NamedElementImpl implements PetriNet {
	...
	public EList<Place> getPlaces() {
		if (places == null) {
			places = new EObjectContainmentEList<Place>(Place.class, this, PetrinetsPackage.PETRI_NET__PLACES);
		}
		return places;
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, PetrinetsPackage.PETRI_NET__TRANSITIONS);
		}
		return transitions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case PetrinetsPackage.PETRI_NET__TRANSITIONS:
