			...
			for (EPackage pack : metamodel) {
				...
				{					
					...
					if(!isOperational) {
						...
						DsmcHelpers.createCustomMapType(EcorePackage.eINSTANCE.getEString(), eeClassDiffKind	, 	pack, 1, 1, "DiffKind", true);
						DsmcHelpers.createCustomMapType(EcorePackage.eINSTANCE.getEString(), eeAscDiffKind		, 	pack, 1, 1, "DiffKind", true);
					}
					...
					EAttribute attrIsForbidden = DsmcHelpers.createEAttribute("isForbidden", dsdDiffClass, EcorePackage.eINSTANCE.getEBoolean(), 1, 1, false, false, false, false);
		...
		if(dsdiffFileURI!=null)
		{
			...
			//for (EPackage pack : metamodel) 
			{
				...
				{					
					...
					ecRule.setName("Rule");					
					DsmcHelpers.createEAttribute("name", ecRule, EcorePackage.eINSTANCE.getEString(), 1, 1, false, false, false, false);
					DsmcHelpers.createEAttribute("constraints", ecRule, EcorePackage.eINSTANCE.getEString(), 0, -1, false, false, false, false);	
					...
					for (EClassifier diffClass : classifiers) 
					{
						if (diffClass instanceof EClass)
						{
							...
							DsmcHelpers.createEAttribute("ID_Pattern", patternRuleClass, EcorePackage.eINSTANCE.getEInt(), 1, 1, false, false, false, false);
							...
							//if(Id!=null)
							//	Id.setID(false);
							DsmcHelpers.createEAttribute("filter", patternRuleClass, EcorePackage.eINSTANCE.getEBoolean(), 1, 1, false, false, false, false);
