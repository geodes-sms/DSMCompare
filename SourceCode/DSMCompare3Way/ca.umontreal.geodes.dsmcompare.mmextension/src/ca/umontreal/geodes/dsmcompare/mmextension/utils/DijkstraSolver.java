...
public class DijkstraSolver {
     ...
     */
    protected final List<EClass> nodes;
    /**
     * The list of edges of the graph
     */
    protected final List<EReference> edges;
    /**
     * Visited nodes
     */
    protected Set<EClass> settledNodes;
    /**
     * Unvisited nodes
     */
    protected Set<EClass> unSettledNodes;
    /**
     * The list of predecesors in the set of calculated paths
     */
    protected Map<EClass, EClass> predecessors = new HashMap<EClass, EClass>();
    /**
     * Distance matrix between each pair of nodes
     */
    protected Map<EClass, Integer> distance;
     ...
     */
    protected int getDistance(EClass node, EClass target) {
     ...
     */
    protected List<EClass> getNeighbors(EClass node) {
     ...
     */
    protected EClass getMinimum(Set<EClass> vertexes) {
        EClass minimum = null;
     ...
     */
    protected boolean isSettled(EClass vertex) {
     ...
     */
    protected int getShortestDistance(EClass destination) {
