...
/**
 * This is the item provider adapter for a {@link refactoringDiffMM.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefactoringDiffMMPackage.Literals.INTERFACE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefactoringDiffMMPackage.Literals.INTERFACE__EXTENDS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPackageNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_packageName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_packageName_feature", "_UI_Interface_type"),
				 RefactoringDiffMMPackage.Literals.INTERFACE__PACKAGE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEsupertypesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_esupertypes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_esupertypes_feature", "_UI_Interface_type"),
				 RefactoringDiffMMPackage.Literals.INTERFACE__ESUPERTYPES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RefactoringDiffMMPackage.Literals.INTERFACE__EOPERATIONS);
			childrenFeatures.add(RefactoringDiffMMPackage.Literals.INTERFACE__DIFFEOPERATIONS);
			childrenFeatures.add(RefactoringDiffMMPackage.Literals.INTERFACE__DIFFESUPERTYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RefactoringDiffMMPackage.Literals.INTERFACE__EOPERATIONS,
		...
		newChildDescriptors.add
			(createChildParameter
				(RefactoringDiffMMPackage.Literals.INTERFACE__DIFFEOPERATIONS,
				 RefactoringDiffMMFactory.eINSTANCE.createDiffInterface_eoperations()));

		newChildDescriptors.add
			(createChildParameter
				(RefactoringDiffMMPackage.Literals.INTERFACE__DIFFESUPERTYPES,
				 RefactoringDiffMMFactory.eINSTANCE.createDiffInterface_esupertypes()));
	}
