...
/**
 * This is the item provider adapter for a {@link refactoringDiffMM.ConflictResolution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefactoringDiffMMPackage.Literals.CONFLICT_RESOLUTION__RESOLUTION_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefactoringDiffMMPackage.Literals.CONFLICT_RESOLUTION__RESOLUTION_STRATEGY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefactoringDiffMMPackage.Literals.CONFLICT_RESOLUTION__SEMANTICCONFLICTS,
				 true,
				 false,
				 true,
				 null,
