...
/**
 * This is the item provider adapter for a {@link refactoringDiffMM.EReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EReferenceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EReference_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EReference_name_feature", "_UI_EReference_type"),
				 RefactoringDiffMMPackage.Literals.EREFERENCE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addEtypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EReference_etype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EReference_etype_feature", "_UI_EReference_type"),
				 RefactoringDiffMMPackage.Literals.EREFERENCE__ETYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EReference.class)) {
			case RefactoringDiffMMPackage.EREFERENCE__NAME:
			case RefactoringDiffMMPackage.EREFERENCE__ETYPE:
