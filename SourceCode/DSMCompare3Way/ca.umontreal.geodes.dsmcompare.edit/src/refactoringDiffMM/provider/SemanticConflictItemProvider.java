...
/**
 * This is the item provider adapter for a {@link refactoringDiffMM.SemanticConflict} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefactoringDiffMMPackage.Literals.SEMANTIC_CONFLICT__CONFLICT_KIND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefactoringDiffMMPackage.Literals.SEMANTIC_CONFLICT__CONFLICT_GRANULARITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefactoringDiffMMPackage.Literals.SEMANTIC_CONFLICT__SEMANTICDIFFS,
				 true,
				 false,
				 true,
				 null,
