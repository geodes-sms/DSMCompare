...
/**
 * This is the item provider adapter for a {@link refactoring.EPackage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EPackageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RefactoringPackage.Literals.EPACKAGE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RefactoringPackage.Literals.EPACKAGE__ECLASSIFIERS);
			childrenFeatures.add(RefactoringPackage.Literals.EPACKAGE__INTERFACES);
			childrenFeatures.add(RefactoringPackage.Literals.EPACKAGE__TEST);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RefactoringPackage.Literals.EPACKAGE__ECLASSIFIERS,
				 RefactoringFactory.eINSTANCE.createEClass()));

		newChildDescriptors.add
			(createChildParameter
				(RefactoringPackage.Literals.EPACKAGE__INTERFACES,
				 RefactoringFactory.eINSTANCE.createInterface()));

		newChildDescriptors.add
			(createChildParameter
				(RefactoringPackage.Literals.EPACKAGE__TEST,
				 RefactoringFactory.eINSTANCE.createtestAssociations()));
	}
