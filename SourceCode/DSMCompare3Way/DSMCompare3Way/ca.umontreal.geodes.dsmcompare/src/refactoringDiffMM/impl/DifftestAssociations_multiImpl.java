...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Difftest Associations multi</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociations_multiImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociations_multiImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociations_multiImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociations_multiImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociations_multiImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociations_multiImpl#getDiff_Group <em>Diff Group</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociations_multiImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DifftestAssociations_multiImpl extends MinimalEObjectImpl.Container implements DifftestAssociations_multi {
	/**
	 ...
	 * @generated
	 */
	protected DifftestAssociations_multiImpl() {
		super();
	}
	...
	protected org.eclipse.emf.ecore.EClass eStaticClass() {
		return RefactoringDiffMMPackage.Literals.DIFFTEST_ASSOCIATIONS_MULTI;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS_MULTI__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS_MULTI__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS_MULTI__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS_MULTI__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS_MULTI__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setDiff_Group(String newDiff_Group) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS_MULTI__DIFF_GROUP, oldDiff_Group, diff_Group));
	}
	...
	public EClass getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS_MULTI__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(EClass newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS_MULTI__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS_MULTI__ETYPE:
...
} //DifftestAssociations_multiImpl
