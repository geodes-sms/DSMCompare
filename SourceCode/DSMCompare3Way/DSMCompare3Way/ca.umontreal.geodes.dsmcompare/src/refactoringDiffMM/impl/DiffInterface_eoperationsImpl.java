 ...
 *   <li>{@link refactoringDiffMM.impl.DiffInterface_eoperationsImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffInterface_eoperationsImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffInterface_eoperationsImpl#getDiff_Group <em>Diff Group</em>}</li>
...
public class DiffInterface_eoperationsImpl extends MinimalEObjectImpl.Container implements DiffInterface_eoperations {
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_INTERFACE_EOPERATIONS__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_INTERFACE_EOPERATIONS__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setDiff_Group(String newDiff_Group) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_INTERFACE_EOPERATIONS__DIFF_GROUP, oldDiff_Group, diff_Group));
	}
