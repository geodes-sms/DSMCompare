 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.SemanticConflictImpl#getConflict_kind <em>Conflict kind</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.SemanticConflictImpl#getConflict_Granularity <em>Conflict Granularity</em>}</li>
...
public class SemanticConflictImpl extends SemanticObjectImpl implements SemanticConflict {
	...
	public void setConflict_kind(ChangeStatus newConflict_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.SEMANTIC_CONFLICT__CONFLICT_KIND, oldConflict_kind, conflict_kind));
	}
	...
	public void setConflict_Granularity(ConflictGranularity newConflict_Granularity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.SEMANTIC_CONFLICT__CONFLICT_GRANULARITY, oldConflict_Granularity, conflict_Granularity));
	}
	...
	public EList<SemanticDiff> getSemanticdiffs() {
		if (semanticdiffs == null) {
			semanticdiffs = new EObjectResolvingEList<SemanticDiff>(SemanticDiff.class, this, RefactoringDiffMMPackage.SEMANTIC_CONFLICT__SEMANTICDIFFS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringDiffMMPackage.SEMANTIC_CONFLICT__CONFLICT_KIND:
				return getConflict_kind();
			case RefactoringDiffMMPackage.SEMANTIC_CONFLICT__CONFLICT_GRANULARITY:
