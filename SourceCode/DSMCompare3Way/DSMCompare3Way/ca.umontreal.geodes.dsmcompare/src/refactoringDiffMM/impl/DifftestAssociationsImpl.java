...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Difftest Associations</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociationsImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociationsImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociationsImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociationsImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociationsImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociationsImpl#getNew_name_Left <em>New name Left</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociationsImpl#getNew_name_Right <em>New name Right</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DifftestAssociationsImpl#getNameChangeStatus <em>Name Change Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DifftestAssociationsImpl extends testAssociationsImpl implements DifftestAssociations {
	/**
	 ...
	 * @generated
	 */
	protected DifftestAssociationsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RefactoringDiffMMPackage.Literals.DIFFTEST_ASSOCIATIONS;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setNew_name_Left(String newNew_name_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS__NEW_NAME_LEFT, oldNew_name_Left, new_name_Left));
	}
	...
	public void setNew_name_Right(String newNew_name_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS__NEW_NAME_RIGHT, oldNew_name_Right, new_name_Right));
	}
	...
	public void setNameChangeStatus(ChangeStatus newNameChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFFTEST_ASSOCIATIONS__NAME_CHANGE_STATUS, oldNameChangeStatus, nameChangeStatus));
	}
