 ...
 * </p>
 * <ul>
 *   <li>{@link refactoringDiffMM.impl.DiffEClass_esupertypesImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEClass_esupertypesImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEClass_esupertypesImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEClass_esupertypesImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEClass_esupertypesImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEClass_esupertypesImpl#getDiff_Group <em>Diff Group</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffEClass_esupertypesImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEClass_esupertypesImpl extends MinimalEObjectImpl.Container implements DiffEClass_esupertypes {
	...
	protected org.eclipse.emf.ecore.EClass eStaticClass() {
		return RefactoringDiffMMPackage.Literals.DIFF_ECLASS_ESUPERTYPES;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_ECLASS_ESUPERTYPES__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_ECLASS_ESUPERTYPES__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_ECLASS_ESUPERTYPES__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_ECLASS_ESUPERTYPES__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_ECLASS_ESUPERTYPES__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setDiff_Group(String newDiff_Group) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_ECLASS_ESUPERTYPES__DIFF_GROUP, oldDiff_Group, diff_Group));
	}
	...
	public EClass getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefactoringDiffMMPackage.DIFF_ECLASS_ESUPERTYPES__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(EClass newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_ECLASS_ESUPERTYPES__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RefactoringDiffMMPackage.DIFF_ECLASS_ESUPERTYPES__ETYPE:
