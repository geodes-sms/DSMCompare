 ...
 *   <li>{@link refactoringDiffMM.impl.DiffInterfaceImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringDiffMM.impl.DiffInterfaceImpl#isIsMerged <em>Is Merged</em>}</li>
...
public class DiffInterfaceImpl extends InterfaceImpl implements DiffInterface {
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_INTERFACE__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringDiffMMPackage.DIFF_INTERFACE__IS_MERGED, oldIsMerged, isMerged));
	}
