 ...
 *   <li>{@link refactoringDiffMM.EPackage#getInterfaces <em>Interfaces</em>}</li>
 *   <li>{@link refactoringDiffMM.EPackage#getTest <em>Test</em>}</li>
 *   <li>{@link refactoringDiffMM.EPackage#getDiffeclassifiers <em>Diffeclassifiers</em>}</li>
 *   <li>{@link refactoringDiffMM.EPackage#getDiffinterfaces <em>Diffinterfaces</em>}</li>
 *   <li>{@link refactoringDiffMM.EPackage#getDifftest <em>Difftest</em>}</li>
 * </ul>
 *
...
public interface EPackage extends EObject {
	 ...
	 * @see refactoringDiffMM.RefactoringDiffMMPackage#getEPackage_Interfaces()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
	 ...
	 * @see refactoringDiffMM.RefactoringDiffMMPackage#getEPackage_Test()
	 ...
	 * @see refactoringDiffMM.RefactoringDiffMMPackage#getEPackage_Diffinterfaces()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see refactoringDiffMM.RefactoringDiffMMPackage#getEPackage_Difftest()
	 * @model containment="true"
	 * @generated
	 */
	EList<DiffEPackage_test> getDifftest();
