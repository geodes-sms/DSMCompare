...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Petri Net places</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link petrinetsDiffMM.impl.DiffPetriNet_placesImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.DiffPetriNet_placesImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.DiffPetriNet_placesImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.DiffPetriNet_placesImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.DiffPetriNet_placesImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.DiffPetriNet_placesImpl#getDiff_Group <em>Diff Group</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.DiffPetriNet_placesImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffPetriNet_placesImpl extends MinimalEObjectImpl.Container implements DiffPetriNet_places {
	/**
	 ...
	 * @generated
	 */
	protected DiffPetriNet_placesImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PetrinetsDiffMMPackage.Literals.DIFF_PETRI_NET_PLACES;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setDiff_Group(String newDiff_Group) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__DIFF_GROUP, oldDiff_Group, diff_Group));
	}
	...
	public Place getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(Place newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__CHANGE_STATUS:
				return getChangeStatus();
			case PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__FILTER:
				return isFilter();
			case PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__IS_MERGED:
				return isIsMerged();
			case PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__DIFF_GROUP:
				return getDiff_Group();
			case PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES__ETYPE:
