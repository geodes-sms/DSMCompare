 ...
 * </p>
 * <ul>
 *   <li>{@link petrinetsDiffMM.impl.ConflictResolutionImpl#getResolutionType <em>Resolution Type</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.ConflictResolutionImpl#getResolutionStrategy <em>Resolution Strategy</em>}</li>
 *   <li>{@link petrinetsDiffMM.impl.ConflictResolutionImpl#getSemanticconflicts <em>Semanticconflicts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConflictResolutionImpl extends SemanticObjectImpl implements ConflictResolution {
	...
	protected EClass eStaticClass() {
		return PetrinetsDiffMMPackage.Literals.CONFLICT_RESOLUTION;
	}
	...
	public void setResolutionType(ConflictResolutionType newResolutionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.CONFLICT_RESOLUTION__RESOLUTION_TYPE, oldResolutionType, resolutionType));
	}
	...
	public void setResolutionStrategy(ConflictResolutionStrategy newResolutionStrategy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsDiffMMPackage.CONFLICT_RESOLUTION__RESOLUTION_STRATEGY, oldResolutionStrategy, resolutionStrategy));
	}
	...
	public EList<SemanticConflict> getSemanticconflicts() {
		if (semanticconflicts == null) {
			semanticconflicts = new EObjectResolvingEList<SemanticConflict>(SemanticConflict.class, this, PetrinetsDiffMMPackage.CONFLICT_RESOLUTION__SEMANTICCONFLICTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetsDiffMMPackage.CONFLICT_RESOLUTION__RESOLUTION_TYPE:
				return getResolutionType();
			case PetrinetsDiffMMPackage.CONFLICT_RESOLUTION__RESOLUTION_STRATEGY:
				return getResolutionStrategy();
			case PetrinetsDiffMMPackage.CONFLICT_RESOLUTION__SEMANTICCONFLICTS:
