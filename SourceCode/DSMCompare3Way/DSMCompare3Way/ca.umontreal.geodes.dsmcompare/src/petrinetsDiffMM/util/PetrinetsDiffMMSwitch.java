 ...
 * @generated
 */
public class PetrinetsDiffMMSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PetrinetsDiffMMPackage.CONFLICT_RESOLUTION: {
			...
			case PetrinetsDiffMMPackage.DIFF_PETRI_NET: {
			...
			case PetrinetsDiffMMPackage.DIFF_PETRI_NET_PLACES: {
			...
			case PetrinetsDiffMMPackage.DIFF_PETRI_NET_TRANSITIONS: {
			...
			case PetrinetsDiffMMPackage.DIFF_PLACE: {
			...
			case PetrinetsDiffMMPackage.DIFF_PLACE_TRANSITIONS: {
			...
			case PetrinetsDiffMMPackage.DIFF_TRANSITION: {
			...
			case PetrinetsDiffMMPackage.DIFF_TRANSITION_PLACES: {
			...
			case PetrinetsDiffMMPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetsDiffMMPackage.PETRI_NET: {
			...
			case PetrinetsDiffMMPackage.PLACE: {
			...
			case PetrinetsDiffMMPackage.SEMANTIC_CONFLICT: {
			...
			case PetrinetsDiffMMPackage.SEMANTIC_DIFF: {
