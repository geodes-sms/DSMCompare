 ...
 * @generated
 */
public class DssmmSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DssmmPackage.COMPOSITE_FACTOR: {
			...
			case DssmmPackage.OPTION: {
				Option option = (Option)theEObject;
				T result = caseOption(option);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DssmmPackage.VENDOR: {
				Vendor vendor = (Vendor)theEObject;
				T result = caseVendor(vendor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DssmmPackage.SCORE: {
