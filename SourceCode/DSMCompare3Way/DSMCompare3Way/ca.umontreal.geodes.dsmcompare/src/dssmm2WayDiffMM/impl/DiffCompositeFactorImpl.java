 ...
 * </p>
 * <ul>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffCompositeFactorImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffCompositeFactorImpl#getNew_FactorID <em>New Factor ID</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffCompositeFactorImpl#getNew_Name <em>New Name</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffCompositeFactorImpl#getNew_Descr <em>New Descr</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffCompositeFactorImpl#getNew_GW <em>New GW</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffCompositeFactorImpl#getNew_LW <em>New LW</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffCompositeFactorImpl#getNew_Del <em>New Del</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffCompositeFactorImpl#isNew_HideOnLine <em>New Hide On Line</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffCompositeFactorImpl#getNew_Hierarchy <em>New Hierarchy</em>}</li>
 *   <li>{@link dssmm2WayDiffMM.impl.DiffCompositeFactorImpl#getNew_MasterFactorID <em>New Master Factor ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffCompositeFactorImpl extends CompositeFactorImpl implements DiffCompositeFactor {
	...
	protected EClass eStaticClass() {
		return Dssmm2WayDiffMMPackage.Literals.DIFF_COMPOSITE_FACTOR;
	}
	...
	public void setDiff_kind(ClassDiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public void setNew_FactorID(int newNew_FactorID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_FACTOR_ID, oldNew_FactorID, new_FactorID));
	}
	...
	public void setNew_Name(String newNew_Name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_NAME, oldNew_Name, new_Name));
	}
	...
	public void setNew_Descr(String newNew_Descr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DESCR, oldNew_Descr, new_Descr));
	}
	...
	public void setNew_GW(float newNew_GW) {
		...
		new_GW = newNew_GW;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_GW, oldNew_GW, new_GW));
	}
	...
	public void setNew_LW(float newNew_LW) {
		...
		new_LW = newNew_LW;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_LW, oldNew_LW, new_LW));
	}
	...
	public void setNew_Del(Boolean newNew_Del) {
		...
		new_Del = newNew_Del;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DEL, oldNew_Del, new_Del));
	}
	...
	public void setNew_HideOnLine(boolean newNew_HideOnLine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIDE_ON_LINE, oldNew_HideOnLine, new_HideOnLine));
	}
	...
	public void setNew_Hierarchy(String newNew_Hierarchy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIERARCHY, oldNew_Hierarchy, new_Hierarchy));
	}
	...
	public void setNew_MasterFactorID(int newNew_MasterFactorID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_MASTER_FACTOR_ID, oldNew_MasterFactorID, new_MasterFactorID));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__DIFF_KIND:
				return getDiff_kind();
			case Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_FACTOR_ID:
				return getNew_FactorID();
			case Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_NAME:
				return getNew_Name();
			case Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DESCR:
				return getNew_Descr();
			case Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_GW:
				return getNew_GW();
			case Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_LW:
				return getNew_LW();
			case Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_DEL:
				return getNew_Del();
			case Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIDE_ON_LINE:
				return isNew_HideOnLine();
			case Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_HIERARCHY:
				return getNew_Hierarchy();
			case Dssmm2WayDiffMMPackage.DIFF_COMPOSITE_FACTOR__NEW_MASTER_FACTOR_ID:
