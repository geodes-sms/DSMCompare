...
//org.eclipse.emf.compare.rcp.ui.internal.structuremergeviewer.filters.impl
 ...
 public class DsEMFComparatorArrayEMap {
	...
	public 	Comparison compareCoreTwoWay(final ResourceSet newResourceSet, final ResourceSet oldResourceSet) {		  
		    final DefaultComparisonScope comparisonScope = this.getComparisonScope(newResourceSet, oldResourceSet,null);
		    final EMFCompare configuredEmfComparator = this.getConfiguredEmfCompareObjectBuilder().build();
		    final Comparison comparison = configuredEmfComparator.compare(comparisonScope);
		    return comparison;
	...
	private DefaultComparisonScope getComparisonScope(final ResourceSet leftResourceSet, final ResourceSet rightResourceSet, final ResourceSet originResourceSet) {
			  
		    DefaultComparisonScope _defaultComparisonScope = new DefaultComparisonScope(leftResourceSet, rightResourceSet, originResourceSet);
