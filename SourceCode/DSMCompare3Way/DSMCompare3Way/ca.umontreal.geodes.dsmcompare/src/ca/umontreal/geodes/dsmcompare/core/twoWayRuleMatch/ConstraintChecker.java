...
/*
		 ...
		 //bsNs.importPackage("ca.umontreal.geodes.dsmcompare.tests");
	bsNs.importClass("ca.umontreal.geodes.dsmcompare.tests.*"); //ca.umontreal.geodes.dsmcompare.tests.DsModelComparatorTest
