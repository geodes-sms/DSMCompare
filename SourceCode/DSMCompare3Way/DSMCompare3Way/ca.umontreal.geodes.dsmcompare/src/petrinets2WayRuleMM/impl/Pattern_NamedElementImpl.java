...
import petrinets2WayDiffMM.impl.NamedElementImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link petrinets2WayRuleMM.impl.Pattern_NamedElementImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link petrinets2WayRuleMM.impl.Pattern_NamedElementImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link petrinets2WayRuleMM.impl.Pattern_NamedElementImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class Pattern_NamedElementImpl extends NamedElementImpl implements Pattern_NamedElement {
	/**
	...
	protected EClass eStaticClass() {
		return Petrinets2WayRuleMMPackage.Literals.PATTERN_NAMED_ELEMENT;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayRuleMMPackage.PATTERN_NAMED_ELEMENT__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayRuleMMPackage.PATTERN_NAMED_ELEMENT__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayRuleMMPackage.PATTERN_NAMED_ELEMENT__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Petrinets2WayRuleMMPackage.PATTERN_NAMED_ELEMENT__ID_PATTERN:
				return getID_Pattern();
			case Petrinets2WayRuleMMPackage.PATTERN_NAMED_ELEMENT__FILTER:
				return isFilter();
			case Petrinets2WayRuleMMPackage.PATTERN_NAMED_ELEMENT__IS_FORBIDDEN:
