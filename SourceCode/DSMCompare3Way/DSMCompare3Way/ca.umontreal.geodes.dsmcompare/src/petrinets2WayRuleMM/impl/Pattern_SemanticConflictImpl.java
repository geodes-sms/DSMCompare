...
import petrinets2WayDiffMM.impl.SemanticConflictImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link petrinets2WayRuleMM.impl.Pattern_SemanticConflictImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link petrinets2WayRuleMM.impl.Pattern_SemanticConflictImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link petrinets2WayRuleMM.impl.Pattern_SemanticConflictImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_SemanticConflictImpl extends SemanticConflictImpl implements Pattern_SemanticConflict {
	...
	protected EClass eStaticClass() {
		return Petrinets2WayRuleMMPackage.Literals.PATTERN_SEMANTIC_CONFLICT;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Petrinets2WayRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__ID_PATTERN:
				return getID_Pattern();
			case Petrinets2WayRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__FILTER:
				return isFilter();
			case Petrinets2WayRuleMMPackage.PATTERN_SEMANTIC_CONFLICT__IS_FORBIDDEN:
