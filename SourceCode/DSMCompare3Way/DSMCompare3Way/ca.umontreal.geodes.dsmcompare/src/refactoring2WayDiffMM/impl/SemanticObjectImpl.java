 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEAttribute <em>Semantic Object Diff EAttribute</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEClass <em>Semantic Object Diff EClass</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEClass_eattributes <em>Semantic Object Diff EClass eattributes</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEClass_eoperations <em>Semantic Object Diff EClass eoperations</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEClass_ereferences <em>Semantic Object Diff EClass ereferences</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEClass_esupertypes <em>Semantic Object Diff EClass esupertypes</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEClass_interfaces <em>Semantic Object Diff EClass interfaces</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEClass_nested_classes <em>Semantic Object Diff EClass nested classes</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEClass_nested_interfaces <em>Semantic Object Diff EClass nested interfaces</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEOperation <em>Semantic Object Diff EOperation</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEPackage <em>Semantic Object Diff EPackage</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEPackage_eclassifiers <em>Semantic Object Diff EPackage eclassifiers</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEPackage_interfaces <em>Semantic Object Diff EPackage interfaces</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEReference <em>Semantic Object Diff EReference</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffInterface <em>Semantic Object Diff Interface</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffInterface_eoperations <em>Semantic Object Diff Interface eoperations</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffInterface_esupertypes <em>Semantic Object Diff Interface esupertypes</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_EAttribute <em>Semantic Object EAttribute</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_EClass <em>Semantic Object EClass</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_EOperation <em>Semantic Object EOperation</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_EPackage <em>Semantic Object EPackage</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_EReference <em>Semantic Object EReference</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_Interface <em>Semantic Object Interface</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SemanticObjectImpl extends MinimalEObjectImpl.Container implements SemanticObject {
	...
	protected org.eclipse.emf.ecore.EClass eStaticClass() {
		return Refactoring2WayDiffMMPackage.Literals.SEMANTIC_OBJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__NAME, oldName, name));
	}
	...
	public EList<DiffEAttribute> getSemanticObject_DiffEAttribute() {
		if (semanticObject_DiffEAttribute == null) {
			semanticObject_DiffEAttribute = new EObjectResolvingEList<DiffEAttribute>(DiffEAttribute.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EATTRIBUTE);
		}
	...
	public EList<DiffEClass> getSemanticObject_DiffEClass() {
		if (semanticObject_DiffEClass == null) {
			semanticObject_DiffEClass = new EObjectResolvingEList<DiffEClass>(DiffEClass.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS);
		}
	...
	public EList<DiffEClass_eattributes> getSemanticObject_DiffEClass_eattributes() {
		if (semanticObject_DiffEClass_eattributes == null) {
			semanticObject_DiffEClass_eattributes = new EObjectResolvingEList<DiffEClass_eattributes>(DiffEClass_eattributes.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_EATTRIBUTES);
		}
	...
	public EList<DiffEClass_eoperations> getSemanticObject_DiffEClass_eoperations() {
		if (semanticObject_DiffEClass_eoperations == null) {
			semanticObject_DiffEClass_eoperations = new EObjectResolvingEList<DiffEClass_eoperations>(DiffEClass_eoperations.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_EOPERATIONS);
		}
	...
	public EList<DiffEClass_ereferences> getSemanticObject_DiffEClass_ereferences() {
		if (semanticObject_DiffEClass_ereferences == null) {
			semanticObject_DiffEClass_ereferences = new EObjectResolvingEList<DiffEClass_ereferences>(DiffEClass_ereferences.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_EREFERENCES);
		}
	...
	public EList<DiffEClass_esupertypes> getSemanticObject_DiffEClass_esupertypes() {
		if (semanticObject_DiffEClass_esupertypes == null) {
			semanticObject_DiffEClass_esupertypes = new EObjectResolvingEList<DiffEClass_esupertypes>(DiffEClass_esupertypes.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_ESUPERTYPES);
		}
	...
	public EList<DiffEClass_interfaces> getSemanticObject_DiffEClass_interfaces() {
		if (semanticObject_DiffEClass_interfaces == null) {
			semanticObject_DiffEClass_interfaces = new EObjectResolvingEList<DiffEClass_interfaces>(DiffEClass_interfaces.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_INTERFACES);
		}
	...
	public EList<DiffEClass_nested_classes> getSemanticObject_DiffEClass_nested_classes() {
		if (semanticObject_DiffEClass_nested_classes == null) {
			semanticObject_DiffEClass_nested_classes = new EObjectResolvingEList<DiffEClass_nested_classes>(DiffEClass_nested_classes.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_NESTED_CLASSES);
		}
	...
	public EList<DiffEClass_nested_interfaces> getSemanticObject_DiffEClass_nested_interfaces() {
		if (semanticObject_DiffEClass_nested_interfaces == null) {
			semanticObject_DiffEClass_nested_interfaces = new EObjectResolvingEList<DiffEClass_nested_interfaces>(DiffEClass_nested_interfaces.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_NESTED_INTERFACES);
		}
	...
	public EList<DiffEOperation> getSemanticObject_DiffEOperation() {
		if (semanticObject_DiffEOperation == null) {
			semanticObject_DiffEOperation = new EObjectResolvingEList<DiffEOperation>(DiffEOperation.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EOPERATION);
		}
	...
	public EList<DiffEPackage> getSemanticObject_DiffEPackage() {
		if (semanticObject_DiffEPackage == null) {
			semanticObject_DiffEPackage = new EObjectResolvingEList<DiffEPackage>(DiffEPackage.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EPACKAGE);
		}
	...
	public EList<DiffEPackage_eclassifiers> getSemanticObject_DiffEPackage_eclassifiers() {
		if (semanticObject_DiffEPackage_eclassifiers == null) {
			semanticObject_DiffEPackage_eclassifiers = new EObjectResolvingEList<DiffEPackage_eclassifiers>(DiffEPackage_eclassifiers.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EPACKAGE_ECLASSIFIERS);
		}
	...
	public EList<DiffEPackage_interfaces> getSemanticObject_DiffEPackage_interfaces() {
		if (semanticObject_DiffEPackage_interfaces == null) {
			semanticObject_DiffEPackage_interfaces = new EObjectResolvingEList<DiffEPackage_interfaces>(DiffEPackage_interfaces.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EPACKAGE_INTERFACES);
		}
	...
	public EList<DiffEReference> getSemanticObject_DiffEReference() {
		if (semanticObject_DiffEReference == null) {
			semanticObject_DiffEReference = new EObjectResolvingEList<DiffEReference>(DiffEReference.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EREFERENCE);
		}
	...
	public EList<DiffInterface> getSemanticObject_DiffInterface() {
		if (semanticObject_DiffInterface == null) {
			semanticObject_DiffInterface = new EObjectResolvingEList<DiffInterface>(DiffInterface.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_INTERFACE);
		}
	...
	public EList<DiffInterface_eoperations> getSemanticObject_DiffInterface_eoperations() {
		if (semanticObject_DiffInterface_eoperations == null) {
			semanticObject_DiffInterface_eoperations = new EObjectResolvingEList<DiffInterface_eoperations>(DiffInterface_eoperations.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_INTERFACE_EOPERATIONS);
		}
	...
	public EList<DiffInterface_esupertypes> getSemanticObject_DiffInterface_esupertypes() {
		if (semanticObject_DiffInterface_esupertypes == null) {
			semanticObject_DiffInterface_esupertypes = new EObjectResolvingEList<DiffInterface_esupertypes>(DiffInterface_esupertypes.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_INTERFACE_ESUPERTYPES);
		}
	...
	public EList<EAttribute> getSemanticObject_EAttribute() {
		if (semanticObject_EAttribute == null) {
			semanticObject_EAttribute = new EObjectResolvingEList<EAttribute>(EAttribute.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_EATTRIBUTE);
		}
	...
	public EList<EClass> getSemanticObject_EClass() {
		if (semanticObject_EClass == null) {
			semanticObject_EClass = new EObjectResolvingEList<EClass>(EClass.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_ECLASS);
		}
	...
	public EList<EOperation> getSemanticObject_EOperation() {
		if (semanticObject_EOperation == null) {
			semanticObject_EOperation = new EObjectResolvingEList<EOperation>(EOperation.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_EOPERATION);
		}
	...
	public EList<EPackage> getSemanticObject_EPackage() {
		if (semanticObject_EPackage == null) {
			semanticObject_EPackage = new EObjectResolvingEList<EPackage>(EPackage.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_EPACKAGE);
		}
	...
	public EList<EReference> getSemanticObject_EReference() {
		if (semanticObject_EReference == null) {
			semanticObject_EReference = new EObjectResolvingEList<EReference>(EReference.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_EREFERENCE);
		}
	...
	public EList<Interface> getSemanticObject_Interface() {
		if (semanticObject_Interface == null) {
			semanticObject_Interface = new EObjectResolvingEList<Interface>(Interface.class, this, Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_INTERFACE);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__NAME:
				return getName();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EATTRIBUTE:
				return getSemanticObject_DiffEAttribute();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS:
				return getSemanticObject_DiffEClass();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_EATTRIBUTES:
				return getSemanticObject_DiffEClass_eattributes();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_EOPERATIONS:
				return getSemanticObject_DiffEClass_eoperations();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_EREFERENCES:
				return getSemanticObject_DiffEClass_ereferences();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_ESUPERTYPES:
				return getSemanticObject_DiffEClass_esupertypes();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_INTERFACES:
				return getSemanticObject_DiffEClass_interfaces();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_NESTED_CLASSES:
				return getSemanticObject_DiffEClass_nested_classes();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ECLASS_NESTED_INTERFACES:
				return getSemanticObject_DiffEClass_nested_interfaces();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EOPERATION:
				return getSemanticObject_DiffEOperation();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EPACKAGE:
				return getSemanticObject_DiffEPackage();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EPACKAGE_ECLASSIFIERS:
				return getSemanticObject_DiffEPackage_eclassifiers();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EPACKAGE_INTERFACES:
				return getSemanticObject_DiffEPackage_interfaces();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_EREFERENCE:
				return getSemanticObject_DiffEReference();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_INTERFACE:
				return getSemanticObject_DiffInterface();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_INTERFACE_EOPERATIONS:
				return getSemanticObject_DiffInterface_eoperations();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_INTERFACE_ESUPERTYPES:
				return getSemanticObject_DiffInterface_esupertypes();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_EATTRIBUTE:
				return getSemanticObject_EAttribute();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_ECLASS:
				return getSemanticObject_EClass();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_EOPERATION:
				return getSemanticObject_EOperation();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_EPACKAGE:
				return getSemanticObject_EPackage();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_EREFERENCE:
				return getSemanticObject_EReference();
			case Refactoring2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_INTERFACE:
