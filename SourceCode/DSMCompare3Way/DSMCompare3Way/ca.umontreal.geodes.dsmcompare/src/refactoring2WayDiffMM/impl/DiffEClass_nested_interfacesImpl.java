 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayDiffMM.impl.DiffEClass_nested_interfacesImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.DiffEClass_nested_interfacesImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffEClass_nested_interfacesImpl extends MinimalEObjectImpl.Container implements DiffEClass_nested_interfaces {
	...
	protected EClass eStaticClass() {
		return Refactoring2WayDiffMMPackage.Literals.DIFF_ECLASS_NESTED_INTERFACES;
	}
	...
	public void setDiff_kind(DiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.DIFF_ECLASS_NESTED_INTERFACES__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public Interface getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Refactoring2WayDiffMMPackage.DIFF_ECLASS_NESTED_INTERFACES__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(Interface newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.DIFF_ECLASS_NESTED_INTERFACES__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.DIFF_ECLASS_NESTED_INTERFACES__DIFF_KIND:
				return getDiff_kind();
			case Refactoring2WayDiffMMPackage.DIFF_ECLASS_NESTED_INTERFACES__ETYPE:
