 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayDiffMM.impl.DiffInterfaceImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.DiffInterfaceImpl#getNew_name <em>New name</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.DiffInterfaceImpl#getNew_extends <em>New extends</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.DiffInterfaceImpl#getNew_packageName <em>New package Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffInterfaceImpl extends InterfaceImpl implements DiffInterface {
	...
	protected EClass eStaticClass() {
		return Refactoring2WayDiffMMPackage.Literals.DIFF_INTERFACE;
	}
	...
	public void setDiff_kind(DiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.DIFF_INTERFACE__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.DIFF_INTERFACE__NEW_NAME, oldNew_name, new_name));
	}
	...
	public void setNew_extends(String newNew_extends) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.DIFF_INTERFACE__NEW_EXTENDS, oldNew_extends, new_extends));
	}
	...
	public void setNew_packageName(String newNew_packageName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.DIFF_INTERFACE__NEW_PACKAGE_NAME, oldNew_packageName, new_packageName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.DIFF_INTERFACE__DIFF_KIND:
				return getDiff_kind();
			case Refactoring2WayDiffMMPackage.DIFF_INTERFACE__NEW_NAME:
				return getNew_name();
			case Refactoring2WayDiffMMPackage.DIFF_INTERFACE__NEW_EXTENDS:
				return getNew_extends();
			case Refactoring2WayDiffMMPackage.DIFF_INTERFACE__NEW_PACKAGE_NAME:
