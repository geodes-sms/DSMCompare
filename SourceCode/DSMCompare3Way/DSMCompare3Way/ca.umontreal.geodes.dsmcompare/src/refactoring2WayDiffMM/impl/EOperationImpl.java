 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayDiffMM.impl.EOperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EOperationImpl#getEparameters <em>Eparameters</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EOperationImpl#getEtype <em>Etype</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EOperationImpl#getMethodBody <em>Method Body</em>}</li>
 *   <li>{@link refactoring2WayDiffMM.impl.EOperationImpl#get__idKDM <em>id KDM</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EOperationImpl extends MinimalEObjectImpl.Container implements EOperation {
	...
	protected EClass eStaticClass() {
		return Refactoring2WayDiffMMPackage.Literals.EOPERATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.EOPERATION__NAME, oldName, name));
	}
	...
	public void setEparameters(String newEparameters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.EOPERATION__EPARAMETERS, oldEparameters, eparameters));
	}
	...
	public void setEtype(String newEtype) {
		...
		etype = newEtype;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.EOPERATION__ETYPE, oldEtype, etype));
	}
	...
	public void setMethodBody(String newMethodBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.EOPERATION__METHOD_BODY, oldMethodBody, methodBody));
	}
	...
	public void set__idKDM(String new__idKDM) {
		...
		__idKDM = new__idKDM;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayDiffMMPackage.EOPERATION__ID_KDM, old__idKDM, __idKDM));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayDiffMMPackage.EOPERATION__NAME:
				return getName();
			case Refactoring2WayDiffMMPackage.EOPERATION__EPARAMETERS:
				return getEparameters();
			case Refactoring2WayDiffMMPackage.EOPERATION__ETYPE:
				return getEtype();
			case Refactoring2WayDiffMMPackage.EOPERATION__METHOD_BODY:
				return getMethodBody();
			case Refactoring2WayDiffMMPackage.EOPERATION__ID_KDM:
				return get__idKDM();
		}
