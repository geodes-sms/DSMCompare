...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Game entities</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link pacmanDiffMM.impl.DiffGame_entitiesImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGame_entitiesImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGame_entitiesImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGame_entitiesImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGame_entitiesImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGame_entitiesImpl#getDiff_Group <em>Diff Group</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGame_entitiesImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffGame_entitiesImpl extends MinimalEObjectImpl.Container implements DiffGame_entities {
	/**
	 ...
	 * @ordered
	 */
	protected PositionableEntity eType;
	 ...
	 * @generated
	 */
	protected DiffGame_entitiesImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PacmanDiffMMPackage.Literals.DIFF_GAME_ENTITIES;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME_ENTITIES__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME_ENTITIES__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME_ENTITIES__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME_ENTITIES__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME_ENTITIES__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setDiff_Group(String newDiff_Group) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME_ENTITIES__DIFF_GROUP, oldDiff_Group, diff_Group));
	}
	 ...
	 * @generated
	 */
	public PositionableEntity getEType() {
		if (eType != null && eType.eIsProxy()) {
			InternalEObject oldEType = (InternalEObject)eType;
			eType = (PositionableEntity)eResolveProxy(oldEType);
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PacmanDiffMMPackage.DIFF_GAME_ENTITIES__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	 ...
	 * @generated
	 */
	public PositionableEntity basicGetEType() {
		return eType;
	}
	 ...
	 * @generated
	 */
	public void setEType(PositionableEntity newEType) {
		PositionableEntity oldEType = eType;
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME_ENTITIES__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PacmanDiffMMPackage.DIFF_GAME_ENTITIES__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case PacmanDiffMMPackage.DIFF_GAME_ENTITIES__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case PacmanDiffMMPackage.DIFF_GAME_ENTITIES__CHANGE_STATUS:
				return getChangeStatus();
			case PacmanDiffMMPackage.DIFF_GAME_ENTITIES__FILTER:
				return isFilter();
			case PacmanDiffMMPackage.DIFF_GAME_ENTITIES__IS_MERGED:
				return isIsMerged();
			case PacmanDiffMMPackage.DIFF_GAME_ENTITIES__DIFF_GROUP:
				return getDiff_Group();
			case PacmanDiffMMPackage.DIFF_GAME_ENTITIES__ETYPE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case PacmanDiffMMPackage.DIFF_GAME_ENTITIES__DIFF_GROUP:
				...
				return;
			case PacmanDiffMMPackage.DIFF_GAME_ENTITIES__ETYPE:
				setEType((PositionableEntity)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case PacmanDiffMMPackage.DIFF_GAME_ENTITIES__DIFF_GROUP:
				...
				return;
			case PacmanDiffMMPackage.DIFF_GAME_ENTITIES__ETYPE:
				setEType((PositionableEntity)null);
				return;
		}
