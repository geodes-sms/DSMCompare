 ...
 * </p>
 * <ul>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getNew_id_Left <em>New id Left</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getNew_id_Right <em>New id Right</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getIdChangeStatus <em>Id Change Status</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getNew_value_Left <em>New value Left</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getNew_value_Right <em>New value Right</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getValueChangeStatus <em>Value Change Status</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getNew_location_Left <em>New location Left</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getNew_location_Right <em>New location Right</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffFruitImpl#getLocationChangeStatus <em>Location Change Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffFruitImpl extends FruitImpl implements DiffFruit {
	...
	protected EClass eStaticClass() {
		return PacmanDiffMMPackage.Literals.DIFF_FRUIT;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setNew_id_Left(String newNew_id_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__NEW_ID_LEFT, oldNew_id_Left, new_id_Left));
	}
	...
	public void setNew_id_Right(String newNew_id_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__NEW_ID_RIGHT, oldNew_id_Right, new_id_Right));
	}
	...
	public void setIdChangeStatus(ChangeStatus newIdChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__ID_CHANGE_STATUS, oldIdChangeStatus, idChangeStatus));
	}
	...
	public void setNew_value_Left(int newNew_value_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__NEW_VALUE_LEFT, oldNew_value_Left, new_value_Left));
	}
	...
	public void setNew_value_Right(int newNew_value_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__NEW_VALUE_RIGHT, oldNew_value_Right, new_value_Right));
	}
	...
	public void setValueChangeStatus(ChangeStatus newValueChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__VALUE_CHANGE_STATUS, oldValueChangeStatus, valueChangeStatus));
	}
	...
	public void setNew_location_Left(String newNew_location_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__NEW_LOCATION_LEFT, oldNew_location_Left, new_location_Left));
	}
	...
	public void setNew_location_Right(String newNew_location_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__NEW_LOCATION_RIGHT, oldNew_location_Right, new_location_Right));
	}
	...
	public void setLocationChangeStatus(ChangeStatus newLocationChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_FRUIT__LOCATION_CHANGE_STATUS, oldLocationChangeStatus, locationChangeStatus));
	}
