 ...
 *   <li>{@link pacmanDiffMM.impl.DiffGameImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGameImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGameImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGameImpl#getNew_id_Left <em>New id Left</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGameImpl#getNew_id_Right <em>New id Right</em>}</li>
 *   <li>{@link pacmanDiffMM.impl.DiffGameImpl#getIdChangeStatus <em>Id Change Status</em>}</li>
...
public class DiffGameImpl extends GameImpl implements DiffGame {
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setNew_id_Left(String newNew_id_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME__NEW_ID_LEFT, oldNew_id_Left, new_id_Left));
	}
	...
	public void setNew_id_Right(String newNew_id_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME__NEW_ID_RIGHT, oldNew_id_Right, new_id_Right));
	}
	...
	public void setIdChangeStatus(ChangeStatus newIdChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.DIFF_GAME__ID_CHANGE_STATUS, oldIdChangeStatus, idChangeStatus));
	}
