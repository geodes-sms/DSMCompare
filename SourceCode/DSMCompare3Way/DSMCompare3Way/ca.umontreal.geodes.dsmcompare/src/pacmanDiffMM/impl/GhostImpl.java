 ...
 * </p>
 * <ul>
 *   <li>{@link pacmanDiffMM.impl.GhostImpl#getStrategy <em>Strategy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GhostImpl extends PositionableEntityImpl implements Ghost {
	...
	protected EClass eStaticClass() {
		return PacmanDiffMMPackage.Literals.GHOST;
	}
	...
	public void setStrategy(GhostStrategy newStrategy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanDiffMMPackage.GHOST__STRATEGY, oldStrategy, strategy));
	}
