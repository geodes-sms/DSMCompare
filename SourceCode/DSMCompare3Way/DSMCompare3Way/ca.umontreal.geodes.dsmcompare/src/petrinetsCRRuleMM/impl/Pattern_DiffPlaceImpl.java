...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff Place</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getNew_id_Left <em>New id Left</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getNew_id_Right <em>New id Right</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getIdChangeStatus <em>Id Change Status</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getNew_name_Left <em>New name Left</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getNew_name_Right <em>New name Right</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getNameChangeStatus <em>Name Change Status</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getNew_tokens_Left <em>New tokens Left</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getNew_tokens_Right <em>New tokens Right</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffPlaceImpl#getTokensChangeStatus <em>Tokens Change Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffPlaceImpl extends Pattern_NamedElementImpl implements Pattern_DiffPlace {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffPlaceImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PetrinetsCRRuleMMPackage.Literals.PATTERN_DIFF_PLACE;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setNew_id_Left(int newNew_id_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_ID_LEFT, oldNew_id_Left, new_id_Left));
	}
	...
	public void setNew_id_Right(int newNew_id_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_ID_RIGHT, oldNew_id_Right, new_id_Right));
	}
	...
	public void setIdChangeStatus(ChangeStatus newIdChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__ID_CHANGE_STATUS, oldIdChangeStatus, idChangeStatus));
	}
	...
	public void setNew_name_Left(String newNew_name_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_NAME_LEFT, oldNew_name_Left, new_name_Left));
	}
	...
	public void setNew_name_Right(String newNew_name_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_NAME_RIGHT, oldNew_name_Right, new_name_Right));
	}
	...
	public void setNameChangeStatus(ChangeStatus newNameChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NAME_CHANGE_STATUS, oldNameChangeStatus, nameChangeStatus));
	}
	...
	public void setNew_tokens_Left(int newNew_tokens_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_TOKENS_LEFT, oldNew_tokens_Left, new_tokens_Left));
	}
	...
	public void setNew_tokens_Right(int newNew_tokens_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_TOKENS_RIGHT, oldNew_tokens_Right, new_tokens_Right));
	}
	...
	public void setTokensChangeStatus(ChangeStatus newTokensChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__TOKENS_CHANGE_STATUS, oldTokensChangeStatus, tokensChangeStatus));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__FILTER:
				return isFilter();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__IS_MERGED:
				return isIsMerged();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__CHANGE_STATUS:
				return getChangeStatus();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_ID_LEFT:
				return getNew_id_Left();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_ID_RIGHT:
				return getNew_id_Right();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__ID_CHANGE_STATUS:
				return getIdChangeStatus();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_NAME_LEFT:
				return getNew_name_Left();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_NAME_RIGHT:
				return getNew_name_Right();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NAME_CHANGE_STATUS:
				return getNameChangeStatus();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_TOKENS_LEFT:
				return getNew_tokens_Left();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__NEW_TOKENS_RIGHT:
				return getNew_tokens_Right();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_PLACE__TOKENS_CHANGE_STATUS:
