...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff Transition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffTransitionImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffTransitionImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffTransitionImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffTransitionImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffTransitionImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffTransitionImpl#getNew_id_Left <em>New id Left</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffTransitionImpl#getNew_id_Right <em>New id Right</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffTransitionImpl#getIdChangeStatus <em>Id Change Status</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffTransitionImpl#getNew_name_Left <em>New name Left</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffTransitionImpl#getNew_name_Right <em>New name Right</em>}</li>
 *   <li>{@link petrinetsCRRuleMM.impl.Pattern_DiffTransitionImpl#getNameChangeStatus <em>Name Change Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffTransitionImpl extends Pattern_NamedElementImpl implements Pattern_DiffTransition {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffTransitionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PetrinetsCRRuleMMPackage.Literals.PATTERN_DIFF_TRANSITION;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setNew_id_Left(int newNew_id_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__NEW_ID_LEFT, oldNew_id_Left, new_id_Left));
	}
	...
	public void setNew_id_Right(int newNew_id_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__NEW_ID_RIGHT, oldNew_id_Right, new_id_Right));
	}
	...
	public void setIdChangeStatus(ChangeStatus newIdChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__ID_CHANGE_STATUS, oldIdChangeStatus, idChangeStatus));
	}
	...
	public void setNew_name_Left(String newNew_name_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__NEW_NAME_LEFT, oldNew_name_Left, new_name_Left));
	}
	...
	public void setNew_name_Right(String newNew_name_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__NEW_NAME_RIGHT, oldNew_name_Right, new_name_Right));
	}
	...
	public void setNameChangeStatus(ChangeStatus newNameChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__NAME_CHANGE_STATUS, oldNameChangeStatus, nameChangeStatus));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__FILTER:
				return isFilter();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__IS_MERGED:
				return isIsMerged();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__CHANGE_STATUS:
				return getChangeStatus();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__NEW_ID_LEFT:
				return getNew_id_Left();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__NEW_ID_RIGHT:
				return getNew_id_Right();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__ID_CHANGE_STATUS:
				return getIdChangeStatus();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__NEW_NAME_LEFT:
				return getNew_name_Left();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__NEW_NAME_RIGHT:
				return getNew_name_Right();
			case PetrinetsCRRuleMMPackage.PATTERN_DIFF_TRANSITION__NAME_CHANGE_STATUS:
