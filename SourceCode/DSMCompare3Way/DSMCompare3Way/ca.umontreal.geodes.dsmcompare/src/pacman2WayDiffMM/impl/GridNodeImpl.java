 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayDiffMM.impl.GridNodeImpl#getUp <em>Up</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.GridNodeImpl#getDown <em>Down</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.GridNodeImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.GridNodeImpl#getRight <em>Right</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.GridNodeImpl#getId <em>Id</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.GridNodeImpl#getDiffup <em>Diffup</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.GridNodeImpl#getDiffdown <em>Diffdown</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.GridNodeImpl#getDiffleft <em>Diffleft</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.GridNodeImpl#getDiffright <em>Diffright</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GridNodeImpl extends MinimalEObjectImpl.Container implements GridNode {
	...
	protected EClass eStaticClass() {
		return Pacman2WayDiffMMPackage.Literals.GRID_NODE;
	}
		...
		if (up != null && up.eIsProxy()) {
			...
			if (up != oldUp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pacman2WayDiffMMPackage.GRID_NODE__UP, oldUp, up));
			}
		}
		return up;
	}
	...
	public void setUp(GridNode newUp) {
		...
		up = newUp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.GRID_NODE__UP, oldUp, up));
	}
	...
	public GridNode getDown() {
		if (down != null && down.eIsProxy()) {
			...
			if (down != oldDown) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pacman2WayDiffMMPackage.GRID_NODE__DOWN, oldDown, down));
			}
		}
		return down;
	}
	...
	public void setDown(GridNode newDown) {
		...
		down = newDown;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.GRID_NODE__DOWN, oldDown, down));
	}
	...
	public GridNode getLeft() {
		if (left != null && left.eIsProxy()) {
			...
			if (left != oldLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pacman2WayDiffMMPackage.GRID_NODE__LEFT, oldLeft, left));
			}
		}
		return left;
	}
	...
	public void setLeft(GridNode newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.GRID_NODE__LEFT, oldLeft, left));
	}
	...
	public GridNode getRight() {
		if (right != null && right.eIsProxy()) {
			...
			if (right != oldRight) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Pacman2WayDiffMMPackage.GRID_NODE__RIGHT, oldRight, right));
			}
		}
		return right;
	}
	...
	public void setRight(GridNode newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.GRID_NODE__RIGHT, oldRight, right));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.GRID_NODE__ID, oldId, id));
	}
	...
	public EList<DiffGridNode_up> getDiffup() {
		if (diffup == null) {
			diffup = new EObjectContainmentEList<DiffGridNode_up>(DiffGridNode_up.class, this, Pacman2WayDiffMMPackage.GRID_NODE__DIFFUP);
		}
		return diffup;
	}
	...
	public EList<DiffGridNode_down> getDiffdown() {
		if (diffdown == null) {
			diffdown = new EObjectContainmentEList<DiffGridNode_down>(DiffGridNode_down.class, this, Pacman2WayDiffMMPackage.GRID_NODE__DIFFDOWN);
		}
		return diffdown;
	}
	...
	public EList<DiffGridNode_left> getDiffleft() {
		if (diffleft == null) {
			diffleft = new EObjectContainmentEList<DiffGridNode_left>(DiffGridNode_left.class, this, Pacman2WayDiffMMPackage.GRID_NODE__DIFFLEFT);
		}
		return diffleft;
	}
	...
	public EList<DiffGridNode_right> getDiffright() {
		if (diffright == null) {
			diffright = new EObjectContainmentEList<DiffGridNode_right>(DiffGridNode_right.class, this, Pacman2WayDiffMMPackage.GRID_NODE__DIFFRIGHT);
		}
		return diffright;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pacman2WayDiffMMPackage.GRID_NODE__DIFFUP:
				return ((InternalEList<?>)getDiffup()).basicRemove(otherEnd, msgs);
			case Pacman2WayDiffMMPackage.GRID_NODE__DIFFDOWN:
				return ((InternalEList<?>)getDiffdown()).basicRemove(otherEnd, msgs);
			case Pacman2WayDiffMMPackage.GRID_NODE__DIFFLEFT:
				return ((InternalEList<?>)getDiffleft()).basicRemove(otherEnd, msgs);
			case Pacman2WayDiffMMPackage.GRID_NODE__DIFFRIGHT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayDiffMMPackage.GRID_NODE__UP:
				if (resolve) return getUp();
				return basicGetUp();
			case Pacman2WayDiffMMPackage.GRID_NODE__DOWN:
				if (resolve) return getDown();
				return basicGetDown();
			case Pacman2WayDiffMMPackage.GRID_NODE__LEFT:
				if (resolve) return getLeft();
				return basicGetLeft();
			case Pacman2WayDiffMMPackage.GRID_NODE__RIGHT:
				if (resolve) return getRight();
				return basicGetRight();
			case Pacman2WayDiffMMPackage.GRID_NODE__ID:
				return getId();
			case Pacman2WayDiffMMPackage.GRID_NODE__DIFFUP:
				return getDiffup();
			case Pacman2WayDiffMMPackage.GRID_NODE__DIFFDOWN:
