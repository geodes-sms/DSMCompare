 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffEnergizer <em>Semantic Object Diff Energizer</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffFood <em>Semantic Object Diff Food</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffFruit <em>Semantic Object Diff Fruit</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffGame <em>Semantic Object Diff Game</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffGame_entities <em>Semantic Object Diff Game entities</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffGame_gridnodes <em>Semantic Object Diff Game gridnodes</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffGhost <em>Semantic Object Diff Ghost</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffGridNode <em>Semantic Object Diff Grid Node</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffGridNode_down <em>Semantic Object Diff Grid Node down</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffGridNode_left <em>Semantic Object Diff Grid Node left</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffGridNode_right <em>Semantic Object Diff Grid Node right</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffGridNode_up <em>Semantic Object Diff Grid Node up</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffPacman <em>Semantic Object Diff Pacman</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffPositionableEntity_on <em>Semantic Object Diff Positionable Entity on</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_Game <em>Semantic Object Game</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_GridNode <em>Semantic Object Grid Node</em>}</li>
 *   <li>{@link pacman2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_PositionableEntity <em>Semantic Object Positionable Entity</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SemanticObjectImpl extends MinimalEObjectImpl.Container implements SemanticObject {
	...
	protected EClass eStaticClass() {
		return Pacman2WayDiffMMPackage.Literals.SEMANTIC_OBJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__NAME, oldName, name));
	}
	...
	public EList<DiffEnergizer> getSemanticObject_DiffEnergizer() {
		if (semanticObject_DiffEnergizer == null) {
			semanticObject_DiffEnergizer = new EObjectResolvingEList<DiffEnergizer>(DiffEnergizer.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ENERGIZER);
		}
	...
	public EList<DiffFood> getSemanticObject_DiffFood() {
		if (semanticObject_DiffFood == null) {
			semanticObject_DiffFood = new EObjectResolvingEList<DiffFood>(DiffFood.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_FOOD);
		}
	...
	public EList<DiffFruit> getSemanticObject_DiffFruit() {
		if (semanticObject_DiffFruit == null) {
			semanticObject_DiffFruit = new EObjectResolvingEList<DiffFruit>(DiffFruit.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_FRUIT);
		}
	...
	public EList<DiffGame> getSemanticObject_DiffGame() {
		if (semanticObject_DiffGame == null) {
			semanticObject_DiffGame = new EObjectResolvingEList<DiffGame>(DiffGame.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GAME);
		}
	...
	public EList<DiffGame_entities> getSemanticObject_DiffGame_entities() {
		if (semanticObject_DiffGame_entities == null) {
			semanticObject_DiffGame_entities = new EObjectResolvingEList<DiffGame_entities>(DiffGame_entities.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GAME_ENTITIES);
		}
	...
	public EList<DiffGame_gridnodes> getSemanticObject_DiffGame_gridnodes() {
		if (semanticObject_DiffGame_gridnodes == null) {
			semanticObject_DiffGame_gridnodes = new EObjectResolvingEList<DiffGame_gridnodes>(DiffGame_gridnodes.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GAME_GRIDNODES);
		}
	...
	public EList<DiffGhost> getSemanticObject_DiffGhost() {
		if (semanticObject_DiffGhost == null) {
			semanticObject_DiffGhost = new EObjectResolvingEList<DiffGhost>(DiffGhost.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GHOST);
		}
	...
	public EList<DiffGridNode> getSemanticObject_DiffGridNode() {
		if (semanticObject_DiffGridNode == null) {
			semanticObject_DiffGridNode = new EObjectResolvingEList<DiffGridNode>(DiffGridNode.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GRID_NODE);
		}
	...
	public EList<DiffGridNode_down> getSemanticObject_DiffGridNode_down() {
		if (semanticObject_DiffGridNode_down == null) {
			semanticObject_DiffGridNode_down = new EObjectResolvingEList<DiffGridNode_down>(DiffGridNode_down.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GRID_NODE_DOWN);
		}
	...
	public EList<DiffGridNode_left> getSemanticObject_DiffGridNode_left() {
		if (semanticObject_DiffGridNode_left == null) {
			semanticObject_DiffGridNode_left = new EObjectResolvingEList<DiffGridNode_left>(DiffGridNode_left.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GRID_NODE_LEFT);
		}
	...
	public EList<DiffGridNode_right> getSemanticObject_DiffGridNode_right() {
		if (semanticObject_DiffGridNode_right == null) {
			semanticObject_DiffGridNode_right = new EObjectResolvingEList<DiffGridNode_right>(DiffGridNode_right.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GRID_NODE_RIGHT);
		}
	...
	public EList<DiffGridNode_up> getSemanticObject_DiffGridNode_up() {
		if (semanticObject_DiffGridNode_up == null) {
			semanticObject_DiffGridNode_up = new EObjectResolvingEList<DiffGridNode_up>(DiffGridNode_up.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GRID_NODE_UP);
		}
	...
	public EList<DiffPacman> getSemanticObject_DiffPacman() {
		if (semanticObject_DiffPacman == null) {
			semanticObject_DiffPacman = new EObjectResolvingEList<DiffPacman>(DiffPacman.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PACMAN);
		}
	...
	public EList<DiffPositionableEntity_on> getSemanticObject_DiffPositionableEntity_on() {
		if (semanticObject_DiffPositionableEntity_on == null) {
			semanticObject_DiffPositionableEntity_on = new EObjectResolvingEList<DiffPositionableEntity_on>(DiffPositionableEntity_on.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_POSITIONABLE_ENTITY_ON);
		}
	...
	public EList<Game> getSemanticObject_Game() {
		if (semanticObject_Game == null) {
			semanticObject_Game = new EObjectResolvingEList<Game>(Game.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_GAME);
		}
	...
	public EList<GridNode> getSemanticObject_GridNode() {
		if (semanticObject_GridNode == null) {
			semanticObject_GridNode = new EObjectResolvingEList<GridNode>(GridNode.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_GRID_NODE);
		}
	...
	public EList<PositionableEntity> getSemanticObject_PositionableEntity() {
		if (semanticObject_PositionableEntity == null) {
			semanticObject_PositionableEntity = new EObjectResolvingEList<PositionableEntity>(PositionableEntity.class, this, Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_POSITIONABLE_ENTITY);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__NAME:
				return getName();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_ENERGIZER:
				return getSemanticObject_DiffEnergizer();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_FOOD:
				return getSemanticObject_DiffFood();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_FRUIT:
				return getSemanticObject_DiffFruit();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GAME:
				return getSemanticObject_DiffGame();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GAME_ENTITIES:
				return getSemanticObject_DiffGame_entities();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GAME_GRIDNODES:
				return getSemanticObject_DiffGame_gridnodes();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GHOST:
				return getSemanticObject_DiffGhost();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GRID_NODE:
				return getSemanticObject_DiffGridNode();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GRID_NODE_DOWN:
				return getSemanticObject_DiffGridNode_down();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GRID_NODE_LEFT:
				return getSemanticObject_DiffGridNode_left();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GRID_NODE_RIGHT:
				return getSemanticObject_DiffGridNode_right();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_GRID_NODE_UP:
				return getSemanticObject_DiffGridNode_up();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PACMAN:
				return getSemanticObject_DiffPacman();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_POSITIONABLE_ENTITY_ON:
				return getSemanticObject_DiffPositionableEntity_on();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_GAME:
				return getSemanticObject_Game();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_GRID_NODE:
				return getSemanticObject_GridNode();
			case Pacman2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_POSITIONABLE_ENTITY:
