...
import refactoring2WayDiffMM.impl.DiffInterface_eoperationsImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_DiffInterface_eoperationsImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_DiffInterface_eoperationsImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_DiffInterface_eoperationsImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffInterface_eoperationsImpl extends DiffInterface_eoperationsImpl implements Pattern_DiffInterface_eoperations {
	/**
	...
	protected EClass eStaticClass() {
		return Refactoring2WayRuleMMPackage.Literals.PATTERN_DIFF_INTERFACE_EOPERATIONS;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_DIFF_INTERFACE_EOPERATIONS__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_DIFF_INTERFACE_EOPERATIONS__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_DIFF_INTERFACE_EOPERATIONS__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayRuleMMPackage.PATTERN_DIFF_INTERFACE_EOPERATIONS__ID_PATTERN:
				return getID_Pattern();
			case Refactoring2WayRuleMMPackage.PATTERN_DIFF_INTERFACE_EOPERATIONS__FILTER:
				return isFilter();
			case Refactoring2WayRuleMMPackage.PATTERN_DIFF_INTERFACE_EOPERATIONS__IS_FORBIDDEN:
