...
import refactoring2WayDiffMM.impl.DiffEClass_esupertypesImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_DiffEClass_esupertypesImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_DiffEClass_esupertypesImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_DiffEClass_esupertypesImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffEClass_esupertypesImpl extends DiffEClass_esupertypesImpl implements Pattern_DiffEClass_esupertypes {
	/**
	...
	protected EClass eStaticClass() {
		return Refactoring2WayRuleMMPackage.Literals.PATTERN_DIFF_ECLASS_ESUPERTYPES;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_DIFF_ECLASS_ESUPERTYPES__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_DIFF_ECLASS_ESUPERTYPES__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_DIFF_ECLASS_ESUPERTYPES__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayRuleMMPackage.PATTERN_DIFF_ECLASS_ESUPERTYPES__ID_PATTERN:
				return getID_Pattern();
			case Refactoring2WayRuleMMPackage.PATTERN_DIFF_ECLASS_ESUPERTYPES__FILTER:
				return isFilter();
			case Refactoring2WayRuleMMPackage.PATTERN_DIFF_ECLASS_ESUPERTYPES__IS_FORBIDDEN:
