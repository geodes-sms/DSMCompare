...
import refactoring2WayDiffMM.impl.InterfaceImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_InterfaceImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_InterfaceImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoring2WayRuleMM.impl.Pattern_InterfaceImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_InterfaceImpl extends InterfaceImpl implements Pattern_Interface {
	/**
	...
	protected EClass eStaticClass() {
		return Refactoring2WayRuleMMPackage.Literals.PATTERN_INTERFACE;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_INTERFACE__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_INTERFACE__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Refactoring2WayRuleMMPackage.PATTERN_INTERFACE__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Refactoring2WayRuleMMPackage.PATTERN_INTERFACE__ID_PATTERN:
				return getID_Pattern();
			case Refactoring2WayRuleMMPackage.PATTERN_INTERFACE__FILTER:
				return isFilter();
			case Refactoring2WayRuleMMPackage.PATTERN_INTERFACE__IS_FORBIDDEN:
