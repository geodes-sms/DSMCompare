 ...
 * </p>
 * <ul>
 *   <li>{@link dssmmDiffMM.DiffCompositeFactor_subFactors#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link dssmmDiffMM.DiffCompositeFactor_subFactors#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link dssmmDiffMM.DiffCompositeFactor_subFactors#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.DiffCompositeFactor_subFactors#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @see dssmmDiffMM.DssmmDiffMMPackage#getDiffCompositeFactor_subFactors()
 * @model
 * @generated
 */
public interface DiffCompositeFactor_subFactors extends EObject {
	 ...
	 * @see dssmmDiffMM.DssmmDiffMMPackage#getDiffCompositeFactor_subFactors_Diff_kind_Left()
	...
	/**
	 * Sets the value of the '{@link dssmmDiffMM.DiffCompositeFactor_subFactors#getDiff_kind_Left <em>Diff kind Left</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dssmmDiffMM.DssmmDiffMMPackage#getDiffCompositeFactor_subFactors_Diff_kind_Right()
	 * @model default="NON" unique="false" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dssmmDiffMM.DiffCompositeFactor_subFactors#getDiff_kind_Right <em>Diff kind Right</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dssmmDiffMM.DssmmDiffMMPackage#getDiffCompositeFactor_subFactors_ChangeStatus()
	 * @model default="NON" unique="false" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dssmmDiffMM.DiffCompositeFactor_subFactors#getChangeStatus <em>Change Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setEType(Factor)
	 * @see dssmmDiffMM.DssmmDiffMMPackage#getDiffCompositeFactor_subFactors_EType()
	 * @model required="true"
	 * @generated
	 */
	Factor getEType();
	...
	/**
	 * Sets the value of the '{@link dssmmDiffMM.DiffCompositeFactor_subFactors#getEType <em>EType</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
