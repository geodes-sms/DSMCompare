...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Score score option</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dssmmDiffMM.impl.DiffScore_score_optionImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffScore_score_optionImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffScore_score_optionImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.DiffScore_score_optionImpl#getEType <em>EType</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffScore_score_optionImpl extends MinimalEObjectImpl.Container implements DiffScore_score_option {
	/**
	 ...
	 * @generated
	 */
	protected DiffScore_score_optionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DssmmDiffMMPackage.Literals.DIFF_SCORE_SCORE_OPTION;
	}
	...
	public void setDiff_kind_Left(AscDiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_SCORE_SCORE_OPTION__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(AscDiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_SCORE_SCORE_OPTION__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_SCORE_SCORE_OPTION__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public Option getEType() {
		if (eType != null && eType.eIsProxy()) {
			...
			if (eType != oldEType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DssmmDiffMMPackage.DIFF_SCORE_SCORE_OPTION__ETYPE, oldEType, eType));
			}
		}
		return eType;
	}
	...
	public void setEType(Option newEType) {
		...
		eType = newEType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.DIFF_SCORE_SCORE_OPTION__ETYPE, oldEType, eType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DssmmDiffMMPackage.DIFF_SCORE_SCORE_OPTION__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case DssmmDiffMMPackage.DIFF_SCORE_SCORE_OPTION__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case DssmmDiffMMPackage.DIFF_SCORE_SCORE_OPTION__CHANGE_STATUS:
				return getChangeStatus();
			case DssmmDiffMMPackage.DIFF_SCORE_SCORE_OPTION__ETYPE:
