 ...
 * </p>
 * <ul>
 *   <li>{@link dssmmDiffMM.impl.OptionImpl#getOptionID <em>Option ID</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.OptionImpl#getName <em>Name</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.OptionImpl#getSort <em>Sort</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.OptionImpl#getCost <em>Cost</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.OptionImpl#getNumOtherCosts <em>Num Other Costs</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.OptionImpl#getVendor <em>Vendor</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.OptionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.OptionImpl#getDiffvendor <em>Diffvendor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OptionImpl extends MinimalEObjectImpl.Container implements Option {
	...
	protected EClass eStaticClass() {
		return DssmmDiffMMPackage.Literals.OPTION;
	}
	...
	public void setOptionID(int newOptionID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.OPTION__OPTION_ID, oldOptionID, optionID));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.OPTION__NAME, oldName, name));
	}
	...
	public void setSort(int newSort) {
		...
		sort = newSort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.OPTION__SORT, oldSort, sort));
	}
	...
	public void setCost(float newCost) {
		...
		cost = newCost;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.OPTION__COST, oldCost, cost));
	}
	...
	public void setNumOtherCosts(int newNumOtherCosts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.OPTION__NUM_OTHER_COSTS, oldNumOtherCosts, numOtherCosts));
	}
	...
	public Vendor getVendor() {
		if (vendor != null && vendor.eIsProxy()) {
			...
			if (vendor != oldVendor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DssmmDiffMMPackage.OPTION__VENDOR, oldVendor, vendor));
			}
		}
		return vendor;
	}
	...
	public void setVendor(Vendor newVendor) {
		...
		vendor = newVendor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.OPTION__VENDOR, oldVendor, vendor));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.OPTION__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<DiffOption_vendor> getDiffvendor() {
		if (diffvendor == null) {
			diffvendor = new EObjectContainmentEList<DiffOption_vendor>(DiffOption_vendor.class, this, DssmmDiffMMPackage.OPTION__DIFFVENDOR);
		}
		return diffvendor;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DssmmDiffMMPackage.OPTION__DIFFVENDOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DssmmDiffMMPackage.OPTION__OPTION_ID:
				return getOptionID();
			case DssmmDiffMMPackage.OPTION__NAME:
				return getName();
			case DssmmDiffMMPackage.OPTION__SORT:
				return getSort();
			case DssmmDiffMMPackage.OPTION__COST:
				return getCost();
			case DssmmDiffMMPackage.OPTION__NUM_OTHER_COSTS:
				return getNumOtherCosts();
			case DssmmDiffMMPackage.OPTION__VENDOR:
				if (resolve) return getVendor();
				return basicGetVendor();
			case DssmmDiffMMPackage.OPTION__DESCRIPTION:
