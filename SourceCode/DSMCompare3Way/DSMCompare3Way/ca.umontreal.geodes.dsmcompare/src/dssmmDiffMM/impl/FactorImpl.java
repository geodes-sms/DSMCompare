 ...
 * </p>
 * <ul>
 *   <li>{@link dssmmDiffMM.impl.FactorImpl#getFactorID <em>Factor ID</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.FactorImpl#getName <em>Name</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.FactorImpl#getDescr <em>Descr</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.FactorImpl#getGW <em>GW</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.FactorImpl#getLW <em>LW</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.FactorImpl#getDel <em>Del</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.FactorImpl#isHideOnLine <em>Hide On Line</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.FactorImpl#getScores <em>Scores</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.FactorImpl#getHierarchy <em>Hierarchy</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.FactorImpl#getMasterFactorID <em>Master Factor ID</em>}</li>
 *   <li>{@link dssmmDiffMM.impl.FactorImpl#getDiffscores <em>Diffscores</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FactorImpl extends MinimalEObjectImpl.Container implements Factor {
	...
	protected EClass eStaticClass() {
		return DssmmDiffMMPackage.Literals.FACTOR;
	}
	...
	public void setFactorID(int newFactorID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.FACTOR__FACTOR_ID, oldFactorID, factorID));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.FACTOR__NAME, oldName, name));
	}
	...
	public void setDescr(String newDescr) {
		...
		descr = newDescr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.FACTOR__DESCR, oldDescr, descr));
	}
	...
	public void setGW(float newGW) {
		...
		gw = newGW;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.FACTOR__GW, oldGW, gw));
	}
	...
	public void setLW(float newLW) {
		...
		lw = newLW;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.FACTOR__LW, oldLW, lw));
	}
	...
	public void setDel(Boolean newDel) {
		...
		del = newDel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.FACTOR__DEL, oldDel, del));
	}
	...
	public void setHideOnLine(boolean newHideOnLine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.FACTOR__HIDE_ON_LINE, oldHideOnLine, hideOnLine));
	}
	...
	public EList<Score> getScores() {
		if (scores == null) {
			scores = new EObjectContainmentEList<Score>(Score.class, this, DssmmDiffMMPackage.FACTOR__SCORES);
		}
		return scores;
	}
	...
	public void setHierarchy(String newHierarchy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.FACTOR__HIERARCHY, oldHierarchy, hierarchy));
	}
	...
	public void setMasterFactorID(int newMasterFactorID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DssmmDiffMMPackage.FACTOR__MASTER_FACTOR_ID, oldMasterFactorID, masterFactorID));
	}
	...
	public EList<DiffFactor_scores> getDiffscores() {
		if (diffscores == null) {
			diffscores = new EObjectContainmentEList<DiffFactor_scores>(DiffFactor_scores.class, this, DssmmDiffMMPackage.FACTOR__DIFFSCORES);
		}
		return diffscores;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DssmmDiffMMPackage.FACTOR__SCORES:
				return ((InternalEList<?>)getScores()).basicRemove(otherEnd, msgs);
			case DssmmDiffMMPackage.FACTOR__DIFFSCORES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DssmmDiffMMPackage.FACTOR__FACTOR_ID:
				return getFactorID();
			case DssmmDiffMMPackage.FACTOR__NAME:
				return getName();
			case DssmmDiffMMPackage.FACTOR__DESCR:
				return getDescr();
			case DssmmDiffMMPackage.FACTOR__GW:
				return getGW();
			case DssmmDiffMMPackage.FACTOR__LW:
				return getLW();
			case DssmmDiffMMPackage.FACTOR__DEL:
				return getDel();
			case DssmmDiffMMPackage.FACTOR__HIDE_ON_LINE:
				return isHideOnLine();
			case DssmmDiffMMPackage.FACTOR__SCORES:
				return getScores();
			case DssmmDiffMMPackage.FACTOR__HIERARCHY:
				return getHierarchy();
			case DssmmDiffMMPackage.FACTOR__MASTER_FACTOR_ID:
