 ...
 * </p>
 * <ul>
 *   <li>{@link dssmmDiffMM.impl.SemanticConflictImpl#getSemanticdiffs <em>Semanticdiffs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemanticConflictImpl extends SemanticObjectImpl implements SemanticConflict {
	...
	protected EClass eStaticClass() {
		return DssmmDiffMMPackage.Literals.SEMANTIC_CONFLICT;
	}
	...
	public EList<SemanticDiff> getSemanticdiffs() {
		if (semanticdiffs == null) {
			semanticdiffs = new EObjectContainmentEList<SemanticDiff>(SemanticDiff.class, this, DssmmDiffMMPackage.SEMANTIC_CONFLICT__SEMANTICDIFFS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DssmmDiffMMPackage.SEMANTIC_CONFLICT__SEMANTICDIFFS:
