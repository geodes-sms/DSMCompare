 ...
 * </p>
 * <ul>
 *   <li>{@link petrinets2WayDiffMM.impl.DiffTransitionImpl#getDiff_kind <em>Diff kind</em>}</li>
 *   <li>{@link petrinets2WayDiffMM.impl.DiffTransitionImpl#getNew_id <em>New id</em>}</li>
 *   <li>{@link petrinets2WayDiffMM.impl.DiffTransitionImpl#getNew_name <em>New name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffTransitionImpl extends TransitionImpl implements DiffTransition {
	...
	protected EClass eStaticClass() {
		return Petrinets2WayDiffMMPackage.Literals.DIFF_TRANSITION;
	}
	...
	public void setDiff_kind(DiffKind newDiff_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayDiffMMPackage.DIFF_TRANSITION__DIFF_KIND, oldDiff_kind, diff_kind));
	}
	...
	public void setNew_id(int newNew_id) {
		...
		new_id = newNew_id;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayDiffMMPackage.DIFF_TRANSITION__NEW_ID, oldNew_id, new_id));
	}
	...
	public void setNew_name(String newNew_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayDiffMMPackage.DIFF_TRANSITION__NEW_NAME, oldNew_name, new_name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Petrinets2WayDiffMMPackage.DIFF_TRANSITION__DIFF_KIND:
				return getDiff_kind();
			case Petrinets2WayDiffMMPackage.DIFF_TRANSITION__NEW_ID:
				return getNew_id();
			case Petrinets2WayDiffMMPackage.DIFF_TRANSITION__NEW_NAME:
				return getNew_name();
		}
