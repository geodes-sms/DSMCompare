 ...
 * </p>
 * <ul>
 *   <li>{@link petrinets2WayDiffMM.impl.SemanticObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link petrinets2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffPetriNet <em>Semantic Object Diff Petri Net</em>}</li>
 *   <li>{@link petrinets2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffPetriNet_places <em>Semantic Object Diff Petri Net places</em>}</li>
 *   <li>{@link petrinets2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffPetriNet_transitions <em>Semantic Object Diff Petri Net transitions</em>}</li>
 *   <li>{@link petrinets2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffPlace <em>Semantic Object Diff Place</em>}</li>
 *   <li>{@link petrinets2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffPlace_transitions <em>Semantic Object Diff Place transitions</em>}</li>
 *   <li>{@link petrinets2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffTransition <em>Semantic Object Diff Transition</em>}</li>
 *   <li>{@link petrinets2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_DiffTransition_places <em>Semantic Object Diff Transition places</em>}</li>
 *   <li>{@link petrinets2WayDiffMM.impl.SemanticObjectImpl#getSemanticObject_NamedElement <em>Semantic Object Named Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SemanticObjectImpl extends MinimalEObjectImpl.Container implements SemanticObject {
	...
	protected EClass eStaticClass() {
		return Petrinets2WayDiffMMPackage.Literals.SEMANTIC_OBJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__NAME, oldName, name));
	}
	...
	public EList<DiffPetriNet> getSemanticObject_DiffPetriNet() {
		if (semanticObject_DiffPetriNet == null) {
			semanticObject_DiffPetriNet = new EObjectResolvingEList<DiffPetriNet>(DiffPetriNet.class, this, Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PETRI_NET);
		}
	...
	public EList<DiffPetriNet_places> getSemanticObject_DiffPetriNet_places() {
		if (semanticObject_DiffPetriNet_places == null) {
			semanticObject_DiffPetriNet_places = new EObjectResolvingEList<DiffPetriNet_places>(DiffPetriNet_places.class, this, Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PETRI_NET_PLACES);
		}
	...
	public EList<DiffPetriNet_transitions> getSemanticObject_DiffPetriNet_transitions() {
		if (semanticObject_DiffPetriNet_transitions == null) {
			semanticObject_DiffPetriNet_transitions = new EObjectResolvingEList<DiffPetriNet_transitions>(DiffPetriNet_transitions.class, this, Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PETRI_NET_TRANSITIONS);
		}
	...
	public EList<DiffPlace> getSemanticObject_DiffPlace() {
		if (semanticObject_DiffPlace == null) {
			semanticObject_DiffPlace = new EObjectResolvingEList<DiffPlace>(DiffPlace.class, this, Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PLACE);
		}
	...
	public EList<DiffPlace_transitions> getSemanticObject_DiffPlace_transitions() {
		if (semanticObject_DiffPlace_transitions == null) {
			semanticObject_DiffPlace_transitions = new EObjectResolvingEList<DiffPlace_transitions>(DiffPlace_transitions.class, this, Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PLACE_TRANSITIONS);
		}
	...
	public EList<DiffTransition> getSemanticObject_DiffTransition() {
		if (semanticObject_DiffTransition == null) {
			semanticObject_DiffTransition = new EObjectResolvingEList<DiffTransition>(DiffTransition.class, this, Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_TRANSITION);
		}
	...
	public EList<DiffTransition_places> getSemanticObject_DiffTransition_places() {
		if (semanticObject_DiffTransition_places == null) {
			semanticObject_DiffTransition_places = new EObjectResolvingEList<DiffTransition_places>(DiffTransition_places.class, this, Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_TRANSITION_PLACES);
		}
	...
	public EList<NamedElement> getSemanticObject_NamedElement() {
		if (semanticObject_NamedElement == null) {
			semanticObject_NamedElement = new EObjectResolvingEList<NamedElement>(NamedElement.class, this, Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_NAMED_ELEMENT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__NAME:
				return getName();
			case Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PETRI_NET:
				return getSemanticObject_DiffPetriNet();
			case Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PETRI_NET_PLACES:
				return getSemanticObject_DiffPetriNet_places();
			case Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PETRI_NET_TRANSITIONS:
				return getSemanticObject_DiffPetriNet_transitions();
			case Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PLACE:
				return getSemanticObject_DiffPlace();
			case Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_PLACE_TRANSITIONS:
				return getSemanticObject_DiffPlace_transitions();
			case Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_TRANSITION:
				return getSemanticObject_DiffTransition();
			case Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_DIFF_TRANSITION_PLACES:
				return getSemanticObject_DiffTransition_places();
			case Petrinets2WayDiffMMPackage.SEMANTIC_OBJECT__SEMANTIC_OBJECT_NAMED_ELEMENT:
