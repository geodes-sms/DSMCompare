...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff Food</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_DiffFoodImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_DiffFoodImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_DiffFoodImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_DiffFoodImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_DiffFoodImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_DiffFoodImpl#getNew_id_Left <em>New id Left</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_DiffFoodImpl#getNew_id_Right <em>New id Right</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_DiffFoodImpl#getIdChangeStatus <em>Id Change Status</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_DiffFoodImpl#getNew_value_Left <em>New value Left</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_DiffFoodImpl#getNew_value_Right <em>New value Right</em>}</li>
 *   <li>{@link pacmanCRRuleMM.impl.Pattern_DiffFoodImpl#getValueChangeStatus <em>Value Change Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffFoodImpl extends Pattern_PositionableEntityImpl implements Pattern_DiffFood {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffFoodImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PacmanCRRuleMMPackage.Literals.PATTERN_DIFF_FOOD;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setNew_id_Left(String newNew_id_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__NEW_ID_LEFT, oldNew_id_Left, new_id_Left));
	}
	...
	public void setNew_id_Right(String newNew_id_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__NEW_ID_RIGHT, oldNew_id_Right, new_id_Right));
	}
	...
	public void setIdChangeStatus(ChangeStatus newIdChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__ID_CHANGE_STATUS, oldIdChangeStatus, idChangeStatus));
	}
	...
	public void setNew_value_Left(int newNew_value_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__NEW_VALUE_LEFT, oldNew_value_Left, new_value_Left));
	}
	...
	public void setNew_value_Right(int newNew_value_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__NEW_VALUE_RIGHT, oldNew_value_Right, new_value_Right));
	}
	...
	public void setValueChangeStatus(ChangeStatus newValueChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__VALUE_CHANGE_STATUS, oldValueChangeStatus, valueChangeStatus));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__FILTER:
				return isFilter();
			case PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__IS_MERGED:
				return isIsMerged();
			case PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__CHANGE_STATUS:
				return getChangeStatus();
			case PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__NEW_ID_LEFT:
				return getNew_id_Left();
			case PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__NEW_ID_RIGHT:
				return getNew_id_Right();
			case PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__ID_CHANGE_STATUS:
				return getIdChangeStatus();
			case PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__NEW_VALUE_LEFT:
				return getNew_value_Left();
			case PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__NEW_VALUE_RIGHT:
				return getNew_value_Right();
			case PacmanCRRuleMMPackage.PATTERN_DIFF_FOOD__VALUE_CHANGE_STATUS:
