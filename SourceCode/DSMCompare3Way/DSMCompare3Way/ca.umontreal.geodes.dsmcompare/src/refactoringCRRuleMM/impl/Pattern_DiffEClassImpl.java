...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff EClass</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getNew_name_Left <em>New name Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getNew_name_Right <em>New name Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getNameChangeStatus <em>Name Change Status</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getNew_extends_Left <em>New extends Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getNew_extends_Right <em>New extends Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getExtendsChangeStatus <em>Extends Change Status</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getNew_implements_Left <em>New implements Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getNew_implements_Right <em>New implements Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getImplementsChangeStatus <em>Implements Change Status</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#isNew_isAbstract_Left <em>New is Abstract Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#isNew_isAbstract_Right <em>New is Abstract Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getIsAbstractChangeStatus <em>Is Abstract Change Status</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getNew_packageName_Left <em>New package Name Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getNew_packageName_Right <em>New package Name Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEClassImpl#getPackageNameChangeStatus <em>Package Name Change Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffEClassImpl extends Pattern_EClassImpl implements Pattern_DiffEClass {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffEClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RefactoringCRRuleMMPackage.Literals.PATTERN_DIFF_ECLASS;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setNew_name_Left(String newNew_name_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_NAME_LEFT, oldNew_name_Left, new_name_Left));
	}
	...
	public void setNew_name_Right(String newNew_name_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_NAME_RIGHT, oldNew_name_Right, new_name_Right));
	}
	...
	public void setNameChangeStatus(ChangeStatus newNameChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NAME_CHANGE_STATUS, oldNameChangeStatus, nameChangeStatus));
	}
	...
	public void setNew_extends_Left(String newNew_extends_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_EXTENDS_LEFT, oldNew_extends_Left, new_extends_Left));
	}
	...
	public void setNew_extends_Right(String newNew_extends_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_EXTENDS_RIGHT, oldNew_extends_Right, new_extends_Right));
	}
	...
	public void setExtendsChangeStatus(ChangeStatus newExtendsChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__EXTENDS_CHANGE_STATUS, oldExtendsChangeStatus, extendsChangeStatus));
	}
	...
	public void setNew_implements_Left(String newNew_implements_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_IMPLEMENTS_LEFT, oldNew_implements_Left, new_implements_Left));
	}
	...
	public void setNew_implements_Right(String newNew_implements_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_IMPLEMENTS_RIGHT, oldNew_implements_Right, new_implements_Right));
	}
	...
	public void setImplementsChangeStatus(ChangeStatus newImplementsChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__IMPLEMENTS_CHANGE_STATUS, oldImplementsChangeStatus, implementsChangeStatus));
	}
	...
	public void setNew_isAbstract_Left(boolean newNew_isAbstract_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_IS_ABSTRACT_LEFT, oldNew_isAbstract_Left, new_isAbstract_Left));
	}
	...
	public void setNew_isAbstract_Right(boolean newNew_isAbstract_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_IS_ABSTRACT_RIGHT, oldNew_isAbstract_Right, new_isAbstract_Right));
	}
	...
	public void setIsAbstractChangeStatus(ChangeStatus newIsAbstractChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__IS_ABSTRACT_CHANGE_STATUS, oldIsAbstractChangeStatus, isAbstractChangeStatus));
	}
	...
	public void setNew_packageName_Left(String newNew_packageName_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_PACKAGE_NAME_LEFT, oldNew_packageName_Left, new_packageName_Left));
	}
	...
	public void setNew_packageName_Right(String newNew_packageName_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_PACKAGE_NAME_RIGHT, oldNew_packageName_Right, new_packageName_Right));
	}
	...
	public void setPackageNameChangeStatus(ChangeStatus newPackageNameChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__PACKAGE_NAME_CHANGE_STATUS, oldPackageNameChangeStatus, packageNameChangeStatus));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__FILTER:
				return isFilter();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__IS_MERGED:
				return isIsMerged();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__CHANGE_STATUS:
				return getChangeStatus();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_NAME_LEFT:
				return getNew_name_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_NAME_RIGHT:
				return getNew_name_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NAME_CHANGE_STATUS:
				return getNameChangeStatus();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_EXTENDS_LEFT:
				return getNew_extends_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_EXTENDS_RIGHT:
				return getNew_extends_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__EXTENDS_CHANGE_STATUS:
				return getExtendsChangeStatus();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_IMPLEMENTS_LEFT:
				return getNew_implements_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_IMPLEMENTS_RIGHT:
				return getNew_implements_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__IMPLEMENTS_CHANGE_STATUS:
				return getImplementsChangeStatus();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_IS_ABSTRACT_LEFT:
				return isNew_isAbstract_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_IS_ABSTRACT_RIGHT:
				return isNew_isAbstract_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__IS_ABSTRACT_CHANGE_STATUS:
				return getIsAbstractChangeStatus();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_PACKAGE_NAME_LEFT:
				return getNew_packageName_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__NEW_PACKAGE_NAME_RIGHT:
				return getNew_packageName_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_ECLASS__PACKAGE_NAME_CHANGE_STATUS:
