...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern EOperation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_EOperationImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_EOperationImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_EOperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_EOperationImpl#getEparameters <em>Eparameters</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_EOperationImpl#getEtype <em>Etype</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_EOperationImpl#getMethodBody <em>Method Body</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_EOperationImpl#get__idKDM <em>id KDM</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_EOperationImpl extends MinimalEObjectImpl.Container implements Pattern_EOperation {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_EOperationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RefactoringCRRuleMMPackage.Literals.PATTERN_EOPERATION;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_EOPERATION__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_EOPERATION__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_EOPERATION__NAME, oldName, name));
	}
	...
	public void setEparameters(String newEparameters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_EOPERATION__EPARAMETERS, oldEparameters, eparameters));
	}
	...
	public void setEtype(String newEtype) {
		...
		etype = newEtype;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_EOPERATION__ETYPE, oldEtype, etype));
	}
	...
	public void setMethodBody(String newMethodBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_EOPERATION__METHOD_BODY, oldMethodBody, methodBody));
	}
	...
	public void set__idKDM(String new__idKDM) {
		...
		__idKDM = new__idKDM;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_EOPERATION__ID_KDM, old__idKDM, __idKDM));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringCRRuleMMPackage.PATTERN_EOPERATION__ID_PATTERN:
				return getID_Pattern();
			case RefactoringCRRuleMMPackage.PATTERN_EOPERATION__IS_FORBIDDEN:
				return isIsForbidden();
			case RefactoringCRRuleMMPackage.PATTERN_EOPERATION__NAME:
				return getName();
			case RefactoringCRRuleMMPackage.PATTERN_EOPERATION__EPARAMETERS:
				return getEparameters();
			case RefactoringCRRuleMMPackage.PATTERN_EOPERATION__ETYPE:
				return getEtype();
			case RefactoringCRRuleMMPackage.PATTERN_EOPERATION__METHOD_BODY:
				return getMethodBody();
			case RefactoringCRRuleMMPackage.PATTERN_EOPERATION__ID_KDM:
				return get__idKDM();
		}
