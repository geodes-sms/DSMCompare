...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Diff EOperation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getDiff_kind_Left <em>Diff kind Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getDiff_kind_Right <em>Diff kind Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#isIsMerged <em>Is Merged</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getChangeStatus <em>Change Status</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getNew_name_Left <em>New name Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getNew_name_Right <em>New name Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getNameChangeStatus <em>Name Change Status</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getNew_eparameters_Left <em>New eparameters Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getNew_eparameters_Right <em>New eparameters Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getEparametersChangeStatus <em>Eparameters Change Status</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getNew_etype_Left <em>New etype Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getNew_etype_Right <em>New etype Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getEtypeChangeStatus <em>Etype Change Status</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getNew_methodBody_Left <em>New method Body Left</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getNew_methodBody_Right <em>New method Body Right</em>}</li>
 *   <li>{@link refactoringCRRuleMM.impl.Pattern_DiffEOperationImpl#getMethodBodyChangeStatus <em>Method Body Change Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffEOperationImpl extends Pattern_EOperationImpl implements Pattern_DiffEOperation {
	/**
	 ...
	 * @generated
	 */
	protected Pattern_DiffEOperationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RefactoringCRRuleMMPackage.Literals.PATTERN_DIFF_EOPERATION;
	}
	...
	public void setDiff_kind_Left(DiffKind newDiff_kind_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__DIFF_KIND_LEFT, oldDiff_kind_Left, diff_kind_Left));
	}
	...
	public void setDiff_kind_Right(DiffKind newDiff_kind_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__DIFF_KIND_RIGHT, oldDiff_kind_Right, diff_kind_Right));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__FILTER, oldFilter, filter));
	}
	...
	public void setIsMerged(boolean newIsMerged) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__IS_MERGED, oldIsMerged, isMerged));
	}
	...
	public void setChangeStatus(ChangeStatus newChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__CHANGE_STATUS, oldChangeStatus, changeStatus));
	}
	...
	public void setNew_name_Left(String newNew_name_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_NAME_LEFT, oldNew_name_Left, new_name_Left));
	}
	...
	public void setNew_name_Right(String newNew_name_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_NAME_RIGHT, oldNew_name_Right, new_name_Right));
	}
	...
	public void setNameChangeStatus(ChangeStatus newNameChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NAME_CHANGE_STATUS, oldNameChangeStatus, nameChangeStatus));
	}
	...
	public void setNew_eparameters_Left(String newNew_eparameters_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_EPARAMETERS_LEFT, oldNew_eparameters_Left, new_eparameters_Left));
	}
	...
	public void setNew_eparameters_Right(String newNew_eparameters_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_EPARAMETERS_RIGHT, oldNew_eparameters_Right, new_eparameters_Right));
	}
	...
	public void setEparametersChangeStatus(ChangeStatus newEparametersChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__EPARAMETERS_CHANGE_STATUS, oldEparametersChangeStatus, eparametersChangeStatus));
	}
	...
	public void setNew_etype_Left(String newNew_etype_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_ETYPE_LEFT, oldNew_etype_Left, new_etype_Left));
	}
	...
	public void setNew_etype_Right(String newNew_etype_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_ETYPE_RIGHT, oldNew_etype_Right, new_etype_Right));
	}
	...
	public void setEtypeChangeStatus(ChangeStatus newEtypeChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__ETYPE_CHANGE_STATUS, oldEtypeChangeStatus, etypeChangeStatus));
	}
	...
	public void setNew_methodBody_Left(String newNew_methodBody_Left) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_METHOD_BODY_LEFT, oldNew_methodBody_Left, new_methodBody_Left));
	}
	...
	public void setNew_methodBody_Right(String newNew_methodBody_Right) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_METHOD_BODY_RIGHT, oldNew_methodBody_Right, new_methodBody_Right));
	}
	...
	public void setMethodBodyChangeStatus(ChangeStatus newMethodBodyChangeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__METHOD_BODY_CHANGE_STATUS, oldMethodBodyChangeStatus, methodBodyChangeStatus));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__DIFF_KIND_LEFT:
				return getDiff_kind_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__DIFF_KIND_RIGHT:
				return getDiff_kind_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__FILTER:
				return isFilter();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__IS_MERGED:
				return isIsMerged();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__CHANGE_STATUS:
				return getChangeStatus();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_NAME_LEFT:
				return getNew_name_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_NAME_RIGHT:
				return getNew_name_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NAME_CHANGE_STATUS:
				return getNameChangeStatus();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_EPARAMETERS_LEFT:
				return getNew_eparameters_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_EPARAMETERS_RIGHT:
				return getNew_eparameters_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__EPARAMETERS_CHANGE_STATUS:
				return getEparametersChangeStatus();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_ETYPE_LEFT:
				return getNew_etype_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_ETYPE_RIGHT:
				return getNew_etype_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__ETYPE_CHANGE_STATUS:
				return getEtypeChangeStatus();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_METHOD_BODY_LEFT:
				return getNew_methodBody_Left();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__NEW_METHOD_BODY_RIGHT:
				return getNew_methodBody_Right();
			case RefactoringCRRuleMMPackage.PATTERN_DIFF_EOPERATION__METHOD_BODY_CHANGE_STATUS:
