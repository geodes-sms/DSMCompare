...
import pacman2WayDiffMM.impl.DiffGridNode_leftImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DiffGridNode_leftImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DiffGridNode_leftImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_DiffGridNode_leftImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_DiffGridNode_leftImpl extends DiffGridNode_leftImpl implements Pattern_DiffGridNode_left {
	/**
	...
	protected EClass eStaticClass() {
		return Pacman2WayRuleMMPackage.Literals.PATTERN_DIFF_GRID_NODE_LEFT;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_LEFT__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_LEFT__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_LEFT__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_LEFT__ID_PATTERN:
				return getID_Pattern();
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_LEFT__FILTER:
				return isFilter();
			case Pacman2WayRuleMMPackage.PATTERN_DIFF_GRID_NODE_LEFT__IS_FORBIDDEN:
