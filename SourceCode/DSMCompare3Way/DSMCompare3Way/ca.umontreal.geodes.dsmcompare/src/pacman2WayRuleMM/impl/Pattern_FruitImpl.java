...
import pacman2WayDiffMM.impl.FruitImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Fruit</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_FruitImpl#getID_Pattern <em>ID Pattern</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_FruitImpl#isFilter <em>Filter</em>}</li>
 *   <li>{@link pacman2WayRuleMM.impl.Pattern_FruitImpl#isIsForbidden <em>Is Forbidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pattern_FruitImpl extends FruitImpl implements Pattern_Fruit {
	/**
	...
	protected EClass eStaticClass() {
		return Pacman2WayRuleMMPackage.Literals.PATTERN_FRUIT;
	}
	...
	public void setID_Pattern(int newID_Pattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_FRUIT__ID_PATTERN, oldID_Pattern, iD_Pattern));
	}
	...
	public void setFilter(boolean newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_FRUIT__FILTER, oldFilter, filter));
	}
	...
	public void setIsForbidden(boolean newIsForbidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pacman2WayRuleMMPackage.PATTERN_FRUIT__IS_FORBIDDEN, oldIsForbidden, isForbidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pacman2WayRuleMMPackage.PATTERN_FRUIT__ID_PATTERN:
				return getID_Pattern();
			case Pacman2WayRuleMMPackage.PATTERN_FRUIT__FILTER:
				return isFilter();
			case Pacman2WayRuleMMPackage.PATTERN_FRUIT__IS_FORBIDDEN:
